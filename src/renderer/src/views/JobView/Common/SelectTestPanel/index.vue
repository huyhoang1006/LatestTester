<template>
  <div class="st-wrap">
    <div class="st-panel st-left">
      <div class="st-header">
        <span class="st-title"
          >Available tests <span class="st-count">{{ filteredTestTypes.length }}</span></span
        >
        <el-input
          v-model="search"
          size="mini"
      ...
      <div class="st-list">
        ...
        >
          ...
          <span v-if="usageCount[item.mrid]" class="st-badge" title="Times added">{{
            usageCount[item.mrid]
          }}</span>
    ...
    <div class="st-panel st-right">
      <div class="st-header">
        <span class="st-title"
          >Selected tests <span class="st-count">{{ testListData.length }}</span></span
        >
