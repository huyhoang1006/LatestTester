    ...
    <el-row :gutter="20" style="padding: 0">
      <el-tabs type="card">
        ...
        <el-tab-pane style="width: 100%">
          ...
          >
          <overview
            :data="voltageTransformerJobDto.properties"
            @update-attachment="updateAttachmentOverView"
            v-model:attachment="voltageTransformerJobDto.attachmentData"
        ...
        <el-tab-pane>
          ...
          <div>
            <testing-equipment
              :data="voltageTransformerJobDto.testingEquipmentData"
              :testTypeListData="testTypeListData"
            ></testing-equipment>
          </div>
        </el-tab-pane>
        ...
        <el-tab-pane>
          ...
          <div id="tests" style="width: 100%">
            <el-tabs v-model="objActiveName.activeName" type="card" class="w-100 h-100">
              <el-tab-pane
                v-for="(item, index) in voltageTransformerJobDto.testList"
                :key="index"
                :label="item.name"
