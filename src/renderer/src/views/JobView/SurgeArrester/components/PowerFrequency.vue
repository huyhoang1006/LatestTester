        ...
        <table class="table-strip-input-data" style="width: 100%">
            ...
            <tbody>
                <tr v-for="(item, index) in testData.table.table1" :key="index">
                    ...
                    <td>
                        <el-input size="small" type="text" number="positive" v-model="item.ref_current.value"></el-input>
                    </td>
                    <td>
                        <el-input size="small" type="text" number="positive" v-model="item.v_meas.value"></el-input>
                    </td>
                    <td>
