    ...
    <table class="w-100 mgt-10 table-strip-input-data" style="width: 100%; font-size: 12px">
      <thead>
        <tr>
          ...
          <th rowspan="3" @click="add()" class="action-col">
            <i class="fa-solid fa-plus pointer"></i>
          </th>
          <th rowspan="3" @click="removeAll()" class="action-col">
      ...
      <tbody>
        <tr v-for="(item, index) in testData.table.table1" :key="index">
          ...
          <td>
            <el-input size="small" type="text" number="positive" v-model="item.rated_voltage.value">
            </el-input>
          </td>
          <td>
          ...
          <td>
            <el-input
              ...
              type="text"
              number="positive"
              v-model="item.lv_tested_voltage.value"
            >
            </el-input>
          </td>
          <td>
          ...
          <td>
            <el-input
              ...
              type="text"
              number="positive"
              v-model="item.hv_tested_voltage.value"
            >
            </el-input>
          </td>
          <td>
