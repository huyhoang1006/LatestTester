        ...
        <table class="w-100 mgt-10 table-strip-input-data" style="width: 100% ; font-size: 12px;">
            ...
            <tbody>
                <tr v-for="(item, index) in testData.table.table1" :key="index">
                    <td>
                        <el-input size="small" v-model="item.applied_terminal.value"> </el-input>
                    </td>
                    <td>
                        <el-input size="small" type="text" number="positive" v-model="item.rated_voltage.value"> </el-input>
                    </td>
                    <td>
                        <el-input size="small" v-model="item.lv_terminal.value"> </el-input>
                    </td>
                    <td>
                        <el-input size="small" type="text" number="positive" v-model="item.lv_tested_voltage.value"> </el-input>
                    </td>
                    <td>
                        <el-input size="small" v-model="item.hv_terminal.value"> </el-input>
                    </td>
                    <td>
                        <el-input size="small" type="text" number="positive" v-model="item.hv_tested_voltage.value"> </el-input>
                    </td>
                    <td>
