  ...
  <div>
            ...
            <table v-if="assessmentSetting.option.value === 'IEC'" class="table-strip-input-data">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><el-input size="small" type="number" :min="0"
                                v-model="assessmentSetting.data.iec.voltage.value"></el-input></td>
                    </tr>
                </tbody>
            </table>
            ...
            <table v-if="assessmentSetting.option.value === 'IEEE'" class="table-strip-input-data">
                ...
                <tbody>
                    <tr>
                        <th>Breakdown voltage (kV)</th>
                        <td><el-input size="small" type="number" :min="0"
                                v-model="assessmentSetting.data.ieee.voltage.value"></el-input></td>
                    </tr>
                </tbody>
            </table>
            ...
            <table v-else-if="assessmentSetting.option.value === 'Custom'" class="table-strip-input-data">
                ...
                <tbody>
                    <tr>
                        <th>Breakdown voltage (kV)</th>
                        <td>
                            <el-input size="small" type="number" :min="0"
                                v-model="assessmentSetting.data.custom.voltage.value"> </el-input>
                        </td>
                    </tr>
                </tbody>
            </table> -->
    ...
    >
      <!-- <table class="table-strip-input-data">
                ...
                <tbody>
                    <tr>
                        <td>≥ <el-input size="small" class="w-100px"
                                v-model="conditionIndicatorSetting.good.breakdown_voltage[1].value"></el-input></td>
                    ...
                    <tr>
                        <td>&lt; <el-input size="small" class="w-100px"
                                v-model="conditionIndicatorSetting.bad.breakdown_voltage[0].value"></el-input></td>
                        <td class="Bad">Bad</td>
