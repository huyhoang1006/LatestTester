        ...
        <tbody>
          <tr v-for="(item, index) in testData.table.table1" :key="index">
            ...
            <template v-if="index % 3 == 0 && assetData.tap_changers.winding === $constant.SEC">
              ...
              <!-- <td rowspan="3">
                                <el-input size="small" type="text" v-model="item.mean_value"><template #append>Ω</template></el-input>
</td> -->
            </template>
            <template
              v-else-if="index % 3 == 0 && assetData.tap_changers.winding !== $constant.SEC"
            >
              <td rowspan="3">
                <el-input
                  size="small"
