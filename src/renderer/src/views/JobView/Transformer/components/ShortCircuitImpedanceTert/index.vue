        ...
        <table class="table-strip-input-data" style="width: 115% ; font-size: 12px;">
            ...
            <tbody v-if="currentOption === 'threePhase'" key="three">
                <tr v-for="(item, index) in testData.table.table1" :key="index">
                    <td><el-input size="small" type="text" number="positive" v-model="item.tap.value"></el-input></td>
                    <td style="width: 10%">
                        <div class="col-phase">
                            <div class="phase">
            ...
            <tbody v-else key="per">
                    <tr v-for="(item, index) in testData.table.table2" :key="index">
                        <td><el-input size="small" type="text" number="positive" v-model="item.tap.value"></el-input>
                        </td>
                        <td style="width: 10%">
                            <div class="col-phase">
                                <div class="phase">
