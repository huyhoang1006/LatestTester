<template>
    <div id="ratio-prim-sec">
        ...
        <table class="table-strip-input-data" style="width: 100% ; font-size: 12px;">
            ...
            <tbody>
                <tr v-for="(item, index) in testData.table.table1" :key="index">
                    ...
                    <td>
                        <el-input size="small" type="text" number="positive" v-model="item.voltage_prim.value"></el-input>
                    </td>
                    <td>
                        <el-input size="small" type="text" number="positive" v-model="item.voltage_sec.value"></el-input>
                    </td>
                    <td>
                        <el-input size="small" type="text" number="positive" v-model="item.nominal_ratio.value"></el-input>
                    </td>
                    <td>
                        <el-input size="small" type="text" number="positive" v-model="item.ratio_meas.value"></el-input>
                    </td>
                    <td>
                        <el-input size="small" type="text" number="positive" v-model="item.ratio_dev.value"><template
        ...
        <el-dialog append-to-body title="Assessment settings" v-model="openAssessmentDialog" width="600px">
            ...
            <table v-if="assessmentSetting.option.value === 'IEC' || assessmentSetting.option.value === 'IEEE'"
                    ...
                    <tr>
                        ...
                        <td>
                            ≤ <el-input style="width: 100px;" size="small"
                                v-model="assessmentSetting.data.custom.ratio_dev.value"></el-input>
                        </td>
                        <th><i class="fas fa-check-square pass"></i> Pass</th>
                    </tr>
                    <tr>
        ...
        <el-dialog append-to-body title="Condition indicator settings" v-model="openConditionIndicatorDialog"
            ...
            <!-- <table class="table-strip-input-data">
                ...
                <tbody>
                    <tr>
                        <td>Ratio dev (%) ≤ <el-input size="small" class="w-100px"
                                v-model="conditionIndicatorSetting.good.ratio_dev[0].value"></el-input></td>
                        <td class="good">Good</td>
                        <td><el-input size="small" v-model="conditionIndicatorSetting.good.score.value"></el-input></td>
                    </tr>
                    <tr>
                        <td>
                            <el-input size="small" class="w-100px"
                                v-model="conditionIndicatorSetting.fair.ratio_dev[0].value"></el-input> &lt; Ratio dev
                            (%) ≤
                            <el-input size="small" class="w-100px"
                                v-model="conditionIndicatorSetting.fair.ratio_dev[1].value"></el-input>
                        </td>
                        <td class="fair">Fair</td>
                        <td><el-input size="small" v-model="conditionIndicatorSetting.fair.score.value"></el-input></td>
                    </tr>
                    <tr>
                        <td>
                            <el-input size="small" class="w-100px"
                                v-model="conditionIndicatorSetting.poor.ratio_dev[0].value"></el-input> &lt; Ratio dev
                            (%) ≤
                            <el-input size="small" class="w-100px"
                                v-model="conditionIndicatorSetting.poor.ratio_dev[1].value"></el-input>
                        </td>
                        <td class="poor">Poor</td>
                        <td><el-input size="small" v-model="conditionIndicatorSetting.poor.score.value"></el-input></td>
                    </tr>
                    <tr>
                        <td>Ratio dev (%) > <el-input size="small" class="w-100px"
                                v-model="conditionIndicatorSetting.bad.ratio_dev[1].value"></el-input></td>
                        <td class="bad">Bad</td>
                        <td><el-input size="small" v-model="conditionIndicatorSetting.bad.score.value"></el-input></td>
                    </tr>
                </tbody>
            </table> -->
        </el-dialog>
...
export default {
    ...
    computed: {
        ...
        rowData() {
            return common.buildEmptyTestRow(TransformerTestMap['RatioPrimSec'].columns)
        },
        assessmentSetting() {
        ...
        clear() {
            this.testData.table.table1.forEach(row => {
                Object.keys(row).forEach(key => {
                    if (key === "mrid" || key === "tap" || key === "phase") return;
