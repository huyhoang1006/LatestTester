      ...
      <!-- <el-form size="small" label-position="left" label-width="140px">
                <el-form-item label="Option">
                    <el-select class="w-100" placeholder="please select" v-model="assessmentSetting.option.value">
                        ...
                        <el-option label="IEEE C57.152 (2013) - Service aged transformer"
                            value="IEEEserviceTrans"></el-option>
            ...
            <table class="table-strip-input-data">
                ...
                <tbody v-if="assessmentSetting.option.value === 'IEEEnewTrans'">
                    ...
                    <tr>
                        <td>R<sub>60s</sub> &#8804; {{ assessmentSetting.data.IEEEnewTrans.pass.value }}MΩ</td>
                        <td class="bolder"><i class="fa-solid fa-xmark fail"></i> Fail - Manufacturer to be consulted
                            for values
                            less than 500 MΩ for proper course of action</td>
                    </tr>
                </tbody>
                <tbody v-if="assessmentSetting.option === 'IEEEserviceTrans'">
                    ...
                    <tr>
                        <td>{{ assessmentSetting.data.IEEEserviceTrans.fail.value }} MΩ ≤ R<sub>60s</sub> ≤ {{
                            assessmentSetting.data.IEEEserviceTrans.pass.value }}MΩ</td>
                        <td class="bolder"><i class="fa-solid fa-xmark fail"></i> Fail - Indicative of insulation
                            deterioration
                        </td>
                    </tr>
                    <tr>
                ...
                <tbody v-if="assessmentSetting.option.value === 'custom'">
                    <tr>
                        <td>R<sub>60s</sub> > <el-input style="width: 100px;" size="small"
                                v-model="assessmentSetting.data.custom.pass.value"></el-input> MΩ</td>
                        <td class="bolder"><i class="fas fa-check-square pass"></i> Pass</td>
                    </tr>
                    <tr>
                        <td>R<sub>60s</sub> ≤ <el-input style="width: 100px;" size="small"
                                v-model="assessmentSetting.data.custom.fail.value"></el-input> MΩ</td>
      ...
      <!-- <table class="table-strip-input-data">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <div class="flex-container">
                                <div>{{ conditionIndicatorSetting.fair.r60s[0].value }} MΩ ≤ R<sub>60s</sub> &lt; {{
                                    conditionIndicatorSetting.fair.r60s[1].value }} MΩ , R<sub>60s</sub> ≥ {{
                                        conditionIndicatorSetting.fair.r60sref[0].value }}% R<sub>60s ref</sub> </div>
                            </div>
                        </td>
                    ...
                    <tr>
                        <td>
                            <div class="flex-container">
                                <div>{{ conditionIndicatorSetting.poor.r60s[0].value }} MΩ ≤ R<sub>60s</sub> &lt; {{
                                    conditionIndicatorSetting.poor.r60s[1].value }} MΩ , R<sub>60s</sub> ≥ {{
                                        conditionIndicatorSetting.poor.r60sref[0].value }}% R<sub>60s ref</sub> </div>
                            </div>
                        </td>
