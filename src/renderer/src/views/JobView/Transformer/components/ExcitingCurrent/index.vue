      ...
      <table class="table-strip-input-data test-table" style="width: 100%; font-size: 12px">
        ...
        <tbody>
          <tr v-for="(item, index) in testData.table.table1" :key="index">
            ...
            <td>
              <el-input size="small" type="text" number="positive" v-model="item.i_out.value"
                ><template #append>mA</template>
              </el-input>
            </td>
            <td>
              <el-input size="small" type="text" number="positive" v-model="item.watt_losses.value"
