    ...
    <div id="exciting-current">
        ...
        <table class="table-strip-input-data" style="width: 100% ; font-size: 12px;">
            ...
            <tbody>
                <tr v-for="(item, index) in testData.table.table1" :key="index">
                    ...
                    <td>
                        <el-input size="small" type="text" number="positive" v-model="item.i_out.value"><template
                                slot="append">mA</template>
                        </el-input>
                    </td>
                    <td>
                        <el-input size="small" type="text" number="positive" v-model="item.watt_losses.value"><template
                                slot="append">W</template> </el-input>
                    </td>
                    <td>
                        <el-input size="small" type="text" number="positive" v-model="item.i_ref.value"></el-input>
                    </td>
                    <td>
                        <el-input size="small" type="text" number="positive" v-model="item.i_dev.value"></el-input>
                    </td>
                    <td>
        ...
        <el-dialog :modal="false" title="Condition indicator settings" v-model="openConditionIndicatorDialog"
            ...
            <!-- <table class="table-strip-input-data">
                ...
                <tbody>
                    <tr>
                        <td>Dev (%) ≤ <el-input size="small" class="w-100px"
