        ...
        <table class="table-strip-input-data" style="width: 100% ; font-size: 12px;">
            ...
            <tbody>
                <tr v-for="(item, index) in testData.table.table1" :key="index">
                    ...
                    <td>
                        <el-input size="small" type="text" number="positive" v-model="item.r_meas.value"><template
                                slot="append">Ω</template></el-input>
                    </td>
                    <td>
                        <el-input size="small" type="text" number="positive" v-model="item.r_ref.value"><template
                                slot="append">Ω</template></el-input>
                    </td>
                    <td>
                        <el-input size="small" type="text" number="positive" v-model="item.r_corr.value"><template
                                slot="append">Ω</template></el-input>
                    </td>
                    <td>
                        <el-input size="small" type="text" number="positive" v-model="item.dev_r_ref.value"></el-input>
                    </td>
                    <template v-if="index % 3 == 0 && assetData.tap_changers.winding === $constant.TERT">
                        <td rowspan="3">
                            <el-input size="small" type="text" number="positive" v-model="item.dev_phase.value"></el-input>
                        </td>
