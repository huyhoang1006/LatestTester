            ...
            <td style="width: 100px">
              <div class="col-phase">
                ...
                <div
                  class="rectangle"
                  :class="{
                    red: item.name.value == 'A',
                    yellow: item.name.value == 'B',
                    blue: item.name.value == 'C'
                  }"
                ></div>
              </div>
            </td>
            <td>
              <el-input size="small" type="text" number="positive" v-model="item.r_meas.value"
                ><template #append>Ω</template></el-input
              >
            </td>
            <td>
              <el-input size="small" type="text" number="positive" v-model="item.r_ref.value"
                ><template #append>Ω</template></el-input
              >
            </td>
            <td>
              <el-input size="small" type="text" number="positive" v-model="item.r_corr.value"
                ><template #append>Ω</template></el-input
              >
            </td>
            <td>
            ...
            <template v-if="index % 3 == 0 && assetData.tap_changers.winding === $constant.TERT">
              <td rowspan="3">
                <el-input
                  ...
                  type="text"
                  number="positive"
                  v-model="item.dev_phase.value"
                ></el-input>
              </td>

              <!-- <td rowspan="3">
                                <el-input size="small" type="text" v-model="item.mean_value.value"><template #append>Ω</template></el-input>
</td> -->
            </template>
            <template
              v-else-if="index % 3 == 0 && assetData.tap_changers.winding !== $constant.TERT"
            >
              <td rowspan="3">
                <el-input
                  size="small"
...
export default {
  ...
  computed: {
    ...
    rowData() {
      return common.buildEmptyTestRow(TransformerTestMap['DCWindingTert'].columns)
    },
    assessmentSetting() {
