        ...
        <table class="table-strip-input-data" style="width: 100% ; font-size: 12px;">
            ...
            <tbody>
                <tr v-for="(item, index) in testData.table.table1" :key="index">
                    ...
                    <td>
                        <el-input size="small" type="text" number="positive" v-model="item.capacitance.value"></el-input>
                    </td>
                    <td>
                        <el-input size="small" type="text" number="positive" v-model="item.mtd.value"></el-input>
                    </td>
                    <td>
                        <el-input size="small" type="text" number="positive" v-model="item.delta_td_each_step.value"></el-input>
                    </td>
                    <td v-if="index % 3 == 0" rowspan="3">
                        <el-input size="small" type="text" number="positive" v-model="item.tan_delta_dtd.value"></el-input>
                    </td>
                    <td>
                        <el-input size="small" type="text" number="positive" v-model="item.tan_delta_tdts.value"></el-input>
                    </td>
                    <td>
