    ...
    <div style="width: 100%;">
        ...
        <el-row style="width: 100%;" :gutter="20">
            <el-col style="width: 50%;">
                <el-form :inline-message="true" size="small" :label-width="labelWidth" label-position="left">
                ...
                <el-row style="width: inherit;">
                    <el-form :inline-message="true" :label-width="labelWidth" size="small" label-position="left">
                        ...
                        <el-form-item class="asset-item" label="Serial number">
                            <span class="asset-name">{{ assetData.properties?.serial_no || assetData.serial_number }}</span>
                        </el-form-item>
