            ...
            <tbody>
                <template v-for="(item, index) in testingEquipmentListData" :key="index">
                    <tr>
                        ...
                        <td>
                            <el-input size="small" type="text" v-model="item.model"></el-input>
                        </td>
                        <td>
                            <el-input size="small" type="text" v-model="item.serial_number"></el-input>
                        </td>
                        <td>
                            <el-date-picker
                        ...
                        <td>
                            <el-select multiple collapse-tags size="small" v-model="item.test_type_current_transformer_id" placeholder="Select test type">
                                <el-option
    ...
    methods: {
        ...
        add() {
            const data = {
                ...
                calibration_date: '',
                work_id: '',
                test_type_current_transformer_id: []
            }
