        ...
        <table class="table-strip-input-data" style="width: 100% ; font-size: 12px;">
            ...
            <tbody>
                <tr v-for="(item, index) in testData.table.table1" :key="index">
                    <td>
                        <el-input size="small" type="text" number="positive" v-model="item.name.value"></el-input>
                    </td>
                    <td>
                        <el-input size="small" type="text" v-model="item.i_knee.value"
                            @blur="validateIKnee(item, index)">
                        </el-input>
                    </td>
                    <td>
                        <el-input size="small" type="text" number="positive" v-model="item.v_knee.value"></el-input>
                    </td>
                    <td>
