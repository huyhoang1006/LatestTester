...
export default {
  ...
  methods: {
    async saveJob() {
      try {
        if (
          !this.currentTransformerJobDto.properties.name ||
          this.currentTransformerJobDto.properties.name === ''
        ) {
          ...
          const old_entity = currentTransformerJobMapping.jobDtoToEntity(
            this.currentTransformerJobDtoOld
          )
    ...
    checkTestingEquipment(data) {
      ...
      data.currentTransformerTestingEquipmentTestType =
        data.currentTransformerTestingEquipmentTestType.filter((old) =>
          arr.some(
            (current) =>
              old.testing_equipment_id === current.testing_equipment_id &&
              old.test_type_id === current.test_type_id
