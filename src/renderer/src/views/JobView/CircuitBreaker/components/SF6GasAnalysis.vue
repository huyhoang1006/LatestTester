    ...
    <table class="table-strip-input-data" style="width: 80%; font-size: 12px">
      <thead>
        <tr>
          ...
          <th @click="add('table1')" class="action-col">
            <i class="fa-solid fa-plus pointer"></i>
          </th>
          <th @click="removeAll('table1')" class="action-col">
    ...
    <table class="table-strip-input-data" style="width: 80%; font-size: 12px">
      <thead>
        <tr>
          ...
          <th class="assessment-col">Assessment</th>
          <th class="condition-indicator-col">Condition indicator</th>
          <th @click="add('table2')" class="action-col">
            <i class="fa-solid fa-plus pointer"></i>
          </th>
          <th @click="removeAll('table2')" class="action-col">
            <i class="fa-solid fa-trash pointer"></i>
          </th>
        </tr>
      </thead>
    ...
    <table class="table-strip-input-data" style="width: 80%; font-size: 12px">
      <thead>
        <tr>
          ...
          <th class="assessment-col">Assessment</th>
          <th class="condition-indicator-col">Condition indicator</th>
          <th @click="add('table3')" class="action-col">
            <i class="fa-solid fa-plus pointer"></i>
          </th>
          <th @click="removeAll('table3')" class="action-col">
            <i class="fa-solid fa-trash pointer"></i>
          </th>
        </tr>
      </thead>
