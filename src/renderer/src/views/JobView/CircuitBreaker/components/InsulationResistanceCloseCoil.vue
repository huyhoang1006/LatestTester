    ...
    <table class="table-strip-input-data" style="width: 80%; font-size: 12px">
      ...
      <tbody>
        <tr v-for="(item, index) in testData.table.table1" :key="index">
          ...
          <td>
            <el-input size="small" type="text" v-model="item.close_coil_no.value"></el-input>
          </td>
          <td>
            <el-input
              size="small"
...
export default {
  name: 'InsulationResistanceCloseCoil',
  data() {
    return {
  ...
  computed: {
    ...
    rowData() {
      return common.buildEmptyTestRow(
        CircuitBreakerTestMap['InsulationResistanceCloseCoil'].columns
      )
    }
  },
  watch: {
