...
<table class="table-strip-input-data" style="width: 100%; font-size: 12px;">
                    ...
                    <tbody>
                        <tr v-for="(item, index) in testData.table[items - 1]" :key="index">
                            ...
                            <td>
                                <el-input size="small" type="text" number="positive" v-model="item.closing_time.value"></el-input>
                            </td>
                            <td v-if="index % (getInterruptersPerPhase() * getNumberOfPhases()) === 0"
                                ...
                                <el-input
                                    ...
                                    type="textarea" number="positive" size="small"
                                    v-model="item.closing_sync_between_phase.value"></el-input>
                            </td>
                            <td>
                                <el-input type="text" number="positive" size="small" v-model="item.close_open_time.value"></el-input>
                            </td>
                            <td>
...
<table class="table-strip-input-data" style="width: 100%; font-size: 12px;">
                    ...
                    <tbody>
                        <tr v-for="(item, index) in testData.table[items - 1]" :key="index">
                            ...
                            <td>
                                <el-input size="small" type="text" number="positive" v-model="item.interrupter.value"></el-input>
                            </td>
                            <td>
                                <el-input size="small" type="text" number="positive" v-model="item.closing_time.value"></el-input>
                            </td>
...
export default {
    ...
    methods: {
        ...
        calculator() {
            ...
            if (this.$selectedAsset() && this.$selectedAsset()[0] && this.$selectedAsset()[0].circuitBreaker) {
