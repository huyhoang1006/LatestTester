<template>
    <div id="dc-winding-resistance-prim">
        ...
        <table class="table-strip-input-data" style="width: 100%; font-size: 12px;">
            ...
            <tbody>
                <tr v-for="(item, index) in testData.table.table1" :key="index">
                    <td>
                        <el-input size="small" type="text" number="positive" v-model="item.inrush_current.value"></el-input>
                    </td>
                    <td>
                        <el-input size="small" type="text" number="positive" v-model="item.charging.value"></el-input>
                    </td>
                    <td>
                        <el-input size="small" type="text" number="positive" v-model="item.charging_current.value"></el-input>
                    </td>
                    <td>
                        <el-input size="small" type="text" number="positive" v-model="item.mini_voltage.value"></el-input>
                    </td>
                    <td>
        ...
        <!-- Assessment settings -->
        <el-dialog class="dialog_assess" title="Assessment settings" v-model="openAssessmentDialog" width="600px"
            append-to-body>
            <el-radio-group v-model="assetData.assessmentLimits.limits">
                ...
                <table v-else-if="assetData.assessmentLimits.limits === 'Relative'" class="table-strip-input-data">
                    <thead>
                        <tr>
                            <th></th>
                            <th>Reference</th>
        ...
        <el-dialog class="dialog_assess" title="Condition indicator settings"
            v-model="openConditionIndicatorDialog" width="600px" append-to-body>
        </el-dialog>
    </div>
</template>
