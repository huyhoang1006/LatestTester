<template>
  <div id="dc-winding-resistance-prim">
    ...
    <div class="table-scroll">
      <table class="table-strip-input-data test-table" style="width: 80%; font-size: 12px">
        <thead>
          <tr>
            <th>No</th>
            <th>Rmeas (&#8486;)</th>
...
export default {
  ...
  computed: {
    ...
    rowData() {
      return common.buildEmptyTestRow(CircuitBreakerTestMap['DCWindingMotor'].columns)
    }
  },
  watch: {
    // assetData: {
