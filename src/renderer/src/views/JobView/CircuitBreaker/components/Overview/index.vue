          ...
          >
            <el-form-item class="asset-item" label="Asset">
              <span class="asset-name">{{
                assetData.properties?.kind || assetData.kind || assetData.asset?.kind || ''
              }}</span>
            </el-form-item>
            <el-form-item class="asset-item" label="Asset type">
              <span class="asset-name">{{
                assetData.properties?.type || assetData.type || ''
              }}</span>
            </el-form-item>
            <el-form-item class="asset-item" label="Serial number">
              <span class="asset-name">{{
                assetData.properties?.serial_no ||
            ...
            <el-form-item class="asset-item" label="Manufacturer">
              <span class="asset-name">{{
                assetData.properties?.manufacturer || assetData.manufacturer || ''
              }}</span>
            </el-form-item>
          </el-form>
        </el-row>
