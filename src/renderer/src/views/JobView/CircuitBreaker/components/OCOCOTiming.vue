                ...
                <tr v-for="(item, index) in testData.table.table1" :key="index">
                    <td>
                        <div style="display: flex;width: 100%;">
                            <el-input size="small" type="text" v-model="item.phase.value"></el-input>
                            <div
                    ...
                    <td>
                        <el-input size="small" type="text" number="positive" v-model="item.trip_coil.value"></el-input>
                    </td>
                    <td>
                    ...
                    <td>
                        <el-input size="small" type="text" number="positive" v-model="item.opening_sync_between_phase.value"></el-input>
                    </td>
                    <td>
