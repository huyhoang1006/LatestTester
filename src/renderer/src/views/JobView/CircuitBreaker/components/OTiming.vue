  ...
  <div id="dc-winding-resistance-prim">
    ...
    >
      <div v-for="(tableData, tableKey) in testData.table" :key="tableKey" style="margin-top: 2%">
        ...
        >
          Trip coil no. {{ tableKey.replace('table', '') }}
        </div>
              ...
              <tr v-for="(item, index) in tableData" :key="index">
                ...
                <td>
                  <el-input
                    ...
                    number="positive"
                    size="small"
                    v-model="item.opening_time.value"
                  ></el-input>
                </td>
                <td
                ...
                >
                  <el-input
                    ...
                    type="textarea"
                    size="small"
                    v-model="item.opening_sync_between_phase.value"
                  ></el-input>
                </td>
                <td>
              ...
              <tr v-for="(item, index) in tableData" :key="index">
                ...
                >
                  <el-input
                    ...
                    type="textarea"
                    number="positive"
                    v-model="item.opening_sync_between_interrupter.value"
                  ></el-input>
                </td>
                <td>
                  <el-select class="assessment" size="small" v-model="item.assessment.value">
    ...
    >
      ...
      <template #footer>
        <span
          style="margin-top: 20px; width: 100%; position: absolute; right: 10px; bottom: 10px"
          class="dialog-footer"
        >
...
export default {
  ...
  methods: {
    ...
    initializeTable() {
      ...
      const numTripCoil =
        this.assetData?.operating?.numberTripCoil ||
