...
<thead>
                    ...
                    <tbody>
                        <tr v-for="(item, index) in testData.table[items - 1]" :key="index">
                            ...
                            <td>
                                <el-input size="small" type="text" number="positive" v-model="item.opening_time.value"></el-input>
                            </td>
                            <td v-if="index % (getInterruptersPerPhase() * getNumberOfPhases()) === 0"
                                :rowspan="getInterruptersPerPhase() * getNumberOfPhases()">
                                <el-input
                            ...
                            <td>
                                <el-input size="small" type="text" number="positive" v-model="item.close_open_time.value"></el-input>
                            </td>
                            <td>
