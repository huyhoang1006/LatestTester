              ...
              <tr v-for="(item, index) in testData.table[items - 1]" :key="index">
                ...
                >
                  <el-input
                    ...
                    number="positive"
                    size="small"
                    v-model="item.closing_sync.value"
                  ></el-input>
                </td>
                <td>
                  <el-input
                ...
                >
                  <el-input
                    ...
                    number="positive"
                    size="small"
                    v-model="item.opening_sync.value"
                  ></el-input>
                </td>
                <td>
                  <el-input
                ...
                <table class="table-strip-input-data" v-if="testData.limits === 'Absolute'">
                    ...
                    <tbody>
                        <tr v-for="(item, index) in miscellaneous" :key="index">
                            <td>{{ item }}</td>
                            <td>
                                <el-input v-if="index === 1" size="small" v-model="asset_.miscell.abs[index].min"> </el-input>
                                <el-input v-else size="small" v-model="asset_.miscell.abs[index].min">
                                    <template #append>ms</template>
                                </el-input>
                            </td>
                            <td>
                                <el-input v-if="index === 1" size="small" v-model="asset_.miscell.abs[index].max"> </el-input>
                ...
                <table class="table-strip-input-data" v-else-if="testData.limits === 'Relative'">
                    ...
                    <tbody>
                        <tr v-for="(item, index) in miscellaneous" :key="index">
                            <td>{{ item }}</td>
                            <td>
                                <el-input v-if="index === 1" size="small" v-model="asset_.miscell.rel[index].ref"> </el-input>
                                <el-input v-else size="small" v-model="asset_.miscell.rel[index].ref">
                                    <template v-if="item !== 1">ms</template>
                                </el-input>
                            </td>
                            <td>
                                <el-input v-if="index === 1" size="small" v-model="asset_.miscell.rel[index].dev"> </el-input>
              ...
              fields.forEach((field) => {
                ...
                if (
                  ...
                  (typeof row[field] !== 'object' ||
                    !Object.prototype.hasOwnProperty.call(row[field], 'value'))
                ) {
                  ...
                  row[field] = {
                    ...
                    type:
                      field === 'assessment' || field === 'condition_indicator'
                        ? 'discrete'
                        : field === 'phase'
                          ? 'string'
                          : 'analog'
