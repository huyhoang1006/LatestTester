                ...
                <tr v-for="(item, index) in testData.table.table1" :key="index">
                    <td>
                        <div style="display: flex;width: 100%;">
                            <el-input style="width: 100x;" size="small" type="text" v-model="item.measurement.value"
                                v-if="item.measurement"></el-input>
                            <div
                    ...
                    <td>
                        <el-input size="small" type="text" number="positive" v-model="item.i_test.value" v-if="item.i_test"></el-input>
                    </td>
                    <td>
                        <el-input size="small" type="text" number="positive" v-model="item.contact_resistance.value"
                            v-if="item.contact_resistance"></el-input>
                    </td>
                    <td>
                    ...
                    <td>
                        <el-select :class="nameColor(item.condition_indicator && item.condition_indicator.value)"
                            id="condition" type="text" size="small" v-model="item.condition_indicator.value"
...
export default {
    ...
    computed: {
        ...
        rowData() {
            return common.buildEmptyTestRow(disconnectorTestMap.ContactResistance.columns)
        }
    },
    watch: {
    },
