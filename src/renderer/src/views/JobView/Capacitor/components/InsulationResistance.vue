        ...
        <table class="table-strip-input-data" style="width: 100%">
            ...
            <tbody>
                <tr v-for="(item, index) in testData.table" :key="index">
                    ...
                    <td>
                        <el-input size="small" type="text" v-model="item.r60s.value"></el-input>
                    </td>
                    <td>
                    ...
                    <td>
                        <el-input :class="nameColor(item.condition_indicator.value)" id="condition" type="text" size="small" v-model="item.condition_indicator.value">
                        </el-input>
                    </td>
                    <td>
