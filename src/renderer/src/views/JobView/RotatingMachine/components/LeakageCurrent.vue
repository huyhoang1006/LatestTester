<template>
    <div id="dc-winding-resistance-prim">
        ...
        <div style="position: sticky; left: 0; display: inline-block; margin-top: 20px;">
            ...
            <el-row class="mgb-10">
                <el-col>
                    <el-button size="small" type="primary" class="btn-action" @click="calculator" > <i class="fas fa-circle-play"></i> Assess results </el-button>
                    <el-button size="small" type="primary" class="btn-action" @click="clear"> <i class="fas fa-xmark"></i> Clear all</el-button>
                </el-col>
            </el-row>
        </div>
                ...
                <tr v-for="(item, index) in testData.table" :key="index">
                    <td>
                        <div style="display: flex;width: 100%; justify-content: flex-end;">   
                            <el-input v-if="index%(assetData.unit_count)==1" style="width: 50px;" size="small" type="text" v-model="item.phase.value"></el-input>
                            <div :class="{colorTableRed : index%3==0, colorTableYellow : index%3==1, colorTableBlue : index%3==2}" style="min-height: 30px;"></div>
                        </div>
                    </td>
                    <td :class="unitShow">
                        <el-input size="small" type="text" v-model="item.unit_no.value"></el-input>
                    </td>
                    <td>
                        <el-input size="small" type="text" v-model="item.test_voltage.value"></el-input>
                    </td>
                    <td>
                        <el-input size="small" type="text" v-model="item.i_meas.value"></el-input>
                    </td>
                    <td>
                    ...
                    <td>
                        <el-input :class="nameColor(item.condition_indicator)" id="condition" type="text" size="small" v-model="item.condition_indicator.value">
                        </el-input>
                    </td>
        ...
        <!-- Assessment settings -->
        <el-dialog :modal="false" title="Assessment settings" v-model="openAssessmentDialog" width="860px">
        </el-dialog>

        <!-- Condition indicator settings -->
        <el-dialog :modal="false" title="Condition indicator settings" v-model="openConditionIndicatorDialog" width="860px">
        </el-dialog>
    </div>
</template>
