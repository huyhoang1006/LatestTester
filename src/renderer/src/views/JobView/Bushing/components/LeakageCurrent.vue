                ...
                <tr v-for="(item, index) in testData.table.table1" :key="index">
                    <td>
                        <div style="display: flex;width: 100%; justify-content: flex-end;">
                            <el-input v-if="index % (assetData.unit_count) == 1" style="width: 50px;" size="small"
                    ...
                    <td>
                        <el-input :class="nameColor(item.condition_indicator)" id="condition" type="text" size="small"
