...
const fetchNodeSelfDto = async (node, deps) => {
  ...
  try {
    if (node.mode === 'organisation') {
      ...
      if (e)
        return { type: 'organisation', data: mappings.OrganisationMapping.OrgEntityToOrgDto(e) }
    } else if (node.mode === 'substation') {
      const e = unwrap(
        await electronAPI.getSubstationEntityByMrid(node.mrid, userId, node.parentId)
      )
      ...
      if (e)
        return { type: 'voltageLevel', data: mappings.VoltageLevelMapping.volEntityToVolDto(e) }
...
const ASSET_DEFS = {
  'Surge arrester': {
    type: 'surgeArrester',
    get: (n, a) => a.getSurgeArresterEntityByMrid(n.mrid),
    map: (m, e) => m.SurgeArresterMapping.mapEntityToDto(e)
  },
  'Power cable': {
    type: 'powerCable',
    get: (n, a) => a.getPowerCableEntityByMrid(n.mrid, n.parentId),
    map: (m, e) => m.PowerCableMapping.mapEntityToDto(e)
  },
  Disconnector: {
    type: 'disconnector',
    get: (n, a) => a.getDisconnectorEntityByMrid(n.mrid, n.parentId),
    map: (m, e) => m.DisconnectorMapping.disconnectorEntityToDto(e)
  },
  'Rotating machine': {
    type: 'rotatingMachine',
    get: (n, a) => a.getRotatingMachineEntityByMrid(n.mrid, n.parentId),
    map: (m, e) => m.rotatingMachineMapping.mapEntityToDto(e)
  },
  Capacitor: {
    type: 'capacitor',
    get: (n, a) => a.getCapacitorEntityByMrid(n.mrid, n.parentId),
    map: (m, e) => m.CapacitorMapping.mapEntityToDto(e)
  },
  'Voltage transformer': {
    type: 'voltageTransformer',
    get: (n, a) => a.getVoltageTransformerEntityByMrid(n.mrid, n.parentId),
    map: (m, e) => m.VoltageTransformerMapping.mapEntityToDto(e)
  },
  'Current transformer': {
    type: 'currentTransformer',
    get: (n, a) => a.getCurrentTransformerEntityByMrid(n.mrid, n.parentId),
    map: (m, e) => m.CurrentTransformerMapping.mapEntityToDto(e)
  },
  Transformer: {
    type: 'transformer',
    get: (n, a) => a.getTransformerEntityByMrid(n.mrid, n.parentId),
    map: (m, e) => m.TransformerMapping.transformerEntityToDto(e)
  },
  'Circuit breaker': {
    type: 'breaker',
    get: (n, a) => a.getBreakerEntityByMrid(n.mrid, n.parentId),
    map: (m, e) => m.BreakerMapping.mapEntityToDto(e)
  },
  Reactor: {
    type: 'reactor',
    get: (n, a) => a.getReactorEntityByMrid(n.mrid, n.parentId),
    map: (m, e) => m.ReactorMapping.mapEntityToDto(e)
  },
  Bushing: {
    type: 'bushing',
    get: (n, a) => a.getBushingEntityByMrid(n.mrid, n.parentId),
