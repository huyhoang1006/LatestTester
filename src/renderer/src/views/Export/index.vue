<template>
  <div>
    <div class="export-view">
      ...
      >
      <el-button
        @click="uploadWordFile()"
        v-if="this.exportType === 'word'"
        type="primary"
        size="small"
        style="margin-left: 10px; margin-right: 10px"
        >Word File</el-button
      ...
      <el-button
        ...
        >Delete</el-button
      >
      <el-button type="primary" size="small" style="margin-left: 10px; margin-right: 20px"
        >Import</el-button
      >
      <el-button type="primary" size="small" style="margin-left: 10px; margin-right: 20px"
        >Export</el-button
    ...
    <div>
      <table
        ...
        cellpadding="8"
        width="100%"
        style="border-collapse: collapse; margin-top: 10px; table-layout: fixed"
      >
        <thead>
          <tr>
            <th>Code</th>
