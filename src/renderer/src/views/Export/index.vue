...
<div>
  <div class="export-view">
    <el-select v-model="exportTypeSelected" placeholder="Select" size="small"></el-select>
    <el-button @click="addRow()" type="primary" size="small" style="margin-left: 10px;margin-right: 10px;">Add Row</el-button>
    <el-button @click="uploadPdfFile()" v-if="this.exportType === 'pdf'" type="primary" size="small" style="margin-left: 10px;margin-right: 10px;">PDF File</el-button>
    <el-button @click="uploadExcelFile()" v-if="this.exportType === 'excel'" type="primary" size="small" style="margin-left: 10px;margin-right: 10px;">Excel File</el-button>
    <el-button @click="uploadXmlFile()" v-if="this.exportType === 'xml'" type="primary" size="small" style="margin-left: 10px;margin-right: 10px;">XML File</el-button>
    <el-button @click="uploadWordFile()" v-if="this.exportType === 'word'" type="primary" size="small" style="margin-left: 10px;margin-right: 10px;">Word File</el-button>
    <el-button @click="removeRow()" type="danger" size="small" style="margin-left: 10px;margin-right: 20px;">Delete</el-button>
    <el-button type="primary" size="small" style="margin-left: 10px;margin-right: 20px;">Import</el-button>
    <el-button type="primary" size="small" style="margin-left: 10px;margin-right: 20px;">Export</el-button>
    <el-button type="primary" size="small" style="margin-left: 10px;margin-right: 20px;">Refresh</el-button>
  </div>
  <div> 
    ...
    <tbody>
      <tr v-for="(row, index) in tableData" :key="index">
        <td>
          <el-input v-model="row.code" placeholder="Input" size="small"></el-input>
        </td>
        ...
        <td>
          <el-button  @click="addRow(index)" type="primary" size="small" style="width: 100%">
            <i class="fa-solid fa-plus"></i>
          </el-button>
        </td>
        <td>
          <el-button @click="removeRow(index)" type="danger" size="small" style="width: 100%">
            <i class="fa-solid fa-trash"></i>
          </el-button>
        </td>
      </tr>
