  ...
  methods: {
    ...
    async _runExportTreeJSON(nodes, mode) {
      const deps = {
        ...
        jobMappings: {
          'Voltage transformer': {
            getByMrid: (a, m) => a.getVoltageTransformerJobByMrid(m),
            JobEntityToDto: VTJob.JobEntityToDto
          },
          'Current transformer': {
            getByMrid: (a, m) => a.getCurrentTransformerJobByMrid(m),
            JobEntityToDto: CTJob.JobEntityToDto
          },
          Transformer: {
            getByMrid: (a, m) => a.getTransformerJobByMrid(m),
            JobEntityToDto: TFJob.JobEntityToDto
          },
          'Circuit breaker': {
            getByMrid: (a, m) => a.getCircuitBreakerJobByMrid(m),
            JobEntityToDto: CBJob.JobEntityToDto
          },
          'Surge arrester': {
            getByMrid: (a, m) => a.getSurgeArresterJobByMrid(m),
            JobEntityToDto: SAJob.JobEntityToDto
          },
          Disconnector: {
            getByMrid: (a, m) => a.getDisconnectorJobByMrid(m),
            JobEntityToDto: DCJob.JobEntityToDto
          },
          'Power cable': {
            getByMrid: (a, m) => a.getPowerCableJobByMrid(m),
            JobEntityToDto: PCJob.JobEntityToDto
          },
          'Rotating machine': {
            getByMrid: (a, m) => a.getRotatingMachineJobByMrid(m),
            JobEntityToDto: RMJob.JobEntityToDto
          },
          Capacitor: {
            getByMrid: (a, m) => a.getCapacitorJobByMrid(m),
            JobEntityToDto: CAPJob.JobEntityToDto
          },
          Reactor: {
            getByMrid: (a, m) => a.getReactorJobByMrid(m),
            JobEntityToDto: REJob.JobEntityToDto
          },
          Bushing: {
            getByMrid: (a, m) => a.getBushingJobByMrid(m),
            JobEntityToDto: BUJob.JobEntityToDto
          }
        },
        messageHandler: {
