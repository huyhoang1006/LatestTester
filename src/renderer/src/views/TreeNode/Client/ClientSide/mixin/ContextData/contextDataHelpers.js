  ...
  methods: {
    ...
    getContextDataClientRef() {
      return this.$refs.contextDataClient
        ? this.$refs.contextDataClient.getContextDataClientRef()
        : null
    },
    getContentDataClientRef() {
      return this.$refs.contextDataClient
        ? this.$refs.contextDataClient.getContentDataClientRef()
        : null
    },
    getContentClientRef() {
      return this.$refs.contextDataClient
        ? this.$refs.contextDataClient.getContentClientRef()
        : null
    },
    getPropertiesClientRef() {
      return this.$refs.contextDataClient
        ? this.$refs.contextDataClient.getPropertiesClientRef()
        : null
    },
    getLogBarClientRef() {
