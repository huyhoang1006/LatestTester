...
export default {
  ...
  methods: {
    ...
    async resetPathClient(index) {
      ...
      currentNode = this.findNodeByIdOrMrid(target.mrid || target.id, this.organisationClientList)
      ...
      if (currentNode.asset != undefined) {
        ...
        const parentNode = currentNode.parentId
          ? this.findNodeById(currentNode.parentId, this.organisationClientList)
          : null
        if (parentNode) {
        ...
        const jobNode = currentNode.parentId
          ? this.findNodeById(currentNode.parentId, this.organisationClientList)
          : null
        ...
        const assetNode = currentNode.parentId
          ? this.findNodeById(currentNode.parentId, this.organisationClientList)
          : null
        const locationNode = assetNode
          ? assetNode.parentId
