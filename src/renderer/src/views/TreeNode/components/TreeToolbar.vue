<template>
  <div id="toolbar-setting-id" class="toolbar-rail-wrap" :class="{ collapsed }">
    <div v-if="!collapsed" class="toolbar-rail">
      ...
      <button
        ...
        type="button"
        class="rail-tab"
        :class="{ active: activeTab === 'testingEquipment' }"
        title="Testing Equipment"
        @click="handleShowEquipment"
      >
        ...
        <template #dropdown>
          <el-dropdown-menu>
            <el-dropdown-item command="importJSON">
              <icon size="12px" fileTypeDetail="json" folderType="fileType" badgeColor="146EBE" />
              Import from JSON
            </el-dropdown-item>
            <el-dropdown-item command="importExcel">
              <icon size="12px" fileTypeDetail="excel" folderType="fileType" badgeColor="146EBE" />
              Import from Excel
            </el-dropdown-item>
            <el-dropdown-item command="importWord">
              <icon size="12px" fileTypeDetail="word" folderType="fileType" badgeColor="146EBE" />
              Import from Word
            </el-dropdown-item>
          </el-dropdown-menu>
        </template>
      ...
      <button
        type="button"
        class="rail-tab rail-collapse"
        title="Collapse sidebar tabs"
...
/* Vue 3 Deep Selector cho class của Element Plus */
