<template>
  <el-dialog
    ...
    :class="customClass"
  >
    <VoltageLevel :locationId="locationId" :parent="parentOrganization" ref="voltageLevel" />
    <template #footer>
...
export default {
  ...
  methods: {
    ...
    // Expose voltageLevel ref to parent
    getVoltageLevelRef() {
      return this.$refs.voltageLevel
    },
