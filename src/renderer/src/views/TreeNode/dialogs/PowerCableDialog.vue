<template>
    ...
    >
        <PowerCable :locationId="locationId" :parent="parentOrganization" ref="powerCable" />
        <template #footer>
...
export default {
    ...
    methods: {
        ...
        // Expose powerCable ref to parent
        getPowerCableRef() {
            return this.$refs.powerCable
        },
