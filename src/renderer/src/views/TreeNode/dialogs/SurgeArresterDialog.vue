<template>
    ...
    >
        <SurgeArrester :locationId="locationId" :parent="parentOrganization" ref="surgeArrester" />
        <template #footer>
...
export default {
    ...
    methods: {
        ...
        // Expose surgeArrester ref to parent
        getSurgeArresterRef() {
            return this.$refs.surgeArrester
        },
