    ...
    <div class="import-wrapper">
      ...
      <div class="upload-container">
        <el-upload
          ...
          :file-list="fileList"
          :limit="1"
          accept=".json, .xml, .xlsx, .xls, .doc, .docx, .pdf"
        >
          <i
            class="fa-solid fa-upload"
            style="color: #fff; font-size: 40px; margin-bottom: 10px"
          ></i>
          <div class="el-upload__text" style="color: rgba(255, 255, 255, 0.8)">
            Drop file here or <em>click to upload</em>
          </div>
          <template #tip>
            <div class="el-upload__tip" style="color: rgba(255, 255, 255, 0.5)">
...
:global(.el-upload-dragger:hover) {
  border-color: #ffffff !important;
  background: rgba(255, 255, 255, 0.1) !important;
}

:global(.el-upload-dragger.is-dragover) {
...
:global(.el-upload-list__item:hover) {
  background-color: rgba(255, 255, 255, 0.1) !important;
}

:global(.el-upload-list__item .fa-xmark) {
  color: #ffffff !important;
}
...
/* Button Disabled */
:global(.custom-footer .footer-btn.is-disabled) {
  background: rgba(255, 255, 255, 0.1) !important;
