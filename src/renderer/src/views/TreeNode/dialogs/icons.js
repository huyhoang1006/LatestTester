const IconSubstation = {
  render(h) {
    return h('svg', { attrs: { viewBox: '0 0 24 24', width: '24', height: '24' } }, [
      h('path', {
        attrs: { fill: 'currentColor', d: 'M12,3L2,12H5V20H19V12H22L12,3M11,10H13V18H11V10Z' }
      })
    ])
  }
}
    ...
    return h('svg', { attrs: { viewBox: '0 0 100 100', width: '24', height: '24' } }, [
      ...
      ...[35, 50, 65]
        .map((x) => [
          ...
          h('rect', {
            attrs: { x: x - 2, y: 50, width: '4', height: '40', rx: '2', fill: 'currentColor' }
          })
        ])
        .flat()
    ])
...
const IconBushing = {
  render(h) {
    return h('svg', { attrs: { viewBox: '0 0 100 100' } }, [
      ...
      // Phần thân sứ (hình oval bao quanh)
      h('ellipse', {
        attrs: {
          cx: '50',
          cy: '50',
...
// Icon Surge Arrester (Chống sét van)
const IconSurgeArrester = {
  render(h) {
    return h('svg', { attrs: { viewBox: '0 0 100 100' } }, [
      // Dây nối trên và dưới
      h('line', {
        attrs: {
          x1: '50',
          y1: '10',
      ...
      // Ký hiệu mũi tên sét bên trong
      h('path', {
        attrs: {
          d: 'M45 35 L60 45 L40 55 L55 65',
          fill: 'none',
          stroke: 'currentColor',
          'stroke-width': '6',
          'stroke-linecap': 'round',
      ...
      // Mũi tên chỉ xuống đất (bên cạnh)
      h('path', {
        attrs: {
          d: 'M80 30 V70 M80 70 L75 60 M80 70 L85 60',
          fill: 'none',
          stroke: 'currentColor',
          'stroke-width': '4'
        }
...
// Icon Rotating Machine (Máy phát / Động cơ)
const IconRotatingMachine = {
  render(h) {
    return h('svg', { attrs: { viewBox: '0 0 100 100' } }, [
      ...
      // Sóng hình sin (biểu thị AC) bên trong
      h('path', {
        attrs: {
...
// Icon Reactor (Kháng điện / Cuộn cảm)
const IconReactor = {
  render(h) {
    return h('svg', { attrs: { viewBox: '0 0 100 100' } }, [
      // Dây dẫn vào
      ...
      // Các vòng dây (Semicircles)
      h('path', {
        attrs: {
          d: 'M50 20 A 15 15 0 0 1 50 50 A 15 15 0 0 1 50 80',
          fill: 'none',
          stroke: 'currentColor',
          'stroke-width': '8',
          'stroke-linecap': 'round'
