...
export const ASSET_CONFIG = {
  Asset_VoltageTransformerDto: {
    DtoClass: VoltageTransformerDto,
    mapper: vtMapDtoToEntity,
    api: 'insertVoltageTransformerEntity'
  },
  Asset_CurrentTransformerDto: {
    DtoClass: CurrentTransformerDto,
    mapper: ctMapDtoToEntity,
    api: 'insertCurrentTransformerEntity'
  },
  Asset_TransformerDataDto: {
    DtoClass: TransformerDto,
    mapper: tfMapDtoToEntity,
    api: 'insertTransformerEntity'
  },
  Asset_CircuitBreakerDto: {
    DtoClass: CircuitBreakerDto,
    mapper: breakerMapDtoToEntity,
    api: 'insertBreakerEntity'
  },
  Asset_PowerCableDTO: {
    DtoClass: PowerCableDto,
    mapper: cableMapDtoToEntity,
    api: 'insertPowerCableEntity'
  },
  Asset_SurgeArresterDto: {
    DtoClass: SurgeArresterDto,
    mapper: saMapDtoToEntity,
    api: 'insertSurgeArresterEntity'
  },
  Asset_ReactorDto: {
    DtoClass: ReactorDto,
    mapper: reactorMapDtoToEntity,
    api: 'insertReactorEntity'
  },
  Asset_CapacitorsDTO: {
    DtoClass: CapacitorDto,
    mapper: capacitorMapDtoToEntity,
    api: 'insertCapacitorEntity'
  },
  Asset_DisconnectorDTO: {
    DtoClass: DisconnectorDto,
    mapper: disconnectorMapDtoToEntity,
    api: 'insertDisconnectorEntity',
    singleArg: true
  },
  Asset_RotatingMachineDTO: {
    DtoClass: RotatingMachineDto,
    mapper: rotatingMapDtoToEntity,
    api: 'insertRotatingMachineEntity',
    singleArg: true
  },
  Asset_BushingAssetDto: {
    DtoClass: BushingDto,
    mapper: bushingMapDtoToEntity,
    api: 'insertBushingEntity',
    singleArg: true
  }
}
...
export const JOB_CONFIG = {
  Job_TransformerJobDto: {
    mapper: tfJobDtoToEntity,
    api: 'insertTransformerJob',
    testTypeKey: 'transformerTestingEquipmentTestType'
  },
  Job_VoltageTransformerJobDto: {
    mapper: vtJobDtoToEntity,
    api: 'insertVoltageTransformerJob',
    testTypeKey: 'voltageTransformerTestingEquipmentTestType'
  },
  Job_CurrentTransformerJobDto: {
    mapper: ctJobDtoToEntity,
    api: 'insertCurrentTransformerJob',
    testTypeKey: 'currentTransformerTestingEquipmentTestType'
  },
  Job_CircuitBreakerJobDto: {
    mapper: brJobDtoToEntity,
    api: 'insertCircuitBreakerJob',
    testTypeKey: 'circuitBreakerTestingEquipmentTestType'
  },
  Job_PowerCableJobDto: {
    mapper: caJobDtoToEntity,
    api: 'insertPowerCableJob',
    testTypeKey: 'powerCableTestingEquipmentTestType'
  },
  Job_SurgeArresterJobDto: {
    mapper: saJobDtoToEntity,
    api: 'insertSurgeArresterJob',
    testTypeKey: 'surgeArresterTestingEquipmentTestType'
  },
  Job_ReactorJobDto: {
    mapper: reJobDtoToEntity,
    api: 'insertReactorJob',
    testTypeKey: 'reactorTestingEquipmentTestType'
  },
  Job_CapacitorJobDto: {
    mapper: cpJobDtoToEntity,
    api: 'insertCapacitorJob',
    testTypeKey: 'capacitorTestingEquipmentTestType'
  },
  Job_DisconnectorJobDto: {
    mapper: dcJobDtoToEntity,
    api: 'insertDisconnectorJob',
    testTypeKey: 'disconnectorTestingEquipmentTestType'
  },
  Job_RotatingMachineJobDto: {
    mapper: rmJobDtoToEntity,
    api: 'insertRotatingMachineJob',
    testTypeKey: 'rotatingMachineTestingEquipmentTestType'
  },
  Job_BushingJobDto: {
    mapper: buJobDtoToEntity,
    api: 'insertBushingJob',
    testTypeKey: 'bushingTestingEquipmentTestType'
  }
}
