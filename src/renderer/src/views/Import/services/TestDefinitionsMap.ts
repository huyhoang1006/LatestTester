...
export const TEST_DEFINITIONS = {
  ...
  Job_VoltageTransformerJobDto: buildDefs(
    voltageTransformerTestMap,
    voltageTransformerConditionMap
  ),
  Job_CurrentTransformerJobDto: buildDefs(
    currentTransformerTestMap,
    currentTransformerConditionMap
  ),
