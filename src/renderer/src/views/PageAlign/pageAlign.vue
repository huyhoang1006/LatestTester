<template>
  <div
    ...
    "
  >
    <p @click="firstUserPage()" style="margin-right: 10px">
      <i class="fa-solid fa-angles-left"></i>
    </p>
    <p @click="previousUser()"><i class="fa-solid fa-circle-chevron-left"></i></p>
    <p :id="'firstUserPage' + title" @click="firstUser()" style="margin-left: 5px">
      {{ pageUser.first }}
    </p>
    <p
      :id="'secondUserPage' + title"
      v-if="displayPageUser.second"
      @click="secondUser()"
    ...
    <p
      :id="'thirdUserPage' + title"
      v-if="displayPageUser.third"
      @click="thirdUser()"
      style="margin-left: 5px"
    >
      {{ pageUser.third }}
    ...
    <p
      :id="'dotUserPage' + title"
      v-if="displayPageUser.dot"
      @click="dotUser()"
      style="margin-left: 5px"
    >
      {{ pageUser.dot }}
    ...
    <p
      :id="'endUserPage' + title"
      v-if="displayPageUser.end"
      @click="endUser()"
      style="margin-left: 5px"
    >
      {{ pageUser.end }}
    </p>
    <p @click="nextUser()" style="margin-left: 5px">
    ...
    firstUserPage() {
      ...
      for (let i in Object.keys(this.pageUserInstance)) {
        if (this.pageUserInstance[Object.keys(this.pageUserInstance)[i]] != null) {
          this.pageUserInstance[Object.keys(this.pageUserInstance)[i]]['style']['backgroundColor'] =
            'white'
