...
export function mapDtoToEntity(dto) {
  ...
  currentFlow.unit =
    unitPartsRatedCurrent.length > 1 ? unitPartsRatedCurrent[1] : unitPartsRatedCurrent[0] || null
  ...
  frequency.unit =
    unitPartsRatedFrequency.length > 1
      ? unitPartsRatedFrequency[1]
      : unitPartsRatedFrequency[0] || null
  ...
  voltageVolGround.unit =
    unitPartsVolGround.length > 1 ? unitPartsVolGround[1] : unitPartsVolGround[0] || null
  ...
  HighVoLlimit.unit =
    unitPartsHighVoLlimit.length > 1 ? unitPartsHighVoLlimit[1] : unitPartsHighVoLlimit[0] || null
...
export const bushingDtoToEntity = mapDtoToEntity
export const bushingEntityToDto = mapEntityToDto
