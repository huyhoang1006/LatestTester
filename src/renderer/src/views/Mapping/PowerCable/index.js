...
export function mapDtoToEntity(dto) {
  ...
  if (dto.datasData.conductor.conductor_material.value !== 'Custom') {
    ...
    entity.concentricNeutral.material =
  ...
  entity.oldCableInfo.nominal_conductor_diameter =
    dto.datasData.conductor.conductor_diameter.mrid || null
  ...
  /** ================== conductor shield ================== */
  entity.oldCableInfo.conductor_shield_thickness =
    dto.datasData.conductor_shield.thickness.mrid || null
  ...
  /** ================== insulation ================== */
  entity.oldCableInfo.insulation_max_operating_temp =
    dto.datasData.insulation.insulation_operating.mrid || null
  ...
  if (dto.datasData.insulation.insulation_type.value !== 'Custom') {
    entity.concentricNeutral.insulation_material =
  ...
  if (dto.datasData.insulation_screen.material.value !== 'Custom') {
    ...
    entity.oldCableInfo.screen_material =
  ...
  entity.concentricNeutral.diameter_over_screen =
    dto.datasData.insulation_screen.diameter.mrid || null
  ...
  if (dto.datasData.armour_bedding.material.value !== 'Custom') {
    entity.oldCableInfo.armour_bedding_material =
  ...
  entity.oldCableInfo.diameter_bedding_over_armour =
    dto.datasData.armour_bedding.diameter.mrid || null
  ...
  if (dto.datasData.sheath_reinforcing.material.value !== 'Custom') {
    entity.oldCableInfo.sheath_reinforcing_material =
  ...
  entity.oldCableInfo.sheath_reinforcing_thickness =
    dto.datasData.sheath_reinforcing.thickness.mrid || null
  ...
  entity.oldCableInfo.diameter_over_sheath_reinforcing =
    dto.datasData.sheath_reinforcing.diameter.mrid || null
  ...
  entity.oldCableInfo.sheath_reinforcing_length_lay =
    dto.datasData.sheath_reinforcing.lengthOfLay.mrid || null
  ...
  entity.oldCableInfo.sheath_reinforcing_no_tape =
    dto.datasData.sheath_reinforcing.numOfTapes.value || null

  /** ================== concentric neutral ================== */
  if (dto.datasData.concentric_neutral.material.value !== 'Custom') {
    entity.oldCableInfo.concentric_material =
  ...
  if (dto.datasData.concentric_neutral.construction.value !== 'Custom') {
    entity.oldCableInfo.concentric_contruction =
  ...
  entity.concentricNeutral.diameter_over_neutral =
    dto.datasData.concentric_neutral.diameter.mrid || null
  ...
  entity.oldCableInfo.concentric_length_lay =
    dto.datasData.concentric_neutral.lengthOfLay.mrid || null
  ...
  entity.oldCableInfo.concentric_no_of_wires =
    dto.datasData.concentric_neutral.numOfWires.value || null
  ...
  entity.oldCableInfo.armour_cross_sectional_area_tap =
    dto.datasData.armour.crossSectional.mrid || null
  ...
  if (dto.datasData.oversheath.material.value !== 'Custom') {
    ...
    entity.concentricNeutral.outer_jacket_kind =
  ...
  entity.sheathVoltageLimiter.rated_voltage_ur =
    dto.datasData.sheathLimitsData.rated_voltage_ur.mrid || null
  ...
  entity.sheathVoltageLimiter.max_continuous_operating_voltage =
    dto.datasData.sheathLimitsData.max_continuous_operating_voltage.mrid || null
  ...
  entity.sheathVoltageLimiter.nominal_discharge_current =
    dto.datasData.sheathLimitsData.nominal_discharge_current.mrid || null
  ...
  entity.sheathVoltageLimiter.high_current_impulse_withstand =
    dto.datasData.sheathLimitsData.high_current_impulse_withstand.mrid || null
  ...
  entity.sheathVoltageLimiter.long_duration_current_impulse_withstand =
    dto.datasData.sheathLimitsData.long_duration_current_impulse_withstand.mrid || null
  const newSheathLongCurrent = new CurrentFlow()
  mappingUnit(
    newSheathLongCurrent,
    dto.datasData.sheathLimitsData.long_duration_current_impulse_withstand
  )
  entity.currentFlow.push(newSheathLongCurrent)
  entity.sheathVoltageLimiter.short_circuit_withstand =
    dto.datasData.sheathLimitsData.short_circuit_withstand.mrid || null
...
export function mapEntityToDto(entity) {
  ...
  // ================== phases ==================
  dto.configsData.phases.value =
    entity.oldCableInfo.phase_count != null ? Number(entity.oldCableInfo.phase_count) : null
  dto.configsData.cores.value =
    entity.oldCableInfo.core_count != null ? String(entity.oldCableInfo.core_count) : null
  ...
  dto.datasData.conductor.conductor_diameter.mrid =
    entity.oldCableInfo.nominal_conductor_diameter || null
  for (const length of entity.length) {
  ...
  const conductorMaterialOptions = [
    'Copper, plain wires',
    'Copper, metal-coated wires',
    'Alluminium wires',
    'Alluminium alloy wires'
  ]
  if (conductorMaterialOptions.includes(entity.concentricNeutral.material)) {
    ...
    dto.datasData.conductor.conductor_material_custom.value =
      entity.concentricNeutral.material || null
  }
  // ================== conductor shield ==================
  dto.datasData.conductor_shield.thickness.mrid =
    entity.oldCableInfo.conductor_shield_thickness || null
  for (const length of entity.length) {
  ...
  // ================== sheath ==================
  const sheathTypeOptions = ['Corrugated', 'Alumiminum', 'Cooper', 'Lead']
  ...
  if (insulationTypeOptions.includes(entity.concentricNeutral.insulation_material)) {
    dto.datasData.insulation.insulation_type.value =
      entity.concentricNeutral.insulation_material || null
  } else if (entity.concentricNeutral.insulation_material == null) {
    dto.datasData.insulation.insulation_type.value = null
    dto.datasData.insulation.insulation_type_custom.value = null
  } else {
    dto.datasData.insulation.insulation_type.value = 'Custom'
    dto.datasData.insulation.insulation_type_custom.value =
      entity.concentricNeutral.insulation_material || null
  }
  dto.datasData.insulation.insulation_operating.mrid =
    entity.oldCableInfo.insulation_max_operating_temp || null
  const insulationOperatingObj = entity.temperature.find(
    (t) => t && dto.datasData.insulation.insulation_operating.mrid === t.mrid
  )
  dto.datasData.insulation.insulation_operating.value = insulationOperatingObj
    ? insulationOperatingObj.value || null
    : null
  ...
  if (insulationScreenMaterialOptions.includes(entity.oldCableInfo.screen_material)) {
    ...
    dto.datasData.insulation_screen.material_custom.value =
      entity.oldCableInfo.screen_material || null
  }
  ...
  dto.datasData.insulation_screen.diameter.mrid =
    entity.concentricNeutral.diameter_over_screen || null
  for (const length of entity.length) {
  ...
  if (armourBeddingMaterialOptions.includes(entity.oldCableInfo.armour_bedding_material)) {
    dto.datasData.armour_bedding.material.value =
      entity.oldCableInfo.armour_bedding_material || null
  } else if (entity.oldCableInfo.armour_bedding_material == null) {
    dto.datasData.armour_bedding.material.value = null
    dto.datasData.armour_bedding.material_custom.value = null
  } else {
    dto.datasData.armour_bedding.material.value = 'Custom'
    dto.datasData.armour_bedding.material_custom.value =
      entity.oldCableInfo.armour_bedding_material || null
  }
  ...
  dto.datasData.armour_bedding.diameter.mrid =
    entity.oldCableInfo.diameter_bedding_over_armour || null
  for (const length of entity.length) {
  ...
  if (sheathReinforcingMaterialOptions.includes(entity.oldCableInfo.sheath_reinforcing_material)) {
    dto.datasData.sheath_reinforcing.material.value =
      entity.oldCableInfo.sheath_reinforcing_material || null
  } else if (entity.oldCableInfo.sheath_reinforcing_material == null) {
    dto.datasData.sheath_reinforcing.material.value = null
    dto.datasData.sheath_reinforcing.material_custom.value = null
  } else {
    dto.datasData.sheath_reinforcing.material.value = 'Custom'
    dto.datasData.sheath_reinforcing.material_custom.value =
      entity.oldCableInfo.sheath_reinforcing_material || null
  }

  dto.datasData.sheath_reinforcing.thickness.mrid =
    entity.oldCableInfo.sheath_reinforcing_thickness || null
  for (const length of entity.length) {
  ...
  dto.datasData.sheath_reinforcing.diameter.mrid =
    entity.oldCableInfo.diameter_over_sheath_reinforcing || null
  for (const length of entity.length) {
  ...
  dto.datasData.sheath_reinforcing.lengthOfLay.mrid =
    entity.oldCableInfo.sheath_reinforcing_length_lay || null
  for (const length of entity.length) {
  ...
  dto.datasData.sheath_reinforcing.numOfTapes.value =
    entity.oldCableInfo.sheath_reinforcing_no_tape || null
  ...
  if (concentricNeutralMaterialOptions.includes(entity.oldCableInfo.concentric_material)) {
    dto.datasData.concentric_neutral.material.value =
      entity.oldCableInfo.concentric_material || null
  } else if (entity.oldCableInfo.concentric_material == null) {
    dto.datasData.concentric_neutral.material.value = null
    dto.datasData.concentric_neutral.material_custom.value = null
  } else {
    dto.datasData.concentric_neutral.material.value = 'Custom'
    dto.datasData.concentric_neutral.material_custom.value =
      entity.oldCableInfo.concentric_material || null
  }

  const concentricNeutralConstructionOptions = ['Round wires', 'Flat straps']
  if (concentricNeutralConstructionOptions.includes(entity.oldCableInfo.concentric_contruction)) {
    dto.datasData.concentric_neutral.construction.value =
      entity.oldCableInfo.concentric_contruction || null
  } else if (entity.oldCableInfo.concentric_contruction == null) {
    dto.datasData.concentric_neutral.construction.value = null
    dto.datasData.concentric_neutral.construction_custom.value = null
  } else {
    dto.datasData.concentric_neutral.construction.value = 'Custom'
    dto.datasData.concentric_neutral.construction_custom.value =
      entity.oldCableInfo.concentric_contruction || null
  }
  ...
  dto.datasData.concentric_neutral.diameter.mrid =
    entity.concentricNeutral.diameter_over_neutral || null
  for (const length of entity.length) {
  ...
  dto.datasData.concentric_neutral.lengthOfLay.mrid =
    entity.oldCableInfo.concentric_length_lay || null
  for (const length of entity.length) {
  ...
  dto.datasData.concentric_neutral.numOfWires.value =
    entity.oldCableInfo.concentric_no_of_wires || null
  ...
  dto.datasData.armour.crossSectional.mrid =
    entity.oldCableInfo.armour_cross_sectional_area_tap || null
  for (const area of entity.area) {
  ...
  if (oversheathMaterialOptions.includes(entity.concentricNeutral.outer_jacket_kind)) {
    ...
    dto.datasData.oversheath.material_custom.value =
      entity.concentricNeutral.outer_jacket_kind || null
  }
  ...
  // Sheath Voltage Limiter
  dto.datasData.sheathLimitsData.rated_voltage_ur.mrid =
    entity.sheathVoltageLimiter.rated_voltage_ur || null
  for (const voltage of entity.voltage) {
  ...
  dto.datasData.sheathLimitsData.max_continuous_operating_voltage.mrid =
    entity.sheathVoltageLimiter.max_continuous_operating_voltage || null
  for (const voltage of entity.voltage) {
    if (
      voltage &&
      dto.datasData.sheathLimitsData.max_continuous_operating_voltage.mrid === voltage.mrid
    ) {
      dto.datasData.sheathLimitsData.max_continuous_operating_voltage.value = voltage.value || null
      break
    }
  }
  dto.datasData.sheathLimitsData.nominal_discharge_current.mrid =
    entity.sheathVoltageLimiter.nominal_discharge_current || null
  for (const current of entity.currentFlow) {
  ...
  dto.datasData.sheathLimitsData.high_current_impulse_withstand.mrid =
    entity.sheathVoltageLimiter.high_current_impulse_withstand || null
  for (const current of entity.currentFlow) {
    if (
      current &&
      dto.datasData.sheathLimitsData.high_current_impulse_withstand.mrid === current.mrid
    ) {
      dto.datasData.sheathLimitsData.high_current_impulse_withstand.value = current.value || null
      break
    }
  }
  dto.datasData.sheathLimitsData.long_duration_current_impulse_withstand.mrid =
    entity.sheathVoltageLimiter.long_duration_current_impulse_withstand || null
  for (const current of entity.currentFlow) {
    if (
      current &&
      dto.datasData.sheathLimitsData.long_duration_current_impulse_withstand.mrid === current.mrid
    ) {
      dto.datasData.sheathLimitsData.long_duration_current_impulse_withstand.value =
        current.value || null
      break
    }
  }
  dto.datasData.sheathLimitsData.short_circuit_withstand.mrid =
    entity.sheathVoltageLimiter.short_circuit_withstand || null
  for (const current of entity.currentFlow) {
  ...
  dto.layersData.conductor = !!(
    dto.datasData.conductor.conductor_size.value ||
    dto.datasData.conductor.conductor_class.value ||
    dto.datasData.conductor.conductor_material.value ||
    dto.datasData.conductor.conductor_type.value ||
    dto.datasData.conductor.conductor_diameter.value
  )
  dto.layersData.insulation = !!(
    dto.datasData.insulation.insulation_type.value ||
    dto.datasData.insulation.thickness.value ||
    dto.datasData.insulation.diameter.value ||
    dto.datasData.insulation.insulation_operating.value
  )
  dto.layersData.sheath_reinforcing = !!(
    dto.datasData.sheath_reinforcing.material.value ||
    dto.datasData.sheath_reinforcing.thickness.value ||
    dto.datasData.sheath_reinforcing.diameter.value ||
    dto.datasData.sheath_reinforcing.width.value ||
    dto.datasData.sheath_reinforcing.lengthOfLay.value ||
    dto.datasData.sheath_reinforcing.numOfTapes.value
  )
  dto.layersData.armour = !!(
    dto.datasData.armour.material.value ||
    dto.datasData.armour.thickness.value ||
    dto.datasData.armour.diameter.value ||
    dto.datasData.armour.layerOfTapes.value ||
    dto.datasData.armour.crossSectional.value
  )
  dto.layersData.conductor_shield = !!(
    dto.datasData.conductor_shield.thickness.value || dto.datasData.conductor_shield.diameter.value
  )
  dto.layersData.insulation_screen = !!(
    dto.datasData.insulation_screen.material.value ||
    dto.datasData.insulation_screen.thickness.value ||
    dto.datasData.insulation_screen.diameter.value
  )
  dto.layersData.concentric_neutral = !!(
    dto.datasData.concentric_neutral.material.value ||
    dto.datasData.concentric_neutral.construction.value ||
    dto.datasData.concentric_neutral.thickness.value ||
    dto.datasData.concentric_neutral.diameter.value ||
    dto.datasData.concentric_neutral.area.value ||
    dto.datasData.concentric_neutral.lengthOfLay.value ||
    dto.datasData.concentric_neutral.numOfWires.value
  )
  dto.layersData.oversheath = !!(
    dto.datasData.oversheath.material.value ||
    dto.datasData.oversheath.thickness.value ||
    dto.datasData.oversheath.diameter.value
  )
  dto.layersData.sheath = !!(
    dto.datasData.sheath.sheath_type.value ||
    dto.datasData.sheath.construction.value ||
    dto.datasData.sheath.thickness.value ||
    dto.datasData.sheath.diameter.value ||
    dto.datasData.sheath.multicore.value
  )
  dto.layersData.armour_bedding = !!(
    dto.datasData.armour_bedding.material.value ||
    dto.datasData.armour_bedding.thickness.value ||
    dto.datasData.armour_bedding.diameter.value
  )
