...
const SA_DISCRETE_ALIAS_TO_VALUE = (() => {
  const map = {}
  const collect = (cfg) => {
...
const discreteToValue = (measurementId, value) => {
  ...
  const m = measurementId && SA_DISCRETE_ALIAS_TO_VALUE[measurementId]
...
// ═══════════════════════════════════════════════════════════════════════════════
// Mapper: DTO Job (Surge Arrester) → server JSON (upload)
//
...
export const mapDtoToServer = (dto) => {
  ...
  return {
    ...
    testingEquipmentList: (dto.testingEquipmentData || []).map((e) => ({
      ...
      testTypeIds: e.test_type_surge_arrester_id || []
    })),
...
export const mapServerToDto = (server) => {
  ...
  return {
    ...
    surgeArresterTestingEquipmentTestType: server.surgeArresterTestingEquipmentTestType || [],
