...
const CT_DISCRETE_ALIAS_TO_VALUE = (() => {
  const map = {}
  const collect = (cfg) => {
  ...
  collect(currentTransformerTestMap)
  collect(currentTransformerConditionMap)
  return map
})()
...
const discreteToValue = (measurementId, value) => {
  ...
  const m = measurementId && CT_DISCRETE_ALIAS_TO_VALUE[measurementId]
...
// ═══════════════════════════════════════════════════════════════════════════════
// Mapper: DTO Job (Current Transformer) → server JSON (upload)
//
...
export const mapDtoToServer = (dto) => {
  ...
  return {
    ...
    testingEquipmentList: (dto.testingEquipmentData || []).map((e) => ({
      ...
      testTypeIds: e.test_type_current_transformer_id || []
    })),
...
export const mapServerToDto = (server) => {
  ...
  return {
    ...
    currentTransformerTestingEquipmentTestType:
      server.currentTransformerTestingEquipmentTestType || [],
