...
const num = (val) => (val !== null && val !== undefined && val !== '' ? parseFloat(val) : null)

const str = (val) => (val !== null && val !== undefined && val !== '' ? String(val) : null)
  ...
  return {
    CurrentTransformer: {
      properties: {
        ...
        type: ASSET_TYPE_TO_SERVER[dto.properties?.asset_type] || dto.properties?.type || null,
      ...
      ratings: {
        standard: {
          ...
          value: (() => {
            const raw =
              typeof ratings.standard === 'string'
                ? ratings.standard
        ...
        system_voltage_type:
          ratings.system_voltage_type?.value || ratings.system_voltage_type || null,
