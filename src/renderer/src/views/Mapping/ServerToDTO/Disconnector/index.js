...
export const mapServerToDto = (serverData) => {
  ...
  dto.ratings.short_time_withstand_current = mapRating(
    core.shortTimeWithstandCurrent,
    core.shortTimeWithstandCurrentUnit
  )
  dto.ratings.rated_duration_of_short_circuit = mapRating(
    core.shortCircuitRatedDuration,
    core.shortCircuitRatedDurationUnit
  )
  dto.ratings.power_freq_withstand_voltage_earth_poles = mapRating(
    core.pfWithstandToEarthPoles,
    core.pfWithstandToEarthPolesUnit
  )
  dto.ratings.power_freq_withstand_voltage_isolating_distance = mapRating(
    core.pfWithstandIsolatingDistance,
    core.pfWithstandIsolatingDistanceUnit
  )
