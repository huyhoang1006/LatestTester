...
export const mapServerToDto = (serverData) => {
  ...
  dto.properties.manufacturing_year = info.manufacturingYear ? String(info.manufacturingYear) : ''
  ...
  // Rated frequency
  const freqValue =
    core.ratedFrequency !== null && core.ratedFrequency !== undefined
  ...
  dto.vt_Configuration.dataVT = configList.map((config) => {
    ...
    return {
      ...
      rated_burden: {
        ...
        unit: burdenMultUI
          ? `${burdenMultUI}|${config.ratedBurdenUnit || 'VA'}`
          : config.ratedBurdenUnit || 'VA',
  ...
  return {
    VoltageTransformer: {
      ...
      properties: {
        mrid: dto.properties?.mrid || null,
        type:
          ASSET_TYPE_TO_SERVER[dto.properties?.asset_type] || dto.properties?.asset_type || null,
        ...
        manufacturer_year:
          dto.properties?.manufacturing_year || dto.properties?.manufacturer_year || null,
      ...
      ratings: {
        ...
        standard: {
          ...
          value: (() => {
            const raw =
              typeof dto.ratings?.standard === 'string'
      ...
      vt_Configuration: {
        ...
        dataVT: (dto.vt_Configuration?.dataVT || []).map((vt) => ({
          ...
          usr_formula: {
            ...
            value: (() => {
              const raw =
                typeof vt.usr_formula === 'string' ? vt.usr_formula : vt.usr_formula?.value || null
          ...
          usr_rated_voltage: {
            ...
            value: vt.usr_rated_voltage?.value ? parseFloat(vt.usr_rated_voltage.value) : null,
          ...
          rated_burden: {
            ...
            value: vt.rated_burden?.value ? parseFloat(vt.rated_burden.value) : null,
          ...
          rated_power_factor: {
            mrid: null,
            value:
              typeof vt.rated_power_factor === 'number'
