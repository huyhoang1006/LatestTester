...
const DC_DISCRETE_ALIAS_TO_VALUE = (() => {
  const map = {}
  const collect = (cfg) => {
  ...
  collect(disconnectorTestMap)
  collect(disconnectorConditionMap)
  return map
})()
...
const discreteToValue = (measurementId, value) => {
  ...
  const m = measurementId && DC_DISCRETE_ALIAS_TO_VALUE[measurementId]
...
// ═══════════════════════════════════════════════════════════════════════════════
// Mapper: DTO Job (Disconnector) → server JSON (upload)
//
