...
export const mapServerToDto = (serverData) => {
  ...
  dto.properties.manufacturer_type =
    assetInfo.manufacturerType || opAssetInfo.manufacturerType || ''
  ...
  dto.properties.apparatus_id =
    serverData.lotNumber || assetInfo.productAssetModel || serverData.position || ''
