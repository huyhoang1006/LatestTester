...
export const mapServerToDto = (serverData) => {
  ...
  const actualData =
    serverData.data && serverData.success !== undefined ? serverData.data : serverData
  ...
  dto.ratings.short_circuit.ka.value =
    trans.maxShortCircuitCurrent !== null ? trans.maxShortCircuitCurrent : ''
  ...
  dto.ratings.voltage_ratings = vRatings.map((v) => ({
    ...
    voltage_ll: {
      mrid: '',
      value: v.voltageLL !== null ? v.voltageLL : '',
      unit: v.voltageLLUnit || 'k|V'
    },
    voltage_ln: {
      mrid: '',
      value: v.voltageLN !== null ? v.voltageLN : '',
      unit: v.voltageLNUnit || 'k|V'
    },
    insul_level_ll: {
      mrid: '',
      value: v.insulLevelLL !== null ? v.insulLevelLL : '',
      unit: v.insulLevelLLUnit || 'k|V'
    },
  ...
  dto.ratings.power_ratings = pRatings.map((p) => ({
    ...
    rated_power: {
      mrid: '',
      value: p.ratedPower !== null ? p.ratedPower : '',
      unit: p.ratedPowerUnit || 'M|VA'
    },
  ...
  dto.ratings.current_ratings = pRatings.map((p) => ({
    ...
    prim: {
      ...
      data: {
        mrid: '',
        value: p.currentRatingPrim !== null ? p.currentRatingPrim : '',
        unit: p.currentRatingPrimUnit || 'A'
      }
    },
    sec: {
      mrid: '',
      data: {
        mrid: '',
        value: p.currentRatingSec !== null ? p.currentRatingSec : '',
        unit: p.currentRatingSecUnit || 'A'
      }
    },
  ...
  const mapImp = (imp) => ({
    ...
    base_power: {
      ...
      data: {
        mrid: '',
        value: imp.basePower !== null ? imp.basePower : '',
        unit: imp.basePowerUnit || 'M|VA'
      }
    },
    base_voltage: {
      mrid: '',
      data: {
        mrid: '',
        value: imp.baseVoltage !== null ? imp.baseVoltage : '',
        unit: imp.baseVoltageUnit || 'k|V'
      }
    },
    short_circuit_impedances_uk: {
      mrid: '',
      value: imp.impedance !== null ? imp.impedance : '',
      unit: imp.impedanceUnit || '%'
    },
    load_losses_pk: {
      mrid: '',
      value: imp.loadLoss !== null ? imp.loadLoss : '',
      unit: imp.loadLossUnit || 'kW'
    },
    oltc_position: '',
    detc_position: ''
  })
  ...
  dto.impedances.zero_sequence_impedance.base_power.data.value =
    trans.basePower !== null ? trans.basePower : ''
  dto.impedances.zero_sequence_impedance.base_power.data.unit = trans.basePowerUnit || 'M|VA'

  dto.impedances.zero_sequence_impedance.base_voltage.data.value =
    trans.baseVoltage !== null ? trans.baseVoltage : ''
  ...
  dto.impedances.zero_sequence_impedance.zero_percent.prim.data.value =
    trans.primaryZeroSequence !== null ? trans.primaryZeroSequence : ''
  dto.impedances.zero_sequence_impedance.zero_percent.prim.data.unit = trans.zeroSequenceUnit || '%'

  dto.impedances.zero_sequence_impedance.zero_percent.sec.data.value =
    trans.secondaryZeroSequence !== null ? trans.secondaryZeroSequence : ''
  ...
  if (tapChanger.id) {
    ...
    dto.tap_changers.winding =
      tapChanger.winding === 'PRIM' ? 'Prim' : tapChanger.winding === 'SEC' ? 'Sec' : 'Tert'
