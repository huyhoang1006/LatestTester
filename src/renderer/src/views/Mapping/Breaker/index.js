...
export function mapDtoToEntity(dto) {
  ...
  entity.oldBreakerInfo.number_of_interrupters_per_phase =
    dto.circuitBreaker.interruptersPerPhase || null
  ...
  entity.breakerRatingInfo.rated_short_circuit_breaking_current =
    dto.ratings.rated_short_circuit_breaking_current.mrid || null
  ...
  entity.breakerRatingInfo.short_circuit_nominal_duration =
    dto.ratings.short_circuit_nominal_duration.mrid || null
  ...
  entity.breakerRatingInfo.rated_power_motor_charge =
    dto.ratings.rated_power_at_motor_charge.mrid || null
  ...
  entity.breakerContactSystemInfo.nominal_total_travel =
    dto.contactSystem.nominal_total_travel.mrid || null
  ...
  entity.oldOperatingMechanismInfo.product_asset_model =
    dto.operatingMechanismProductAssetModelId || null
  ...
  entity.oldOperatingMechanismInfo.auxiliary_circuit_power_type =
    dto.operating.auxiliary_circuits.power || null
  entity.oldOperatingMechanismInfo.rated_auxiliary_circuit_current =
    dto.operating.auxiliary_circuits.rated_current.mrid || null
  ...
  entity.oldOperatingMechanismInfo.rated_auxiliary_circuit_voltage =
    dto.operating.auxiliary_circuits.rated_voltage.mrid || null
  ...
  entity.oldOperatingMechanismInfo.rated_auxiliary_circuit_frequency =
    dto.operating.auxiliary_circuits.frequency.mrid || null
  ...
  entity.oldOperatingMechanismInfo.rated_motor_current =
    dto.operating.motor.rated_current.mrid || null
  ...
  entity.oldOperatingMechanismInfo.rated_motor_voltage =
    dto.operating.motor.rated_voltage.mrid || null
  ...
  entity.oldOperatingMechanismInfo.rated_motor_frequency =
    dto.operating.motor.frequency.mrid || null
  ...
  entity.oldOperatingMechanismInfo.rated_operating_pressure =
    dto.operating.rated_operating_pressure.mrid || null
  ...
  entity.oldOperatingMechanismInfo.rated_operating_pressure_temperature =
    dto.operating.rated_operating_pressure_temperature.mrid || null
  ...
  for (const i in dto.operating.trip_coil_component) {
    ...
    tripCoilComponent.rated_current =
      dto.operating.trip_coil_component[i].rated_current.mrid || null
    ...
    tripCoilComponent.rated_voltage =
      dto.operating.trip_coil_component[i].rated_voltage.mrid || null
  ...
  for (const i in dto.operating.close_coil_component) {
    ...
    closeCoilComponent.rated_current =
      dto.operating.close_coil_component[i].rated_current.mrid || null
    const ratedCurrent = new CurrentFlow()
    mappingUnit(ratedCurrent, dto.operating.close_coil_component[i].rated_current)
    entity.currentFlow.push(ratedCurrent)

    closeCoilComponent.rated_voltage =
      dto.operating.close_coil_component[i].rated_voltage.mrid || null
    const ratedVoltage = new Voltage()
    mappingUnit(ratedVoltage, dto.operating.close_coil_component[i].rated_voltage)
    entity.voltage.push(ratedVoltage)

    closeCoilComponent.rated_frequency =
      dto.operating.close_coil_component[i].frequency.mrid || null
    const ratedFrequency = new Frequency()
  ...
  contactResistanceBreakerInfo.assessment_limit_breaker_info_id =
    dto.assessmentLimitBreakerInfoId || null
  contactResistanceBreakerInfo.r_min =
    dto.assessmentLimits.contact_resistance.abs.r_min.mrid || null
  const rMin = new Resistance()
  mappingUnit(rMin, dto.assessmentLimits.contact_resistance.abs.r_min)
  entity.resistance.push(rMin)
  contactResistanceBreakerInfo.r_max =
    dto.assessmentLimits.contact_resistance.abs.r_max.mrid || null
  const rMax = new Resistance()
  mappingUnit(rMax, dto.assessmentLimits.contact_resistance.abs.r_max)
  entity.resistance.push(rMax)
  contactResistanceBreakerInfo.r_ref =
    dto.assessmentLimits.contact_resistance.rel.r_ref.mrid || null
  const rRef = new Resistance()
  mappingUnit(rRef, dto.assessmentLimits.contact_resistance.rel.r_ref)
  entity.resistance.push(rRef)
  contactResistanceBreakerInfo.r_dev =
    dto.assessmentLimits.contact_resistance.rel.r_dev.mrid || null
  ...
  for (const i in breaker_constant.opening_times) {
    ...
    operatingTimeBreakerInfo.mrid =
      dto.assessmentLimits.operating_time.abs[breaker_constant.opening_times[i].value].mrid || null
    operatingTimeBreakerInfo.parameter_name = breaker_constant.opening_times[i].label || null
    operatingTimeBreakerInfo.assessment_limit_breaker_info_id =
      dto.assessmentLimitBreakerInfoId || null
    operatingTimeBreakerInfo.t_min =
      dto.assessmentLimits.operating_time.abs[breaker_constant.opening_times[i].value].t_min.mrid ||
      null
    const tMin = new Seconds()
    mappingUnit(
      tMin,
      dto.assessmentLimits.operating_time.abs[breaker_constant.opening_times[i].value].t_min
    )
    entity.second.push(tMin)
    operatingTimeBreakerInfo.t_max =
      dto.assessmentLimits.operating_time.abs[breaker_constant.opening_times[i].value].t_max.mrid ||
      null
    const tMax = new Seconds()
    mappingUnit(
      tMax,
      dto.assessmentLimits.operating_time.abs[breaker_constant.opening_times[i].value].t_max
    )
    entity.second.push(tMax)
    operatingTimeBreakerInfo.t_ref =
      dto.assessmentLimits.operating_time.rel[breaker_constant.opening_times[i].value].t_ref.mrid ||
      null
    const tRef = new Seconds()
    mappingUnit(
      tRef,
      dto.assessmentLimits.operating_time.rel[breaker_constant.opening_times[i].value].t_ref
    )
    entity.second.push(tRef)
    operatingTimeBreakerInfo.t_dev_position =
      dto.assessmentLimits.operating_time.rel[breaker_constant.opening_times[i].value].plus_t_dev
        .mrid || null
    ...
    operatingTimeBreakerInfo.t_dev_negative =
      dto.assessmentLimits.operating_time.rel[breaker_constant.opening_times[i].value].minus_t_dev
        .mrid || null
  ...
  for (const i in breaker_constant.contact_travel) {
    ...
    contactTravelBreakerInfo.mrid =
      dto.assessmentLimits.contact_travel.abs[breaker_constant.contact_travel[i].value].mrid || null
    contactTravelBreakerInfo.parameter_name = breaker_constant.contact_travel[i].label || null
    contactTravelBreakerInfo.assessment_limit_breaker_info_id =
      dto.assessmentLimitBreakerInfoId || null
    contactTravelBreakerInfo.d_min =
      dto.assessmentLimits.contact_travel.abs[breaker_constant.contact_travel[i].value].d_min
        .mrid || null
    ...
    contactTravelBreakerInfo.d_max =
      dto.assessmentLimits.contact_travel.abs[breaker_constant.contact_travel[i].value].d_max
        .mrid || null
    ...
    contactTravelBreakerInfo.d_ref =
      dto.assessmentLimits.contact_travel.rel[breaker_constant.contact_travel[i].value].d_ref
        .mrid || null
    ...
    contactTravelBreakerInfo.d_dev =
      dto.assessmentLimits.contact_travel.rel[breaker_constant.contact_travel[i].value].d_dev
        .mrid || null
  ...
  entity.auxiliaryContactsBreakerInfo.assessment_limit_breaker_info_id =
    dto.assessmentLimitBreakerInfoId || null
  ...
  for (const i in breaker_constant.auxiliary_contact) {
    ...
    tripOperation.mrid =
      dto.assessmentLimits.auxiliary_contacts.trip_operation.abs[
        breaker_constant.auxiliary_contact[i].value
      ].mrid || null
    tripOperation.parameter_name = breaker_constant.auxiliary_contact[i].label || null
    tripOperation.auxiliary_contacts_breaker_info_id =
      dto.assessmentLimits.auxiliary_contacts.mrid || null
    tripOperation.t_min =
      dto.assessmentLimits.auxiliary_contacts.trip_operation.abs[
        breaker_constant.auxiliary_contact[i].value
      ].t_min.mrid || null
    ...
    entity.second.push(tMax)
    tripOperation.t_ref =
      dto.assessmentLimits.auxiliary_contacts.trip_operation.rel[
        breaker_constant.auxiliary_contact[i].value
      ].t_ref.mrid || null
    const tRef = new Seconds()
    mappingUnit(
  ...
  for (const i in breaker_constant.auxiliary_contact) {
    ...
    closeOperation.mrid =
      dto.assessmentLimits.auxiliary_contacts.close_operation.abs[
        breaker_constant.auxiliary_contact[i].value
      ].mrid || null
    closeOperation.parameter_name = breaker_constant.auxiliary_contact[i].label || null
    closeOperation.auxiliary_contacts_breaker_info_id =
      dto.assessmentLimits.auxiliary_contacts.mrid || null
    closeOperation.t_min =
      dto.assessmentLimits.auxiliary_contacts.close_operation.abs[
        breaker_constant.auxiliary_contact[i].value
      ].t_min.mrid || null
    const tMin = new Seconds()
    ...
    entity.second.push(tMax)
    closeOperation.t_ref =
      dto.assessmentLimits.auxiliary_contacts.close_operation.rel[
        breaker_constant.auxiliary_contact[i].value
      ].t_ref.mrid || null
    const tRef = new Seconds()
    mappingUnit(
  ...
  for (const i in breaker_constant.miscellaneous) {
    ...
    miscellaneousBreakerInfo.mrid =
      dto.assessmentLimits.miscellaneous.abs[breaker_constant.miscellaneous[i].value].mrid || null
    miscellaneousBreakerInfo.parameter_name = breaker_constant.miscellaneous[i].label || null
    miscellaneousBreakerInfo.assessment_limit_breaker_info_id =
      dto.assessmentLimitBreakerInfoId || null
    miscellaneousBreakerInfo.min =
      dto.assessmentLimits.miscellaneous.abs[breaker_constant.miscellaneous[i].value].min.mrid ||
      null
    const min = new QuantityValue()
    mappingUnit(
      min,
      dto.assessmentLimits.miscellaneous.abs[breaker_constant.miscellaneous[i].value].min
    )
    entity.quantity.push(min)
    miscellaneousBreakerInfo.max =
      dto.assessmentLimits.miscellaneous.abs[breaker_constant.miscellaneous[i].value].max.mrid ||
      null
    const max = new QuantityValue()
    mappingUnit(
      max,
      dto.assessmentLimits.miscellaneous.abs[breaker_constant.miscellaneous[i].value].max
    )
    entity.quantity.push(max)
    miscellaneousBreakerInfo.ref =
      dto.assessmentLimits.miscellaneous.rel[breaker_constant.miscellaneous[i].value].ref.mrid ||
      null
    const ref = new QuantityValue()
    mappingUnit(
      ref,
      dto.assessmentLimits.miscellaneous.rel[breaker_constant.miscellaneous[i].value].ref
    )
    entity.quantity.push(ref)
    miscellaneousBreakerInfo.dev =
      dto.assessmentLimits.miscellaneous.rel[breaker_constant.miscellaneous[i].value].dev.mrid ||
      null
    const dev = new QuantityValue()
    mappingUnit(
      dev,
      dto.assessmentLimits.miscellaneous.rel[breaker_constant.miscellaneous[i].value].dev
    )
  ...
  for (const i in breaker_constant.coil_characteristics) {
    ...
    coilCharacteristicsBreakerInfo.mrid =
      dto.assessmentLimits.coil_characteristics.abs[breaker_constant.coil_characteristics[i].value]
        .mrid || null
    coilCharacteristicsBreakerInfo.parameter_name =
      breaker_constant.coil_characteristics[i].label || null
    coilCharacteristicsBreakerInfo.assessment_limit_breaker_info_id =
      dto.assessmentLimitBreakerInfoId || null
    coilCharacteristicsBreakerInfo.min =
      dto.assessmentLimits.coil_characteristics.abs[breaker_constant.coil_characteristics[i].value]
        .min.mrid || null
    const min = new QuantityValue()
    mappingUnit(
    ...
    entity.quantity.push(min)
    coilCharacteristicsBreakerInfo.max =
      dto.assessmentLimits.coil_characteristics.abs[breaker_constant.coil_characteristics[i].value]
        .max.mrid || null
    const max = new QuantityValue()
    mappingUnit(
    ...
    entity.quantity.push(max)
    coilCharacteristicsBreakerInfo.ref =
      dto.assessmentLimits.coil_characteristics.rel[breaker_constant.coil_characteristics[i].value]
        .ref.mrid || null
    const ref = new QuantityValue()
    mappingUnit(
      ref,
    ...
    entity.quantity.push(ref)
    coilCharacteristicsBreakerInfo.dev_negative =
      dto.assessmentLimits.coil_characteristics.rel[breaker_constant.coil_characteristics[i].value]
        .minus_dev.mrid || null
    ...
    coilCharacteristicsBreakerInfo.dev_positive =
      dto.assessmentLimits.coil_characteristics.rel[breaker_constant.coil_characteristics[i].value]
        .plus_dev.mrid || null
  ...
  for (const i in breaker_constant.pickup_voltage) {
    ...
    pickupVoltageBreakerInfo.mrid =
      dto.assessmentLimits.pickup_voltage.abs[breaker_constant.pickup_voltage[i].value].mrid || null
    pickupVoltageBreakerInfo.parameter_name = breaker_constant.pickup_voltage[i].label || null
    pickupVoltageBreakerInfo.assessment_limit_breaker_info_id =
      dto.assessmentLimitBreakerInfoId || null
    pickupVoltageBreakerInfo.v_min =
      dto.assessmentLimits.pickup_voltage.abs[breaker_constant.pickup_voltage[i].value].v_min
        .mrid || null
    ...
    pickupVoltageBreakerInfo.v_max =
      dto.assessmentLimits.pickup_voltage.abs[breaker_constant.pickup_voltage[i].value].v_max
        .mrid || null
    ...
    pickupVoltageBreakerInfo.v_ref =
      dto.assessmentLimits.pickup_voltage.rel[breaker_constant.pickup_voltage[i].value].v_ref
        .mrid || null
    ...
    pickupVoltageBreakerInfo.v_dev =
      dto.assessmentLimits.pickup_voltage.rel[breaker_constant.pickup_voltage[i].value].v_dev
        .mrid || null
  ...
  for (const i in breaker_constant.motor_characteristics) {
    ...
    motorCharacteristicsBreakerInfo.mrid =
      dto.assessmentLimits.motor_characteristics.abs[
        breaker_constant.motor_characteristics[i].value
      ].mrid || null
    motorCharacteristicsBreakerInfo.parameter_name =
      breaker_constant.motor_characteristics[i].label || null
    motorCharacteristicsBreakerInfo.assessment_limit_breaker_info_id =
      dto.assessmentLimitBreakerInfoId || null

    motorCharacteristicsBreakerInfo.min =
      dto.assessmentLimits.motor_characteristics.abs[
        breaker_constant.motor_characteristics[i].value
      ].min.mrid || null
    const min = new QuantityValue()
    ...
    motorCharacteristicsBreakerInfo.max =
      dto.assessmentLimits.motor_characteristics.abs[
        breaker_constant.motor_characteristics[i].value
      ].max.mrid || null
    const max = new QuantityValue()
    ...
    motorCharacteristicsBreakerInfo.ref =
      dto.assessmentLimits.motor_characteristics.rel[
        breaker_constant.motor_characteristics[i].value
      ].ref.mrid || null
    const ref = new QuantityValue()
    mappingUnit(
    ...
    motorCharacteristicsBreakerInfo.dev =
      dto.assessmentLimits.motor_characteristics.rel[
        breaker_constant.motor_characteristics[i].value
      ].dev.mrid || null
    const dev = new QuantityValue()
  ...
  underVoltageReleaseBreakerInfo.parameter_name =
    dto.assessmentLimits.under_voltage_release.name || null
  underVoltageReleaseBreakerInfo.assessment_limit_breaker_info_id =
    dto.assessmentLimitBreakerInfoId || null

  underVoltageReleaseBreakerInfo.min =
    dto.assessmentLimits.under_voltage_release.abs.uv_coil_trip_voltage.min.mrid || null
  ...
  underVoltageReleaseBreakerInfo.max =
    dto.assessmentLimits.under_voltage_release.abs.uv_coil_trip_voltage.max.mrid || null
  ...
  underVoltageReleaseBreakerInfo.ref =
    dto.assessmentLimits.under_voltage_release.rel.uv_coil_trip_voltage.ref.mrid || null
  ...
  underVoltageReleaseBreakerInfo.dev =
    dto.assessmentLimits.under_voltage_release.rel.uv_coil_trip_voltage.dev.mrid || null
  ...
  overcurrentReleaseBreakerInfo.parameter_name =
    dto.assessmentLimits.overcurrent_release.name || null
  overcurrentReleaseBreakerInfo.assessment_limit_breaker_info_id =
    dto.assessmentLimitBreakerInfoId || null

  overcurrentReleaseBreakerInfo.min =
    dto.assessmentLimits.overcurrent_release.abs.oc_replay_trip_current.min.mrid || null
  ...
  overcurrentReleaseBreakerInfo.max =
    dto.assessmentLimits.overcurrent_release.abs.oc_replay_trip_current.max.mrid || null
  ...
  overcurrentReleaseBreakerInfo.ref =
    dto.assessmentLimits.overcurrent_release.rel.oc_replay_trip_current.ref.mrid || null
  ...
  overcurrentReleaseBreakerInfo.dev =
    dto.assessmentLimits.overcurrent_release.rel.oc_replay_trip_current.dev.mrid || null
...
export function mapEntityToDto(entity) {
  ...
  dto.circuitBreaker.interruptersPerPhase =
    entity.oldBreakerInfo?.number_of_interrupters_per_phase || ''
  ...
  dto.ratings.rated_short_circuit_breaking_current.mrid =
    entity.breakerRatingInfo?.rated_short_circuit_breaking_current
  for (const data of entity.currentFlow || []) {
  ...
  dto.ratings.short_circuit_nominal_duration.mrid =
    entity.breakerRatingInfo?.short_circuit_nominal_duration
  ...
  dto.contactSystem.nominal_total_travel.mrid =
    entity.breakerContactSystemInfo?.nominal_total_travel
  ...
  dto.operating.auxiliary_circuits.rated_voltage.mrid =
    entity.oldOperatingMechanismInfo?.rated_auxiliary_circuit_voltage
  for (const data of entity.voltage || []) {
  ...
  dto.operating.auxiliary_circuits.rated_current.mrid =
    entity.oldOperatingMechanismInfo?.rated_auxiliary_circuit_current
  for (const data of entity.currentFlow || []) {
  ...
  dto.operating.auxiliary_circuits.frequency.mrid =
    entity.oldOperatingMechanismInfo?.rated_auxiliary_circuit_frequency
  for (const data of entity.frequency || []) {
  ...
  dto.operating.auxiliary_circuits.power =
    entity.oldOperatingMechanismInfo?.auxiliary_circuit_power_type
  ...
  dto.operating.rated_operating_pressure.mrid =
    entity.oldOperatingMechanismInfo?.rated_operating_pressure
  for (const data of entity.pressure || []) {
  ...
  dto.operating.rated_operating_pressure_temperature.mrid =
    entity.oldOperatingMechanismInfo?.rated_operating_pressure_temperature
  for (const data of entity.temperature || []) {
  ...
  for (const data of entity.operatingTimeBreakerInfo) {
    const found = breaker_constant.opening_times.find((item) => item.label === data.parameter_name)
  ...
  for (const data of entity.contactTravelBreakerInfo) {
    const found = breaker_constant.contact_travel.find((item) => item.label === data.parameter_name)
    const value = found ? found.value : null
  ...
  for (const data of entity.tripOperation) {
    ...
    for (const data2 of entity.second) {
      if (
        data2.mrid == dto.assessmentLimits.auxiliary_contacts.trip_operation.abs[value].t_min.mrid
      ) {
    ...
    for (const data2 of entity.second) {
      if (
        data2.mrid == dto.assessmentLimits.auxiliary_contacts.trip_operation.abs[value].t_max.mrid
      ) {
    ...
    for (const data2 of entity.second) {
      if (
        data2.mrid == dto.assessmentLimits.auxiliary_contacts.trip_operation.rel[value].t_ref.mrid
      ) {
    ...
    for (const data2 of entity.second) {
      if (
        data2.mrid == dto.assessmentLimits.auxiliary_contacts.trip_operation.rel[value].t_dev.mrid
      ) {
  ...
  for (const data of entity.closeOperation) {
    ...
    for (const data2 of entity.second) {
      if (
        data2.mrid == dto.assessmentLimits.auxiliary_contacts.close_operation.abs[value].t_min.mrid
      ) {
    ...
    for (const data2 of entity.second) {
      if (
        data2.mrid == dto.assessmentLimits.auxiliary_contacts.close_operation.abs[value].t_max.mrid
      ) {
    ...
    for (const data2 of entity.second) {
      if (
        data2.mrid == dto.assessmentLimits.auxiliary_contacts.close_operation.rel[value].t_ref.mrid
      ) {
    ...
    for (const data2 of entity.second) {
      if (
        data2.mrid == dto.assessmentLimits.auxiliary_contacts.close_operation.rel[value].t_dev.mrid
      ) {
  ...
  for (const data of entity.miscellaneousBreakerInfo) {
    const found = breaker_constant.miscellaneous.find((item) => item.label === data.parameter_name)
    const value = found ? found.value : null
  ...
  for (const data of entity.pickupVoltageBreakerInfo) {
    const found = breaker_constant.pickup_voltage.find((item) => item.label === data.parameter_name)
    const value = found ? found.value : null
  ...
  for (const data of entity.underVoltageReleaseBreakerInfo) {
    ...
    for (const data2 of entity.voltage) {
      if (
        data2.mrid == dto.assessmentLimits.under_voltage_release.abs.uv_coil_trip_voltage.min.mrid
      ) {
    ...
    for (const data2 of entity.voltage) {
      if (
        data2.mrid == dto.assessmentLimits.under_voltage_release.abs.uv_coil_trip_voltage.max.mrid
      ) {
    ...
    for (const data2 of entity.voltage) {
      if (
        data2.mrid == dto.assessmentLimits.under_voltage_release.rel.uv_coil_trip_voltage.ref.mrid
      ) {
    ...
    for (const data2 of entity.voltage) {
      if (
        data2.mrid == dto.assessmentLimits.under_voltage_release.rel.uv_coil_trip_voltage.dev.mrid
      ) {
  ...
  for (const data of entity.overcurrentReleaseBreakerInfo) {
    ...
    for (const data2 of entity.currentFlow) {
      if (
        data2.mrid == dto.assessmentLimits.overcurrent_release.abs.oc_replay_trip_current.min.mrid
      ) {
    ...
    for (const data2 of entity.currentFlow) {
      if (
        data2.mrid == dto.assessmentLimits.overcurrent_release.abs.oc_replay_trip_current.max.mrid
      ) {
    ...
    for (const data2 of entity.currentFlow) {
      if (
        data2.mrid == dto.assessmentLimits.overcurrent_release.rel.oc_replay_trip_current.ref.mrid
      ) {
    ...
    for (const data2 of entity.currentFlow) {
      if (
        data2.mrid == dto.assessmentLimits.overcurrent_release.rel.oc_replay_trip_current.dev.mrid
      ) {
