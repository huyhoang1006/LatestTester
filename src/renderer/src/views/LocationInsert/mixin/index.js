...
export default {
  ...
  computed: {
    ...
    selectedLocation() {
      return this.$userStore().selectedLocation
    }
  },
  methods: {
    async saveCtrS() {
    ...
    checkStreetAddress(dto) {
      if (dto.streetAddressId === null || dto.streetAddressId === '') {
        if (
          (dto.streetDetailId === null || dto.streetDetailId === '') &&
          (dto.townDetailId === null || dto.townDetailId === '')
        ) {
    ...
    checkConfigurationEvent(dto) {
      if (dto.locationId !== null && dto.locationId !== '') {
        ...
        configEventLocation.modified_by = this.$userId()
      ...
      if (dto.personId !== null && dto.personId !== '') {
        ...
        configEventPerson.modified_by = this.$userId()
        if (this.mode === this.$constant.ADD) {
      ...
      if (dto.subsId !== null && dto.subsId !== '') {
        ...
        configEventSubstation.modified_by = this.$userId()
        if (this.mode === this.$constant.ADD) {
      ...
      if (dto.attachmentId !== null && dto.attachmentId !== '') {
        ...
        configEventAttachment.modified_by = this.$userId()
        if (this.mode === this.$constant.ADD) {
    ...
    async changeLocationName(value) {
      try {
        ...
        if (index !== -1) {
          ...
          const [streetDetailData, streetAddressData, townDetailData, dataPositionPoint] =
            await Promise.all([
      ...
      try {
        ...
        if (index !== -1) {
          ...
          const [telephoneNumberData, electronicAddressData, personRoleData] = await Promise.all([
            ...
            window.electronAPI.getElectronicAddressByMrid(
              this.personListData[index].electronic_address
            ),
