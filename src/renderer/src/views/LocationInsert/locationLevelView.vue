      ...
      <el-col :xs="24" :md="12">
        <div class="col-content">
          ...
          >
            ...
            <el-form-item label="Location"> </el-form-item>
            <el-form-item label="Location name" class="custom-label">
              ...
              >
                <el-option
                  v-for="(item, index) in locationListData"
                  :key="index"
                  :label="item && item.name ? item.name : ''"
                  :value="item && item.mrid ? item.mrid : ''"
                >
                </el-option>
              </el-select>
            </el-form-item>
            ...
            <el-form-item label="Geo position x" class="custom-label geo-item">
              <div class="geo-row">
                ...
                <el-button class="geo-add-btn" @click="openAddGeo" type="primary"
    ...
    >
      ...
      <template #footer>
        <span class="dialog-footer custom-footer">
          <el-button class="footer-btn" type="danger" @click="handleCloseGeo()" size="small"
            >Cancel</el-button
          >
          <el-button class="footer-btn" type="primary" @click="handleConfirmGeo()" size="small"
            >Confirm</el-button
          >
        </span>
      </template>
...
@media (max-width: 991px) {
  ...
  :global(.el-form-item.voltage-item) {
    display: flex;
    flex-direction: column;
    align-items: stretch;
  }

  :global(.el-form-item.voltage-item .el-form-item__label) {
  ...
  :global(.el-form-item.voltage-item .el-form-item__content) {
    width: 100%;
    margin-left: 0 !important;
  }
...
@media (max-width: 767px) {
  ...
  :global(.el-form-item.custom-label .el-form-item__label) {
    padding-left: 20px;
  }
