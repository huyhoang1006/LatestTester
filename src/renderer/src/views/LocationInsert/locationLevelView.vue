<template>
    <div>
        ...
        <el-dialog custom-class="app-dialog" v-model="signAddGeo" :title="titleGeo" align-center :before-close="handleCloseGeo"
...
@media (max-width: 991px) {
    ...
    :deep(.el-form-item.voltage-item) {
        display: flex;
        flex-direction: column;
        align-items: stretch;
    }

    :deep(.el-form-item.voltage-item .el-form-item__label) {
    ...
    :deep(.el-form-item.voltage-item .el-form-item__content) {
        width: 100%;
        margin-left: 0 !important;
    }
...
@media (max-width: 767px) {
    ...
    :deep(.el-form-item.custom-label .el-form-item__label) {
        padding-left: 20px;
    }
