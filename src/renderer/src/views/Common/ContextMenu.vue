  ...
  >
    ...
    <transition name="fade">
      <ul v-if="sign == 'onlysubs'">
        <li @click="addSubs"><i class="fa-solid fa-plus"></i> Add substation</li>
      </ul>
      <ul v-else>
        ...
        <li
          v-if="
            selectedNode &&
            (selectedNode.mode == 'voltageLevel' || selectedNode.mode == 'substation')
          "
          @click="addBay"
        >
        ...
        <li
          class="has-submenu"
          v-if="selectedNode && (selectedNode.mode == 'bay' || selectedNode.mode == 'substation')"
        >
          ...
          <ul class="submenu">
            ...
            <li @click="addSurgeArrester">
              <i class="fa-solid fa-shield-halved"></i> Add Surge Arrester
            </li>
            <li @click="addPowerCable"><i class="fa-solid fa-route"></i> Add Power Cable</li>
            <li @click="addDisconnector">
              <i class="fa-solid fa-plug-circle-xmark"></i> Add Disconnector
            </li>
            <li @click="addRotatingMachine">
              <i class="fa-solid fa-group-arrows-rotate"></i> Add Rotating Machine
            </li>
        ...
        <li @click="show"><i class="fa-solid fa-eye"></i> Show</li>
        <li @click="refresh"><i class="fa-solid fa-rotate"></i> Refresh</li>
        <li @click="download"><i class="fa-solid fa-file-arrow-down"></i> Download</li>
        <li @click="upload"><i class="fa-solid fa-upload"></i> Upload</li>
        <li @click="move"><i class="fa-solid fa-arrows-up-down-left-right"></i> Move</li>
        <li @click="deleteNode"><i class="fas fa-trash-alt"></i> Delete</li>
        <li @click="duplicate"><i class="fa-solid fa-copy"></i> Duplicate</li>
        <li @click="fmeca"><i class="fa-solid fa-table"></i> FMECA</li>
        <li @click="showEquipment">
          ...
          <ul class="submenu">
            <li class="has-submenu">
              ...
              <ul class="submenu">
                ...
                <li @click="exportJSONCIM">
                  <i class="fa-solid fa-file-code"></i> Export JSON by CIM
                </li>
              </ul>
            </li>
          ...
          <ul class="submenu">
            <li class="has-submenu">
              ...
              <ul class="submenu">
                ...
                <li @click="importJSONCIM">
                  <i class="fa-solid fa-file-code"></i> Import JSON by CIM
                </li>
              </ul>
            </li>
...
export default {
  ...
  methods: {
    ...
    download() {
      this.$emit('download', this.selectedNode)
      this.closeContextMenu()
    },
    upload() {
      this.$emit('upload', this.selectedNode)
      this.closeContextMenu()
    },
    fmeca() {
      this.$emit('fmeca', this.selectedNode)
      this.closeContextMenu()
    },
    showEquipment() {
      this.$emit('show-equipment', this.selectedNode)
      this.closeContextMenu()
    }
  }
}
