export const FEATURE_TREE = {
  ...
  SubstationDto: {
    ...
    children: {
      ...
      generation: { label: 'Generation', value: 'generation' },
      industry: { label: 'Industry', value: 'industry' },
      locationName: { label: 'Location name', value: 'locationName' },
      street: { label: 'Street', value: 'street' },
      ward_or_commune: { label: 'Ward/Commune', value: 'ward_or_commune' },
      district_or_town: { label: 'District/Town', value: 'district_or_town' },
      state_or_province: { label: 'State/Province', value: 'state_or_province' },
      city: { label: 'City', value: 'city' },
      country: { label: 'Country', value: 'country' },
      personName: { label: 'Contact name', value: 'personName' },
    ...
    children: {
      TransformerDataDto: {
        ...
        children: {
          ...
          WindingConfigurationDto: {
            label: 'Winding Config',
            children: {
              phases: { label: 'Phases', value: 'phases' },
              vector_group_custom: { label: 'Vector group (custom)', value: 'vector_group_custom' },
              unsupported_vector_group: {
                label: 'Vector group (unsupported)',
                value: 'unsupported_vector_group'
              },
          ...
          ImpedancesDto: {
            ...
            children: {
              ...
              zsi_base_power: { label: 'Zero seq. base power', value: 'zsi_base_power' },
              zsi_base_voltage: { label: 'Zero seq. base voltage', value: 'zsi_base_voltage' },
              zsi_zero: { label: 'Zero seq. Z0 (zero)', value: 'zsi_zero' },
              zsi_prim: { label: 'Zero seq. Z0 (prim)', value: 'zsi_prim' },
              zsi_sec: { label: 'Zero seq. Z0 (sec)', value: 'zsi_sec' },
              prim_sec: {
                label: 'SC impedance Prim-Sec',
                children: {
          ...
          OthersDto: {
            ...
            children: {
              ...
              tank_type: { label: 'Tank type', value: 'tank_type' },
              insulation_medium: { label: 'Insulation medium', value: 'insulation_medium' },
              total_weight: { label: 'Total weight', value: 'total_weight' },
              insulation_weight: { label: 'Insulation weight', value: 'insulation_weight' },
              insulation_volume: { label: 'Insulation volume', value: 'insulation_volume' },
              winding: {
                label: 'Winding material',
                children: {
                  prim: { label: 'Prim', value: 'winding_prim' },
                  sec: { label: 'Sec', value: 'winding_sec' },
                  tert: { label: 'Tert', value: 'winding_tert' }
                }
              }
            }
          },
          TapChangersDto: {
            label: 'Tap changer',
            children: {
              mode: { label: 'Mode', value: 'tap_mode' },
              serial_no: { label: 'Serial no.', value: 'tap_serial_no' },
              manufacturer: { label: 'Manufacturer', value: 'tap_manufacturer' },
              manufacturer_type: { label: 'Manufacturer type', value: 'tap_manufacturer_type' },
              winding: { label: 'Winding', value: 'tap_winding' },
              tap_scheme: { label: 'Tap scheme', value: 'tap_scheme' },
              no_of_taps: { label: 'Num of taps', value: 'no_of_taps' }
            }
          },
          BushingDto: {
            label: 'Bushing',
              ...
              prim: {
                ...
                children: {
                  ...
                  manufacturer_type: {
                    ...
                    value: 'bushing_prim_manufacturer_type'
                  },
                  manufacturer_year: {
                    label: 'Manufacturing year',
                    value: 'bushing_prim_manufacturer_year'
                  },
                  insulation_level: {
                    label: 'Insul. level (BIL)',
                    value: 'bushing_prim_insulation_level'
                  },
                  voltage_l_ground: {
                    label: 'Voltage L-ground',
                    value: 'bushing_prim_voltage_l_ground'
                  },
                  max_system_voltage: {
                    label: 'Max system voltage',
                    value: 'bushing_prim_max_system_voltage'
                  },
                  ...
                  insulation_type: {
                    ...
                    value: 'bushing_prim_insulation_type'
                  }
                }
              },
              sec: {
                label: 'Secondary bushings',
                children: {
                  ...
                  manufacturer_type: {
                    label: 'Manufacturer type',
                    value: 'bushing_sec_manufacturer_type'
                  },
                  manufacturer_year: {
                    label: 'Manufacturing year',
                    value: 'bushing_sec_manufacturer_year'
                  },
                  insulation_level: {
                    label: 'Insul. level (BIL)',
                    value: 'bushing_sec_insulation_level'
                  },
                  voltage_l_ground: {
                    label: 'Voltage L-ground',
                    value: 'bushing_sec_voltage_l_ground'
                  },
                  max_system_voltage: {
                    label: 'Max system voltage',
                    value: 'bushing_sec_max_system_voltage'
                  },
                  ...
                  insulation_type: {
                    label: 'Insulation type',
                    value: 'bushing_sec_insulation_type'
                  }
                }
              },
              tert: {
                label: 'Tertiary bushings',
                children: {
                  ...
                  manufacturer_type: {
                    label: 'Manufacturer type',
                    value: 'bushing_tert_manufacturer_type'
                  },
                  manufacturer_year: {
                    label: 'Manufacturing year',
                    value: 'bushing_tert_manufacturer_year'
                  },
                  insulation_level: {
                    label: 'Insul. level (BIL)',
                    value: 'bushing_tert_insulation_level'
                  },
                  voltage_l_ground: {
                    label: 'Voltage L-ground',
                    value: 'bushing_tert_voltage_l_ground'
                  },
                  max_system_voltage: {
                    label: 'Max system voltage',
                    value: 'bushing_tert_max_system_voltage'
                  },
                  ...
                  insulation_type: {
                    label: 'Insulation type',
                    value: 'bushing_tert_insulation_type'
                  }
                }
              }
            }
                ...
                children: {
                  properties: {
                    ...
                    children: {
                      ...
                      sa_prim_manufacturer: {
                        label: 'Manufacturer',
                        value: 'sa_prim_manufacturer'
                      },
                      sa_prim_manufacturer_year: {
                        label: 'Manufacturing year',
                        value: 'sa_prim_manufacturer_year'
                      },
                      sa_prim_asset_system_code: {
                        label: 'Asset system code',
                        value: 'sa_prim_asset_system_code'
                      }
                    }
                  },
                  ratings: {
                    ...
                    children: {
                      ...
                      sa_prim_mcovRating: {
                        label: 'MCOV rating',
                        value: 'sa_prim_table_mcovRating'
                      }
                    }
                  }
                }
                ...
                children: {
                  properties: {
                    ...
                    children: {
                      ...
                      sa_sec_manufacturer_year: {
                        label: 'Manufacturing year',
                        value: 'sa_sec_manufacturer_year'
                      },
                      sa_sec_asset_system_code: {
                        label: 'Asset system code',
                        value: 'sa_sec_asset_system_code'
                      }
                    }
                  },
                  ratings: {
                ...
                children: {
                  properties: {
                    ...
                    children: {
                      ...
                      sa_tert_manufacturer: {
                        label: 'Manufacturer',
                        value: 'sa_tert_manufacturer'
                      },
                      sa_tert_manufacturer_year: {
                        label: 'Manufacturing year',
                        value: 'sa_tert_manufacturer_year'
                      },
                      sa_tert_asset_system_code: {
                        label: 'Asset system code',
                        value: 'sa_tert_asset_system_code'
                      }
                    }
                  },
                  ratings: {
                    ...
                    children: {
                      ...
                      sa_tert_mcovRating: {
                        label: 'MCOV rating',
                        value: 'sa_tert_table_mcovRating'
                      }
                    }
                  }
                }
        ...
        children: {
          ...
          RatingDto: {
            ...
            children: {
              ...
              rated_frequency: { label: 'Rated frequency', value: 'rated_frequency' },
              upr: { label: 'Upr formula', value: 'upr' },
              rated_voltage: { label: 'Rated voltage', value: 'rated_voltage' },
              c1: { label: 'C1', value: 'c1' },
              c2: { label: 'C2', value: 'c2' }
            }
          },
          VTConfigurationDto: {
        ...
        children: {
          ...
          RatingsDto: {
            ...
            children: {
              standard: { label: 'Standard', value: 'standard' },
              rated_frequency: { label: 'Rated frequency', value: 'rated_frequency' },
              primary_winding_count: { label: 'Primary windings', value: 'primary_winding_count' },
              um_rms: { label: 'Um (rms)', value: 'um_rms' },
              u_withstand_rms: { label: 'U withstand (rms)', value: 'u_withstand_rms' },
              u_lightning_peak: { label: 'U lightning (peak)', value: 'u_lightning_peak' },
              icth: { label: 'Icth', value: 'icth' },
              idyn_peak: { label: 'Idyn (peak)', value: 'idyn_peak' },
              ith_rms: { label: 'Ith (rms)', value: 'ith_rms' },
              ith_duration: { label: 'Duration', value: 'ith_duration' },
              system_voltage: { label: 'System voltage', value: 'system_voltage' },
              bil: { label: 'BIL', value: 'bil' },
              rating_factor: { label: 'Rating factor', value: 'rating_factor' }
            }
          },
          CTConfigurationDto: {
                ...
                children: {
                    ...
                    children: {
                      ...
                      classRating: {
                        ...
                        children: {
                          ...
                          ct_class_rated_burden: {
                            label: 'Rated burden (VA)',
                            value: 'ct_class_rated_burden'
                          },
                          ct_class_burden: { label: 'Burden (VA)', value: 'ct_class_burden' },
                          ct_class_burden_cos: {
                            label: 'cos φ (burden)',
                            value: 'ct_class_burden_cos'
                          },
                          ct_class_op_burden: {
                            label: 'Op. burden (VA)',
                            value: 'ct_class_op_burden'
                          },
                          ct_class_op_burden_cos: {
                            label: 'cos φ (op. burden)',
                            value: 'ct_class_op_burden_cos'
                          }
                        }
                      }
                    }
                  ...
                  mainTap: {
                    ...
                    children: {
                      ...
                      ct_main_rated_burden: {
                        label: 'Rated burden (VA)',
                        value: 'ct_main_rated_burden'
                      },
                      ...
                      ct_main_op_burden_cos: {
                        label: 'cos φ (op.)',
                        value: 'ct_main_op_burden_cos'
                      }
                    }
                  },
                  interTap: {
                    ...
                    children: {
                      ...
                      ct_inter_rated_burden: {
                        label: 'Rated burden (VA)',
                        value: 'ct_inter_rated_burden'
                      },
                      ...
                      ct_inter_op_burden_cos: {
                        label: 'cos φ (op.)',
                        value: 'ct_inter_op_burden_cos'
                      }
                    }
                  }
                }
      ...
      CircuitBreakerDto: {
        ...
        children: {
          ...
          circuitBreakerDto: {
            ...
            children: {
              numberOfPhases: { label: 'Number of phases', value: 'numberOfPhases' },
              interruptersPerPhase: {
                label: 'Interrupters per phase',
                value: 'interruptersPerPhase'
              },
              poleOperation: { label: 'Pole operation', value: 'poleOperation' },
              hasPIR: { label: 'Has PIR', value: 'hasPIR' },
              pirValue: { label: 'PIR value', value: 'pirValue' },
              hasGradingCapacitors: {
                label: 'Has grading capacitors',
                value: 'hasGradingCapacitors'
              },
              capacitorValue: { label: 'Capacitor value', value: 'capacitorValue' },
              interruptingMedium: { label: 'Interrupting medium', value: 'interruptingMedium' },
              tankType: { label: 'Tank type', value: 'tankType' }
            }
          },
          RatingsDto: {
            label: 'Ratings',
            children: {
              rated_voltage_ll: { label: 'Rated voltage (LL)', value: 'rated_voltage_ll' },
              rated_current: { label: 'Rated current', value: 'rated_current' },
              rated_frequency: { label: 'Rated frequency', value: 'rated_frequency' },
              rated_short_circuit_breaking_current: {
                label: 'Rated SC breaking current',
                value: 'rated_short_circuit_breaking_current'
              },
              short_circuit_nominal_duration: {
                label: 'SC nominal duration',
          ...
          ContactSystemDto: {
            ...
            children: {
              ...
              damping_time: { label: 'Damping time', value: 'damping_time' },
              nozzle_length: { label: 'Nozzle length', value: 'nozzle_length' }
            }
          },
          OtherDto: {
            label: 'Other',
            children: {
              ...
              weight_of_gas: { label: 'Weight of gas', value: 'weight_of_gas' },
              volume_of_gas: { label: 'Volume of gas', value: 'volume_of_gas' },
              rated_gas_pressure: { label: 'Rated gas pressure', value: 'rated_gas_pressure' },
              rated_gas_temperature: {
                label: 'Rated gas temperature',
          ...
          OperatingDto: {
            ...
            children: {
              ...
              rated_operating_pressure_temperature: {
                label: 'Rated pressure temp. (°C)',
                value: 'op_pressure_temp'
              },
              motor: {
                label: 'Motor',
                children: {
            ...
            children: {
                ...
                children: {
                  opening_time: {
                    ...
                    children: {
                      ...
                      ot_opening_rel_p_t_dev: {
                        label: '+t dev (rel)',
                        value: 'ot_opening_rel_p_t_dev'
                      },
                      ot_opening_rel_m_t_dev: {
                        label: '-t dev (rel)',
                        value: 'ot_opening_rel_m_t_dev'
                      }
                    }
                  },
                  opening_sync_within_phase: {
                    label: 'Opening sync within phase',
                    children: {
                  ...
                  opening_sync_breaker_phase: {
                    label: 'Opening sync breaker phase',
                    children: {
                  ...
                  closing_time: {
                    ...
                    children: {
                      ...
                      ot_closing_rel_p_t_dev: {
                        label: '+t dev (rel)',
                        value: 'ot_closing_rel_p_t_dev'
                      },
                      ot_closing_rel_m_t_dev: {
                        label: '-t dev (rel)',
                        value: 'ot_closing_rel_m_t_dev'
                      }
                    }
                  },
                  closing_sync_within_phase: {
                    label: 'Closing sync within phase',
                    children: {
                  ...
                  closing_sync_breaker_phase: {
                    label: 'Closing sync breaker phase',
                    children: {
                  ...
                  reclosing_time: {
                    ...
                    children: {
                      ot_reclosing_abs_t_min: {
                        label: 't min (abs)',
                        value: 'ot_reclosing_abs_t_min'
                      },
                      ot_reclosing_abs_t_max: {
                        label: 't max (abs)',
                        value: 'ot_reclosing_abs_t_max'
                      },
                      ot_reclosing_rel_t_ref: {
                        label: 't ref (rel)',
                        value: 'ot_reclosing_rel_t_ref'
                      },
                      ot_reclosing_rel_p_t_dev: {
                        label: '+t dev (rel)',
                        value: 'ot_reclosing_rel_p_t_dev'
                      },
                      ot_reclosing_rel_m_t_dev: {
                        label: '-t dev (rel)',
                        value: 'ot_reclosing_rel_m_t_dev'
                      }
                    }
                  },
                  close_open_time: {
                    label: 'Close-open time (CO)',
                    children: {
              ...
              contact_travel: {
                ...
                children: {
                  ...
                  over_travel_close: {
                    label: 'Over-travel close (OC)',
                    children: {
                      ct_ot_close_abs_d_min: {
                        label: 'd min (abs)',
                        value: 'ct_ot_close_abs_d_min'
                      },
                      ct_ot_close_abs_d_max: {
                        label: 'd max (abs)',
                        value: 'ct_ot_close_abs_d_max'
                      },
                      ct_ot_close_rel_d_ref: {
                        label: 'd ref (rel)',
                        value: 'ct_ot_close_rel_d_ref'
                      },
                      ct_ot_close_rel_d_dev: {
                        label: 'd dev (rel)',
                        value: 'ct_ot_close_rel_d_dev'
                      }
                    }
                  },
                  rebound_trip: {
                  ...
                  rebound_close: {
                    label: 'Rebound close',
                    children: {
                      ct_rb_close_abs_d_min: {
                        label: 'd min (abs)',
                        value: 'ct_rb_close_abs_d_min'
                      },
                      ct_rb_close_abs_d_max: {
                        label: 'd max (abs)',
                        value: 'ct_rb_close_abs_d_max'
                      },
                      ct_rb_close_rel_d_ref: {
                        label: 'd ref (rel)',
                        value: 'ct_rb_close_rel_d_ref'
                      },
                      ct_rb_close_rel_d_dev: {
                        label: 'd dev (rel)',
                        value: 'ct_rb_close_rel_d_dev'
                      }
                    }
                  },
                  contact_wipe_trip: {
                    label: 'Contact wipe trip (CWT)',
                    children: {
                  ...
                  contact_wipe_close: {
                    label: 'Contact wipe close (CWC)',
                    children: {
                      ct_cw_close_abs_d_min: {
                        label: 'd min (abs)',
                        value: 'ct_cw_close_abs_d_min'
                      },
                      ct_cw_close_abs_d_max: {
                        label: 'd max (abs)',
                        value: 'ct_cw_close_abs_d_max'
                      },
                      ct_cw_close_rel_d_ref: {
                        label: 'd ref (rel)',
                        value: 'ct_cw_close_rel_d_ref'
                      },
                      ct_cw_close_rel_d_dev: {
                        label: 'd dev (rel)',
                        value: 'ct_cw_close_rel_d_dev'
                      }
                    }
                  },
                  damping_distance: {
                    label: 'Damping distance (DD)',
                    children: {
              ...
              auxiliary_contacts: {
                ...
                children: {
                  trip_operation: {
                    ...
                    children: {
                      stta_trip: {
                        label: 'Switching time type A',
                        children: {
                          ac_trip_stta_abs_t_min: {
                            label: 't min (abs)',
                            value: 'ac_trip_stta_abs_t_min'
                          },
                          ac_trip_stta_abs_t_max: {
                            label: 't max (abs)',
                            value: 'ac_trip_stta_abs_t_max'
                          },
                          ac_trip_stta_rel_t_ref: {
                            label: 't ref (rel)',
                            value: 'ac_trip_stta_rel_t_ref'
                          },
                          ac_trip_stta_rel_t_dev: {
                            label: 't dev (rel)',
                            value: 'ac_trip_stta_rel_t_dev'
                          }
                        }
                      },
                      dmta_trip: {
                        label: 'Diff to main type A',
                        children: {
                          ac_trip_dmta_abs_t_min: {
                            label: 't min (abs)',
                            value: 'ac_trip_dmta_abs_t_min'
                          },
                          ac_trip_dmta_abs_t_max: {
                            label: 't max (abs)',
                            value: 'ac_trip_dmta_abs_t_max'
                          },
                          ac_trip_dmta_rel_t_ref: {
                            label: 't ref (rel)',
                            value: 'ac_trip_dmta_rel_t_ref'
                          },
                          ac_trip_dmta_rel_t_dev: {
                            label: 't dev (rel)',
                            value: 'ac_trip_dmta_rel_t_dev'
                          }
                        }
                      },
                      sttb_trip: {
                        label: 'Switching time type B',
                        children: {
                          ac_trip_sttb_abs_t_min: {
                            label: 't min (abs)',
                            value: 'ac_trip_sttb_abs_t_min'
                          },
                          ac_trip_sttb_abs_t_max: {
                            label: 't max (abs)',
                            value: 'ac_trip_sttb_abs_t_max'
                          },
                          ac_trip_sttb_rel_t_ref: {
                            label: 't ref (rel)',
                            value: 'ac_trip_sttb_rel_t_ref'
                          },
                          ac_trip_sttb_rel_t_dev: {
                            label: 't dev (rel)',
                            value: 'ac_trip_sttb_rel_t_dev'
                          }
                        }
                      },
                      dmtb_trip: {
                        label: 'Diff to main type B',
                        children: {
                          ac_trip_dmtb_abs_t_min: {
                            label: 't min (abs)',
                            value: 'ac_trip_dmtb_abs_t_min'
                          },
                          ac_trip_dmtb_abs_t_max: {
                            label: 't max (abs)',
                            value: 'ac_trip_dmtb_abs_t_max'
                          },
                          ac_trip_dmtb_rel_t_ref: {
                            label: 't ref (rel)',
                            value: 'ac_trip_dmtb_rel_t_ref'
                          },
                          ac_trip_dmtb_rel_t_dev: {
                            label: 't dev (rel)',
                            value: 'ac_trip_dmtb_rel_t_dev'
                          }
                        }
                      },
                      stw_trip: {
                        ...
                        children: {
                          ac_trip_stw_abs_t_min: {
                            label: 't min (abs)',
                            value: 'ac_trip_stw_abs_t_min'
                          },
                          ac_trip_stw_abs_t_max: {
                            label: 't max (abs)',
                            value: 'ac_trip_stw_abs_t_max'
                          },
                          ac_trip_stw_rel_t_ref: {
                            label: 't ref (rel)',
                            value: 'ac_trip_stw_rel_t_ref'
                          },
                          ac_trip_stw_rel_t_dev: {
                            label: 't dev (rel)',
                            value: 'ac_trip_stw_rel_t_dev'
                          }
                        }
                      },
                      dur_trip: {
                        ...
                        children: {
                          ac_trip_dur_abs_t_min: {
                            label: 't min (abs)',
                            value: 'ac_trip_dur_abs_t_min'
                          },
                          ac_trip_dur_abs_t_max: {
                            label: 't max (abs)',
                            value: 'ac_trip_dur_abs_t_max'
                          },
                          ac_trip_dur_rel_t_ref: {
                            label: 't ref (rel)',
                            value: 'ac_trip_dur_rel_t_ref'
                          },
                          ac_trip_dur_rel_t_dev: {
                            label: 't dev (rel)',
                            value: 'ac_trip_dur_rel_t_dev'
                          }
                        }
                      }
                    }
                      ...
                      stta_close: {
                        ...
                        children: {
                          ac_close_stta_abs_t_min: {
                            label: 't min (abs)',
                            value: 'ac_close_stta_abs_t_min'
                          },
                          ac_close_stta_abs_t_max: {
                            label: 't max (abs)',
                            value: 'ac_close_stta_abs_t_max'
                          },
                          ac_close_stta_rel_t_ref: {
                            label: 't ref (rel)',
                            value: 'ac_close_stta_rel_t_ref'
                          },
                          ac_close_stta_rel_t_dev: {
                            label: 't dev (rel)',
                            value: 'ac_close_stta_rel_t_dev'
                          }
                        }
                      },
                      dmta_close: {
                        label: 'Diff to main type A',
                        children: {
                          ac_close_dmta_abs_t_min: {
                            label: 't min (abs)',
                            value: 'ac_close_dmta_abs_t_min'
                          },
                          ac_close_dmta_abs_t_max: {
                            label: 't max (abs)',
                            value: 'ac_close_dmta_abs_t_max'
                          },
                          ac_close_dmta_rel_t_ref: {
                            label: 't ref (rel)',
                            value: 'ac_close_dmta_rel_t_ref'
                          },
                          ac_close_dmta_rel_t_dev: {
                            label: 't dev (rel)',
                            value: 'ac_close_dmta_rel_t_dev'
                          }
                        }
                      },
                      sttb_close: {
                        label: 'Switching time type B',
                        children: {
                          ac_close_sttb_abs_t_min: {
                            label: 't min (abs)',
                            value: 'ac_close_sttb_abs_t_min'
                          },
                          ac_close_sttb_abs_t_max: {
                            label: 't max (abs)',
                            value: 'ac_close_sttb_abs_t_max'
                          },
                          ac_close_sttb_rel_t_ref: {
                            label: 't ref (rel)',
                            value: 'ac_close_sttb_rel_t_ref'
                          },
                          ac_close_sttb_rel_t_dev: {
                            label: 't dev (rel)',
                            value: 'ac_close_sttb_rel_t_dev'
                          }
                        }
                      },
                      dmtb_close: {
                        ...
                        children: {
                          ac_close_dmtb_abs_t_min: {
                            label: 't min (abs)',
                            value: 'ac_close_dmtb_abs_t_min'
                          },
                          ac_close_dmtb_abs_t_max: {
                            label: 't max (abs)',
                            value: 'ac_close_dmtb_abs_t_max'
                          },
                          ac_close_dmtb_rel_t_ref: {
                            label: 't ref (rel)',
                            value: 'ac_close_dmtb_rel_t_ref'
                          },
                          ac_close_dmtb_rel_t_dev: {
                            label: 't dev (rel)',
                            value: 'ac_close_dmtb_rel_t_dev'
                          }
                        }
                      },
                      stw_close: {
                        label: 'Switching time wiper',
                        children: {
                          ac_close_stw_abs_t_min: {
                            label: 't min (abs)',
                            value: 'ac_close_stw_abs_t_min'
                          },
                          ac_close_stw_abs_t_max: {
                            label: 't max (abs)',
                            value: 'ac_close_stw_abs_t_max'
                          },
                          ac_close_stw_rel_t_ref: {
                            label: 't ref (rel)',
                            value: 'ac_close_stw_rel_t_ref'
                          },
                          ac_close_stw_rel_t_dev: {
                            label: 't dev (rel)',
                            value: 'ac_close_stw_rel_t_dev'
                          }
                        }
                      },
                      dur_close: {
                        label: 'Duration',
                        children: {
                          ac_close_dur_abs_t_min: {
                            label: 't min (abs)',
                            value: 'ac_close_dur_abs_t_min'
                          },
                          ac_close_dur_abs_t_max: {
                            label: 't max (abs)',
                            value: 'ac_close_dur_abs_t_max'
                          },
                          ac_close_dur_rel_t_ref: {
                            label: 't ref (rel)',
                            value: 'ac_close_dur_rel_t_ref'
                          },
                          ac_close_dur_rel_t_dev: {
                            label: 't dev (rel)',
                            value: 'ac_close_dur_rel_t_dev'
                          }
                        }
                      }
                    }
                ...
                children: {
                  peak_close_coil_current: {
                    ...
                    children: {
                      ...
                      cc_peak_close_rel_m_dev: {
                        label: '-Dev (rel)',
                        value: 'cc_peak_close_rel_m_dev'
                      },
                      cc_peak_close_rel_p_dev: {
                        label: '+Dev (rel)',
                        value: 'cc_peak_close_rel_p_dev'
                      }
                    }
                  },
                  peak_trip_coil_current: {
                    ...
                    children: {
                      ...
                      cc_peak_trip_rel_m_dev: {
                        label: '-Dev (rel)',
                        value: 'cc_peak_trip_rel_m_dev'
                      },
                      cc_peak_trip_rel_p_dev: {
                        label: '+Dev (rel)',
                        value: 'cc_peak_trip_rel_p_dev'
                      }
                    }
                  },
                  average_close_coil_current: {
                    label: 'Avg close coil current',
                    children: {
                      cc_avg_close_i_abs_min: {
                        label: 'Min (abs)',
                        value: 'cc_avg_close_i_abs_min'
                      },
                      cc_avg_close_i_abs_max: {
                        label: 'Max (abs)',
                        value: 'cc_avg_close_i_abs_max'
                      },
                      cc_avg_close_i_rel_ref: {
                        label: 'Ref (rel)',
                        value: 'cc_avg_close_i_rel_ref'
                      },
                      cc_avg_close_i_rel_m_dev: {
                        label: '-Dev (rel)',
                        value: 'cc_avg_close_i_rel_m_dev'
                      },
                      cc_avg_close_i_rel_p_dev: {
                        label: '+Dev (rel)',
                        value: 'cc_avg_close_i_rel_p_dev'
                      }
                    }
                  },
                  average_trip_coil_current: {
                    label: 'Avg trip coil current',
                    children: {
                      ...
                      cc_avg_trip_i_rel_m_dev: {
                        label: '-Dev (rel)',
                        value: 'cc_avg_trip_i_rel_m_dev'
                      },
                      cc_avg_trip_i_rel_p_dev: {
                        label: '+Dev (rel)',
                        value: 'cc_avg_trip_i_rel_p_dev'
                      }
                    }
                  },
                  average_close_coil_voltage: {
                    label: 'Avg close coil voltage',
                    children: {
                      cc_avg_close_u_abs_min: {
                        label: 'Min (abs)',
                        value: 'cc_avg_close_u_abs_min'
                      },
                      cc_avg_close_u_abs_max: {
                        label: 'Max (abs)',
                        value: 'cc_avg_close_u_abs_max'
                      },
                      cc_avg_close_u_rel_ref: {
                        label: 'Ref (rel)',
                        value: 'cc_avg_close_u_rel_ref'
                      },
                      cc_avg_close_u_rel_m_dev: {
                        label: '-Dev (rel)',
                        value: 'cc_avg_close_u_rel_m_dev'
                      },
                      cc_avg_close_u_rel_p_dev: {
                        label: '+Dev (rel)',
                        value: 'cc_avg_close_u_rel_p_dev'
                      }
                    }
                  },
                  average_trip_coil_voltage: {
                    label: 'Avg trip coil voltage',
                    children: {
                      ...
                      cc_avg_trip_u_rel_m_dev: {
                        label: '-Dev (rel)',
                        value: 'cc_avg_trip_u_rel_m_dev'
                      },
                      cc_avg_trip_u_rel_p_dev: {
                        label: '+Dev (rel)',
                        value: 'cc_avg_trip_u_rel_p_dev'
                      }
                    }
                  },
                  close_coil_resistance: {
                    ...
                    children: {
                      ...
                      cc_close_res_rel_m_dev: {
                        label: '-Dev (rel)',
                        value: 'cc_close_res_rel_m_dev'
                      },
                      cc_close_res_rel_p_dev: {
                        label: '+Dev (rel)',
                        value: 'cc_close_res_rel_p_dev'
                      }
                    }
                  },
                  trip_coil_resistance: {
                    ...
                    children: {
                      ...
                      cc_trip_res_rel_m_dev: {
                        label: '-Dev (rel)',
                        value: 'cc_trip_res_rel_m_dev'
                      },
              ...
              pickup_voltage: {
                ...
                children: {
                  min_pickup_voltage_close: {
                    label: 'Min pickup voltage (close)',
                    children: {
      ...
      PowerCableDTO: {
        ...
        children: {
          ...
          ratingsData: {
            label: 'Ratings',
            children: {
              rated_voltage: { label: 'Rated voltage (rms)', value: 'rated_voltage' },
              max_voltage: { label: 'Maximum voltage (rms)', value: 'max_voltage' },
              rated_frequency: { label: 'Rated frequency', value: 'rated_frequency' },
              shortcircuit: { label: 'Short circuit current', value: 'shortcircuit' },
          ...
          othersData: {
            label: 'Others',
            children: {
              insulation_method: { label: 'Installation method', value: 'insulation_method' },
              bonding_type: { label: 'Bonding type', value: 'bonding_type' },
              install_location: { label: 'Install location', value: 'install_location' },
              cable_length: { label: 'Cable length', value: 'cable_length' }
            }
          },
          datasData: {
            label: 'Layer data',
            children: {
              ...
              sheath: {
                ...
                children: {
                  ...
                  sheath_type_custom: {
                    label: 'Sheath type (custom)',
                    value: 'sheath_type_custom'
                  },
                  sheath_construction: { label: 'Construction', value: 'sheath_construction' },
                  sheath_construction_custom: {
                    label: 'Construction (custom)',
                    value: 'sheath_construction_custom'
                  },
              ...
              concentric_neutral: {
                ...
                children: {
                  ...
                  cn_construction_custom: {
                    label: 'Construction (custom)',
                    value: 'cn_construction_custom'
                  },
              ...
              armour: {
                ...
                children: {
                  ...
                  armour_material_custom: {
                    label: 'Material (custom)',
                    value: 'armour_material_custom'
                  },
                  ...
                  armour_layerOfTapes_custom: {
                    label: 'Layer of tapes (custom)',
                    value: 'armour_layerOfTapes_custom'
                  },
                  armour_crossSectional: {
                    label: 'Cross-sectional area',
                    value: 'armour_crossSectional'
                  }
                }
              },
              oversheath: {
                label: 'Oversheath / Jacket',
                children: {
              ...
              terminalsData: {
                ...
                children: {
                  ...
                  term_service_condition: {
                    label: 'Service condition',
                    value: 'term_service_condition'
                  }
                }
              },
              jointsData: {
                ...
                children: {
                  ...
                  joint_service_condition: {
                    label: 'Service condition',
                    value: 'joint_service_condition'
                  }
                }
              },
              sheathLimitsData: {
                label: 'Sheath voltage limits',
                children: {
                  sl_rated_voltage_ur: { label: 'Rated voltage Ur', value: 'sl_rated_voltage_ur' },
                  sl_max_continuous_operating_voltage: {
                    label: 'Max continuous operating voltage Uc',
                    value: 'sl_max_continuous_operating_voltage'
                  },
                  sl_nominal_discharge_current: {
                    label: 'Nominal discharge current',
                    value: 'sl_nominal_discharge_current'
                  },
                  sl_high_current_impulse_withstand: {
                    label: 'High current impulse withstand',
                    value: 'sl_high_current_impulse_withstand'
                  },
                  sl_long_duration_current_impulse_withstand: {
                    label: 'Long duration impulse withstand',
                    value: 'sl_long_duration_current_impulse_withstand'
                  },
                  sl_short_circuit_withstand: {
                    label: 'Short circuit withstand',
                    value: 'sl_short_circuit_withstand'
                  }
                }
              }
            }
        ...
        children: {
          ...
          RatingsDto: {
            ...
            children: {
              ...
              tableRating: {
                label: 'Rating table (array)',
                children: {
                  sa_serial: { label: 'Serial no.', value: 'sa_serial' },
                  sa_ratedVoltage: { label: 'Rated voltage Ur', value: 'sa_ratedVoltage' },
                  sa_maximumVoltage: {
                    label: 'Maximum system voltage Us',
                    value: 'sa_maximumVoltage'
                  },
                  sa_continousVoltage: {
                    label: 'Continuous operating voltage Uc',
                    value: 'sa_continousVoltage'
                  },
                  sa_shortCurrent: {
                    label: 'Short time withstand current',
                    value: 'sa_shortCurrent'
                  },
                  sa_ratedCircuit: {
                    label: 'Rated duration of short circuit',
                    value: 'sa_ratedCircuit'
                  },
                  sa_polesVoltage: {
                    label: 'PF withstand voltage (earth & poles)',
                    value: 'sa_polesVoltage'
                  },
                  sa_isoVoltage: {
                    label: 'PF withstand voltage (isolating distance)',
                    value: 'sa_isoVoltage'
                  }
                }
              }
        ...
        children: {
          ...
          ReactorRatingDto: {
            ...
            children: {
              ...
              rated_frequency: { label: 'Rated frequency', value: 'rated_frequency' },
              rated_current: { label: 'Rated current', value: 'rated_current' },
              rated_power: { label: 'Rated power', value: 'rated_power' },
              inductance: { label: 'Inductance', value: 'inductance' }
            }
          },
          ReactorOtherDto: {
            label: 'Others',
          ...
          RatingsDto: {
            ...
            children: {
              ...
              short_time_withstand_current: {
                label: 'Short time withstand current',
                value: 'dc_short_time_withstand_current'
              },
              rated_duration_of_short_circuit: {
                label: 'Rated duration of short circuit',
                value: 'dc_rated_duration_of_short_circuit'
              },
              power_freq_withstand_voltage_earth_poles: {
                label: 'PF withstand voltage (earth & poles)',
                value: 'dc_pf_earth_poles'
              },
              power_freq_withstand_voltage_isolating_distance: {
                label: 'PF withstand voltage (isolating distance)',
                value: 'dc_pf_isolating_distance'
              }
            }
          }
        }
      ...
      RotatingMachineDTO: {
        ...
        children: {
          ...
          configsData: {
            label: 'Configurations',
            children: { star_point: { label: 'Star point', value: 'star_point' } }
          },
          ratingsData: {
            label: 'Ratings',
            children: {
              rated_u: { label: 'Rated voltage (LL)', value: 'rated_u' },
              rated_current: { label: 'Rated current', value: 'rated_current' },
              rated_speed: { label: 'Rated speed (rpm)', value: 'rated_speed' },
              rated_frequency: { label: 'Rated frequency', value: 'rated_frequency' },
              rated_power: { label: 'Rated power', value: 'rated_power' },
              rated_power_factor: { label: 'Rated power factor', value: 'rated_power_factor' },
              rated_thermal_class: { label: 'Rated thermal class', value: 'rated_thermal_class' },
              rated_ifd: { label: 'Rated excitation current', value: 'rated_ifd' },
              rated_ufd: { label: 'Rated excitation voltage', value: 'rated_ufd' }
            }
          }
        }
      }
  ...
  Job: {
    ...
    children: {
            ...
            children: {
              BushingPrimC1: {
                ...
                children: {
                  ...
                  condition_indicator_df: {
                    label: 'Condition indicator DF',
                    value: 'BushingPrimC1_condition_indicator_df'
                  },
                  condition_indicator_c: {
                    label: 'Condition indicator C',
                    value: 'BushingPrimC1_condition_indicator_c'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'BushingPrimC1_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'BushingPrimC1_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'BushingPrimC1_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'BushingPrimC1_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'BushingPrimC1_cond_ambient_temp'
                  },
                  cond_humidity: {
                    label: 'Humidity (cond.)',
                    value: 'BushingPrimC1_cond_humidity'
                  },
                  cond_weather: { label: 'Weather (cond.)', value: 'BushingPrimC1_cond_weather' }
                }
              },
              BushingPrimC2: {
                label: 'Bushing Prim C2',
                children: {
                  ...
                  condition_indicator_df: {
                    label: 'Condition indicator DF',
                    value: 'BushingPrimC2_condition_indicator_df'
                  },
                  condition_indicator_c: {
                    label: 'Condition indicator C',
                    value: 'BushingPrimC2_condition_indicator_c'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'BushingPrimC2_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'BushingPrimC2_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'BushingPrimC2_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'BushingPrimC2_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'BushingPrimC2_cond_ambient_temp'
                  },
                  cond_humidity: {
                    label: 'Humidity (cond.)',
                    value: 'BushingPrimC2_cond_humidity'
                  },
                  cond_weather: { label: 'Weather (cond.)', value: 'BushingPrimC2_cond_weather' }
                }
              },
              BushingSecC1: {
                label: 'Bushing Sec DF & CAP C1',
                children: {
                  ...
                  condition_indicator_df: {
                    label: 'Condition indicator DF',
                    value: 'BushingSecC1_condition_indicator_df'
                  },
                  condition_indicator_c: {
                    label: 'Condition indicator C',
                    value: 'BushingSecC1_condition_indicator_c'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'BushingSecC1_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'BushingSecC1_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'BushingSecC1_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'BushingSecC1_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'BushingSecC1_cond_ambient_temp'
                  },
              ...
              BushingSecC2: {
                ...
                children: {
                  ...
                  condition_indicator_df: {
                    label: 'Condition indicator DF',
                    value: 'BushingSecC2_condition_indicator_df'
                  },
                  condition_indicator_c: {
                    label: 'Condition indicator C',
                    value: 'BushingSecC2_condition_indicator_c'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'BushingSecC2_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'BushingSecC2_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'BushingSecC2_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'BushingSecC2_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'BushingSecC2_cond_ambient_temp'
                  },
              ...
              BushingTertC1: {
                ...
                children: {
                  ...
                  condition_indicator_df: {
                    label: 'Condition indicator DF',
                    value: 'BushingTertC1_condition_indicator_df'
                  },
                  condition_indicator_c: {
                    label: 'Condition indicator C',
                    value: 'BushingTertC1_condition_indicator_c'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'BushingTertC1_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'BushingTertC1_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'BushingTertC1_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'BushingTertC1_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'BushingTertC1_cond_ambient_temp'
                  },
                  cond_humidity: {
                    label: 'Humidity (cond.)',
                    value: 'BushingTertC1_cond_humidity'
                  },
                  cond_weather: { label: 'Weather (cond.)', value: 'BushingTertC1_cond_weather' }
                }
              },
              BushingTertC2: {
                label: 'Bushing Tert DF & CAP C2',
                children: {
                  ...
                  condition_indicator_df: {
                    label: 'Condition indicator DF',
                    value: 'BushingTertC2_condition_indicator_df'
                  },
                  condition_indicator_c: {
                    label: 'Condition indicator C',
                    value: 'BushingTertC2_condition_indicator_c'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'BushingTertC2_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'BushingTertC2_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'BushingTertC2_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'BushingTertC2_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'BushingTertC2_cond_ambient_temp'
                  },
                  cond_humidity: {
                    label: 'Humidity (cond.)',
                    value: 'BushingTertC2_cond_humidity'
                  },
              ...
              DCWindingPrim: {
                ...
                children: {
                  ...
                  condition_indicator: {
                    ...
                    value: 'DCWindingPrim_condition_indicator'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'DCWindingPrim_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'DCWindingPrim_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'DCWindingPrim_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'DCWindingPrim_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'DCWindingPrim_cond_ambient_temp'
                  },
                  cond_humidity: {
                    label: 'Humidity (cond.)',
                    value: 'DCWindingPrim_cond_humidity'
                  },
              ...
              DCWindingSec: {
                ...
                children: {
                  ...
                  condition_indicator: {
                    label: 'Condition indicator',
                    value: 'DCWindingSec_condition_indicator'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'DCWindingSec_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'DCWindingSec_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'DCWindingSec_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'DCWindingSec_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'DCWindingSec_cond_ambient_temp'
                  },
              ...
              DCWindingTert: {
                ...
                children: {
                  ...
                  condition_indicator: {
                    label: 'Condition indicator',
                    value: 'DCWindingTert_condition_indicator'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'DCWindingTert_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'DCWindingTert_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'DCWindingTert_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'DCWindingTert_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'DCWindingTert_cond_ambient_temp'
                  },
                  cond_humidity: {
                    label: 'Humidity (cond.)',
                    value: 'DCWindingTert_cond_humidity'
                  },
              ...
              Dga: {
                ...
                children: {
                  ...
                  condition_indicator: {
                    label: 'Condition indicator',
                    value: 'Dga_condition_indicator'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'Dga_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'Dga_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'Dga_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'Dga_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'Dga_cond_ambient_temp'
                  },
              ...
              DimensionWeight: {
                ...
                children: {
                  ...
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'DimensionWeight_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'DimensionWeight_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'DimensionWeight_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'DimensionWeight_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'DimensionWeight_cond_ambient_temp'
                  },
                  cond_humidity: {
                    label: 'Humidity (cond.)',
                    value: 'DimensionWeight_cond_humidity'
                  },
              ...
              EnergyEfficiency: {
                ...
                children: {
                  ...
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'EnergyEfficiency_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'EnergyEfficiency_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'EnergyEfficiency_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'EnergyEfficiency_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'EnergyEfficiency_cond_ambient_temp'
                  },
                  cond_humidity: {
                    label: 'Humidity (cond.)',
                    value: 'EnergyEfficiency_cond_humidity'
                  },
              ...
              ExcitingCurrent: {
                ...
                children: {
                  ...
                  condition_indicator: {
                    label: 'Condition indicator',
                    value: 'ExcitingCurrent_condition_indicator'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'ExcitingCurrent_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'ExcitingCurrent_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'ExcitingCurrent_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'ExcitingCurrent_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'ExcitingCurrent_cond_ambient_temp'
                  },
                  cond_humidity: {
                    label: 'Humidity (cond.)',
                    value: 'ExcitingCurrent_cond_humidity'
                  },
              ...
              GasChromatography: {
                ...
                children: {
                  ...
                  condition_indicator: {
                    label: 'Condition indicator',
                    value: 'GasChromatography_condition_indicator'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'GasChromatography_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'GasChromatography_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'GasChromatography_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'GasChromatography_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'GasChromatography_cond_ambient_temp'
                  },
                  cond_humidity: {
                    label: 'Humidity (cond.)',
                    value: 'GasChromatography_cond_humidity'
                  },
                  cond_weather: {
                    label: 'Weather (cond.)',
                    value: 'GasChromatography_cond_weather'
                  }
                }
              },
              GeneralInspection: {
                ...
                children: {
                  ...
                  condition_indicator: {
                    label: 'Condition indicator',
                    value: 'GeneralInspection_condition_indicator'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'GeneralInspection_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'GeneralInspection_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'GeneralInspection_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'GeneralInspection_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'GeneralInspection_cond_ambient_temp'
                  },
                  cond_humidity: {
                    label: 'Humidity (cond.)',
                    value: 'GeneralInspection_cond_humidity'
                  },
                  cond_weather: {
                    label: 'Weather (cond.)',
                    value: 'GeneralInspection_cond_weather'
                  }
                }
              },
              InducedAcVoltageTest: {
                label: 'Induced AC Voltage Test',
                children: {
                  applied_terminal: {
                    label: 'Applied Terminal',
                    value: 'InducedAcVoltageTest_applied_terminal'
                  },
                  rated_voltage: {
                    label: 'Rated Voltage',
                    value: 'InducedAcVoltageTest_rated_voltage'
                  },
                  lv_terminal: { label: 'LV Terminal', value: 'InducedAcVoltageTest_lv_terminal' },
                  lv_tested_voltage: {
                    label: 'LV Tested Voltage',
                    value: 'InducedAcVoltageTest_lv_tested_voltage'
                  },
                  hv_terminal: { label: 'HV Terminal', value: 'InducedAcVoltageTest_hv_terminal' },
                  hv_tested_voltage: {
                    label: 'HV Tested Voltage',
                    value: 'InducedAcVoltageTest_hv_tested_voltage'
                  },
                  assessment: { label: 'Assessment', value: 'InducedAcVoltageTest_assessment' },
                  condition_indicator: {
                    label: 'Condition indicator',
                    value: 'InducedAcVoltageTest_condition_indicator'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'InducedAcVoltageTest_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'InducedAcVoltageTest_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'InducedAcVoltageTest_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'InducedAcVoltageTest_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'InducedAcVoltageTest_cond_ambient_temp'
                  },
                  cond_humidity: {
                    label: 'Humidity (cond.)',
                    value: 'InducedAcVoltageTest_cond_humidity'
                  },
                  cond_weather: {
                    label: 'Weather (cond.)',
                    value: 'InducedAcVoltageTest_cond_weather'
                  }
                }
              },
              InsulationResistance: {
                label: 'Insulation resistance of winding',
                children: {
                  ...
                  condition_indicator: {
                    label: 'Condition indicator',
                    value: 'InsulationResistance_condition_indicator'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'InsulationResistance_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'InsulationResistance_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'InsulationResistance_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'InsulationResistance_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'InsulationResistance_cond_ambient_temp'
                  },
                  cond_humidity: {
                    label: 'Humidity (cond.)',
                    value: 'InsulationResistance_cond_humidity'
                  },
                  cond_weather: {
                    label: 'Weather (cond.)',
                    value: 'InsulationResistance_cond_weather'
                  }
                }
              },
              InsulationResistanceYokeCore: {
                label: 'Insulation resistance of yoke and core',
                children: {
                  measurement: {
                    label: 'Measurement',
                    value: 'InsulationResistanceYokeCore_measurement'
                  },
                  ...
                  assessment: {
                    label: 'Assessment',
                    value: 'InsulationResistanceYokeCore_assessment'
                  },
                  condition_indicator: {
                    label: 'Condition indicator',
                    value: 'InsulationResistanceYokeCore_condition_indicator'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'InsulationResistanceYokeCore_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'InsulationResistanceYokeCore_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'InsulationResistanceYokeCore_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'InsulationResistanceYokeCore_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'InsulationResistanceYokeCore_cond_ambient_temp'
                  },
                  cond_humidity: {
                    label: 'Humidity (cond.)',
                    value: 'InsulationResistanceYokeCore_cond_humidity'
                  },
                  cond_weather: {
                    label: 'Weather (cond.)',
                    value: 'InsulationResistanceYokeCore_cond_weather'
                  }
                }
              },
              MeasurementOfNoLoad: {
                ...
                children: {
                  ...
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'MeasurementOfNoLoad_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'MeasurementOfNoLoad_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'MeasurementOfNoLoad_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'MeasurementOfNoLoad_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'MeasurementOfNoLoad_cond_ambient_temp'
                  },
                  cond_humidity: {
                    label: 'Humidity (cond.)',
                    value: 'MeasurementOfNoLoad_cond_humidity'
                  },
                  cond_weather: {
                    label: 'Weather (cond.)',
                    value: 'MeasurementOfNoLoad_cond_weather'
                  }
                }
              },
              MeasurementOfOil: {
                ...
                children: {
                  ...
                  electrode_gap_spacing: {
                    label: 'Electrode gap spacing',
                    value: 'MeasurementOfOil_electrode_gap_spacing'
                  },
                  result: { label: 'Result', value: 'MeasurementOfOil_result' },
                  assessment: { label: 'Assessment', value: 'MeasurementOfOil_assessment' },
                  condition_indicator: {
                    label: 'Condition indicator',
                    value: 'MeasurementOfOil_condition_indicator'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'MeasurementOfOil_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'MeasurementOfOil_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'MeasurementOfOil_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'MeasurementOfOil_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'MeasurementOfOil_cond_ambient_temp'
                  },
                  cond_humidity: {
                    label: 'Humidity (cond.)',
                    value: 'MeasurementOfOil_cond_humidity'
                  },
              ...
              MeasurementOfShortCircuit: {
                ...
                children: {
                  ...
                  assessment: {
                    label: 'Assessment',
                    value: 'MeasurementOfShortCircuit_assessment'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'MeasurementOfShortCircuit_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'MeasurementOfShortCircuit_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'MeasurementOfShortCircuit_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'MeasurementOfShortCircuit_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'MeasurementOfShortCircuit_cond_ambient_temp'
                  },
                  cond_humidity: {
                    label: 'Humidity (cond.)',
                    value: 'MeasurementOfShortCircuit_cond_humidity'
                  },
                  cond_weather: {
                    label: 'Weather (cond.)',
                    value: 'MeasurementOfShortCircuit_cond_weather'
                  }
                }
              },
              RatioPrimSec: {
                ...
                children: {
                  ...
                  condition_indicator: {
                    label: 'Condition indicator',
                    value: 'RatioPrimSec_condition_indicator'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'RatioPrimSec_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'RatioPrimSec_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'RatioPrimSec_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'RatioPrimSec_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'RatioPrimSec_cond_ambient_temp'
                  },
              ...
              SeparateSourceAc: {
                label: 'Separate Source AC Voltage Test',
                children: {
                  applied_terminal: {
                    label: 'Applied Terminal',
                    value: 'SeparateSourceAc_applied_terminal'
                  },
                  ...
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'SeparateSourceAc_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'SeparateSourceAc_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'SeparateSourceAc_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'SeparateSourceAc_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'SeparateSourceAc_cond_ambient_temp'
                  },
                  cond_humidity: {
                    label: 'Humidity (cond.)',
                    value: 'SeparateSourceAc_cond_humidity'
                  },
                  cond_weather: { label: 'Weather (cond.)', value: 'SeparateSourceAc_cond_weather' }
                }
              },
              ShortCircuitImpedancePrim: {
                label: 'Short-circuit impedance prim',
                children: {
                  ...
                  assessment: {
                    label: 'Assessment',
                    value: 'ShortCircuitImpedancePrim_assessment'
                  },
                  condition_indicator: {
                    label: 'Condition indicator',
                    value: 'ShortCircuitImpedancePrim_condition_indicator'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'ShortCircuitImpedancePrim_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'ShortCircuitImpedancePrim_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'ShortCircuitImpedancePrim_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'ShortCircuitImpedancePrim_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'ShortCircuitImpedancePrim_cond_ambient_temp'
                  },
                  cond_humidity: {
                    label: 'Humidity (cond.)',
                    value: 'ShortCircuitImpedancePrim_cond_humidity'
                  },
                  cond_weather: {
                    label: 'Weather (cond.)',
                    value: 'ShortCircuitImpedancePrim_cond_weather'
                  }
                }
              },
              ShortCircuitImpedanceSec: {
                label: 'Short-circuit impedance sec',
                children: {
                  ...
                  condition_indicator: {
                    label: 'Condition indicator',
                    value: 'ShortCircuitImpedanceSec_condition_indicator'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'ShortCircuitImpedanceSec_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'ShortCircuitImpedanceSec_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'ShortCircuitImpedanceSec_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'ShortCircuitImpedanceSec_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'ShortCircuitImpedanceSec_cond_ambient_temp'
                  },
                  cond_humidity: {
                    label: 'Humidity (cond.)',
                    value: 'ShortCircuitImpedanceSec_cond_humidity'
                  },
                  cond_weather: {
                    label: 'Weather (cond.)',
                    value: 'ShortCircuitImpedanceSec_cond_weather'
                  }
                }
              },
              ShortCircuitImpedanceTert: {
                label: 'Short-circuit impedance tert',
                children: {
                  ...
                  assessment: {
                    label: 'Assessment',
                    value: 'ShortCircuitImpedanceTert_assessment'
                  },
                  condition_indicator: {
                    label: 'Condition indicator',
                    value: 'ShortCircuitImpedanceTert_condition_indicator'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'ShortCircuitImpedanceTert_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'ShortCircuitImpedanceTert_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'ShortCircuitImpedanceTert_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'ShortCircuitImpedanceTert_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'ShortCircuitImpedanceTert_cond_ambient_temp'
                  },
                  cond_humidity: {
                    label: 'Humidity (cond.)',
                    value: 'ShortCircuitImpedanceTert_cond_humidity'
                  },
                  cond_weather: {
                    label: 'Weather (cond.)',
                    value: 'ShortCircuitImpedanceTert_cond_weather'
                  }
                }
              },
              TestingInstruments: {
                label: 'Testing Instruments',
                children: {
                  item: { label: 'Item', value: 'TestingInstruments_item' },
                  type: { label: 'Type', value: 'TestingInstruments_type' },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'TestingInstruments_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'TestingInstruments_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'TestingInstruments_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'TestingInstruments_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'TestingInstruments_cond_ambient_temp'
                  },
                  cond_humidity: {
                    label: 'Humidity (cond.)',
                    value: 'TestingInstruments_cond_humidity'
                  },
                  cond_weather: {
                    label: 'Weather (cond.)',
                    value: 'TestingInstruments_cond_weather'
                  }
                }
              },
              WindingDfCap: {
                ...
                children: {
                  ...
                  condition_indicator_df: {
                    label: 'Condition indicator DF',
                    value: 'WindingDfCap_condition_indicator_df'
                  },
                  condition_indicator_c: {
                    label: 'Condition indicator C',
                    value: 'WindingDfCap_condition_indicator_c'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'WindingDfCap_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'WindingDfCap_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'WindingDfCap_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'WindingDfCap_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'WindingDfCap_cond_ambient_temp'
                  },
            ...
            children: {
              DcWindingResistance: {
                ...
                children: {
                  ...
                  condition_indicator: {
                    label: 'Condition indicator',
                    value: 'DcWindingResistance_condition_indicator'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'DcWindingResistance_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'DcWindingResistance_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'DcWindingResistance_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'DcWindingResistance_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'DcWindingResistance_cond_ambient_temp'
                  },
                  cond_humidity: {
                    label: 'Humidity (cond.)',
                    value: 'DcWindingResistance_cond_humidity'
                  },
                  cond_weather: {
                    label: 'Weather (cond.)',
                    value: 'DcWindingResistance_cond_weather'
                  }
                }
              },
              GeneralInspection: {
              ...
              InsulationResistance: {
                ...
                children: {
                  ...
                  test_voltage: {
                    label: 'Test voltage',
                    value: 'InsulationResistance_test_voltage'
                  },
                  r60s: { label: 'R60s', value: 'InsulationResistance_r60s' },
                  assessment: { label: 'Assessment', value: 'InsulationResistance_assessment' },
                  condition_indicator: {
              ...
              VTDfcap: {
                ...
                children: {
                  ...
                  condition_indicator: {
                    label: 'Condition indicator',
                    value: 'VTDfcap_condition_indicator'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'VTDfcap_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'VTDfcap_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'VTDfcap_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'VTDfcap_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'VTDfcap_cond_ambient_temp'
                  },
              ...
              VTRatio: {
                ...
                children: {
                  ...
                  condition_indicator: {
                    label: 'Condition indicator',
                    value: 'VTRatio_condition_indicator'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'VTRatio_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'VTRatio_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'VTRatio_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'VTRatio_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'VTRatio_cond_ambient_temp'
                  },
            ...
            children: {
              CTDfcap: {
                ...
                children: {
                  ...
                  condition_indicator: {
                    label: 'Condition indicator',
                    value: 'CTDfcap_condition_indicator'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'CTDfcap_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'CTDfcap_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'CTDfcap_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'CTDfcap_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'CTDfcap_cond_ambient_temp'
                  },
              ...
              CTExcitation: {
                ...
                children: {
                  ...
                  condition_indicator: {
                    label: 'Condition indicator',
                    value: 'CTExcitation_condition_indicator'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'CTExcitation_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'CTExcitation_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'CTExcitation_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'CTExcitation_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'CTExcitation_cond_ambient_temp'
                  },
              ...
              CTRatio: {
                ...
                children: {
                  ...
                  condition_indicator: {
                    label: 'Condition indicator',
                    value: 'CTRatio_condition_indicator'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'CTRatio_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'CTRatio_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'CTRatio_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'CTRatio_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'CTRatio_cond_ambient_temp'
                  },
              ...
              CTWindingRes: {
                ...
                children: {
                  ...
                  condition_indicator: {
                    label: 'Condition indicator',
                    value: 'CTWindingRes_condition_indicator'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'CTWindingRes_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'CTWindingRes_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'CTWindingRes_cond_ambient_temp'
                  },
            ...
            children: {
              COCOTiming: {
                ...
                children: {
                  ...
                  opening_sync_between_phase: {
                    ...
                    value: 'COCOTiming_opening_sync_between_phase'
                  },
                  assessment: { label: 'Assessment', value: 'COCOTiming_assessment' },
                  condition_indicator: {
                    label: 'Condition indicator',
                    value: 'COCOTiming_condition_indicator'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'COCOTiming_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'COCOTiming_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'COCOTiming_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'COCOTiming_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'COCOTiming_cond_ambient_temp'
                  },
              ...
              COTiming: {
                ...
                children: {
                  ...
                  closing_sync_between_phase: {
                    ...
                    value: 'COTiming_closing_sync_between_phase'
                  },
                  closing_sync_between_interrupter: {
                    label: 'Closing sync. between interrupter (ms)',
                    value: 'COTiming_closing_sync_between_interrupter'
                  },
                  ...
                  condition_indicator: {
                    label: 'Condition indicator',
                    value: 'COTiming_condition_indicator'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'COTiming_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'COTiming_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'COTiming_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'COTiming_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'COTiming_cond_ambient_temp'
                  },
              ...
              CTiming: {
                ...
                children: {
                  ...
                  closing_sync_between_phase: {
                    label: 'Closing sync. between phase (ms)',
                    value: 'CTiming_closing_sync_between_phase'
                  },
                  closing_sync_between_interrupter: {
                    label: 'Closing sync. between interrupter (ms)',
                    value: 'CTiming_closing_sync_between_interrupter'
                  },
                  assessment: { label: 'Assessment', value: 'CTiming_assessment' },
                  condition_indicator: {
                    label: 'Condition indicator',
                    value: 'CTiming_condition_indicator'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'CTiming_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'CTiming_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'CTiming_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'CTiming_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'CTiming_cond_ambient_temp'
                  },
              ...
              ContactResistance: {
                ...
                children: {
                  ...
                  contact_resistance: {
                    label: 'Contact resistance',
                    value: 'ContactResistance_contact_resistance'
                  },
                  assessment: { label: 'Assessment', value: 'ContactResistance_assessment' },
                  condition_indicator: {
                    label: 'Condition indicator',
                    value: 'ContactResistance_condition_indicator'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'ContactResistance_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'ContactResistance_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'ContactResistance_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'ContactResistance_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'ContactResistance_cond_ambient_temp'
                  },
                  cond_humidity: {
                    label: 'Humidity (cond.)',
                    value: 'ContactResistance_cond_humidity'
                  },
                  cond_weather: {
                    label: 'Weather (cond.)',
                    value: 'ContactResistance_cond_weather'
                  }
                }
              },
              DCWindingCloseCoil: {
                ...
                children: {
                  close_coil_no: {
                    label: 'Close Coil No',
                    value: 'DCWindingCloseCoil_close_coil_no'
                  },
                  r_meas: { label: 'R meas', value: 'DCWindingCloseCoil_r_meas' },
                  assessment: { label: 'Assessment', value: 'DCWindingCloseCoil_assessment' },
                  condition_indicator: {
                    label: 'Condition indicator',
                    value: 'DCWindingCloseCoil_condition_indicator'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'DCWindingCloseCoil_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'DCWindingCloseCoil_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'DCWindingCloseCoil_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'DCWindingCloseCoil_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'DCWindingCloseCoil_cond_ambient_temp'
                  },
                  cond_humidity: {
                    label: 'Humidity (cond.)',
                    value: 'DCWindingCloseCoil_cond_humidity'
                  },
                  cond_weather: {
                    label: 'Weather (cond.)',
                    value: 'DCWindingCloseCoil_cond_weather'
                  }
                }
              },
              DCWindingMotor: {
                ...
                children: {
                  ...
                  condition_indicator: {
                    label: 'Condition indicator',
                    value: 'DCWindingMotor_condition_indicator'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'DCWindingMotor_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'DCWindingMotor_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'DCWindingMotor_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'DCWindingMotor_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'DCWindingMotor_cond_ambient_temp'
                  },
                  cond_humidity: {
                    label: 'Humidity (cond.)',
                    value: 'DCWindingMotor_cond_humidity'
                  },
              ...
              DCWindingTripCoil: {
                ...
                children: {
                  ...
                  condition_indicator: {
                    label: 'Condition indicator',
                    value: 'DCWindingTripCoil_condition_indicator'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'DCWindingTripCoil_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'DCWindingTripCoil_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'DCWindingTripCoil_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'DCWindingTripCoil_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'DCWindingTripCoil_cond_ambient_temp'
                  },
                  cond_humidity: {
                    label: 'Humidity (cond.)',
                    value: 'DCWindingTripCoil_cond_humidity'
                  },
                  cond_weather: {
                    label: 'Weather (cond.)',
                    value: 'DCWindingTripCoil_cond_weather'
                  }
                }
              },
              GeneralInspection: {
              ...
              InsulationResistanceCircuit: {
                ...
                children: {
                  measurement: {
                    label: 'Measurement',
                    value: 'InsulationResistanceCircuit_measurement'
                  },
                  test_voltage: {
                    label: 'Test voltage',
                    value: 'InsulationResistanceCircuit_test_voltage'
                  },
                  r60s: { label: 'R60s', value: 'InsulationResistanceCircuit_r60s' },
                  assessment: {
                    label: 'Assessment',
                    value: 'InsulationResistanceCircuit_assessment'
                  },
                  condition_indicator: {
                    label: 'Condition indicator',
                    value: 'InsulationResistanceCircuit_condition_indicator'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'InsulationResistanceCircuit_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'InsulationResistanceCircuit_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'InsulationResistanceCircuit_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'InsulationResistanceCircuit_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'InsulationResistanceCircuit_cond_ambient_temp'
                  },
                  cond_humidity: {
                    label: 'Humidity (cond.)',
                    value: 'InsulationResistanceCircuit_cond_humidity'
                  },
                  cond_weather: {
                    label: 'Weather (cond.)',
                    value: 'InsulationResistanceCircuit_cond_weather'
                  }
                }
              },
              InsulationResistanceCloseCoil: {
                ...
                children: {
                  close_coil_no: {
                    label: 'Close Coil No',
                    value: 'InsulationResistanceCloseCoil_close_coil_no'
                  },
                  test_voltage: {
                    label: 'Test voltage',
                    value: 'InsulationResistanceCloseCoil_test_voltage'
                  },
                  r60s: { label: 'R60s', value: 'InsulationResistanceCloseCoil_r60s' },
                  assessment: {
                    label: 'Assessment',
                    value: 'InsulationResistanceCloseCoil_assessment'
                  },
                  condition_indicator: {
                    label: 'Condition indicator',
                    value: 'InsulationResistanceCloseCoil_condition_indicator'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'InsulationResistanceCloseCoil_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'InsulationResistanceCloseCoil_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'InsulationResistanceCloseCoil_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'InsulationResistanceCloseCoil_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'InsulationResistanceCloseCoil_cond_ambient_temp'
                  },
                  cond_humidity: {
                    label: 'Humidity (cond.)',
                    value: 'InsulationResistanceCloseCoil_cond_humidity'
                  },
                  cond_weather: {
                    label: 'Weather (cond.)',
                    value: 'InsulationResistanceCloseCoil_cond_weather'
                  }
                }
              },
              InsulationResistanceMotor: {
                ...
                children: {
                  test_voltage: {
                    label: 'Test voltage',
                    value: 'InsulationResistanceMotor_test_voltage'
                  },
                  r60s: { label: 'R60s', value: 'InsulationResistanceMotor_r60s' },
                  assessment: {
                    label: 'Assessment',
                    value: 'InsulationResistanceMotor_assessment'
                  },
                  condition_indicator: {
                    label: 'Condition indicator',
                    value: 'InsulationResistanceMotor_condition_indicator'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'InsulationResistanceMotor_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'InsulationResistanceMotor_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'InsulationResistanceMotor_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'InsulationResistanceMotor_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'InsulationResistanceMotor_cond_ambient_temp'
                  },
                  cond_humidity: {
                    label: 'Humidity (cond.)',
                    value: 'InsulationResistanceMotor_cond_humidity'
                  },
                  cond_weather: {
                    label: 'Weather (cond.)',
                    value: 'InsulationResistanceMotor_cond_weather'
                  }
                }
              },
              InsulationResistanceTripCoil: {
                ...
                children: {
                  trip_coil_no: {
                    label: 'Trip Coil No',
                    value: 'InsulationResistanceTripCoil_trip_coil_no'
                  },
                  test_voltage: {
                    label: 'Test voltage',
                    value: 'InsulationResistanceTripCoil_test_voltage'
                  },
                  r60s: { label: 'R60s', value: 'InsulationResistanceTripCoil_r60s' },
                  assessment: {
                    label: 'Assessment',
                    value: 'InsulationResistanceTripCoil_assessment'
                  },
                  condition_indicator: {
                    label: 'Condition indicator',
                    value: 'InsulationResistanceTripCoil_condition_indicator'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'InsulationResistanceTripCoil_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'InsulationResistanceTripCoil_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'InsulationResistanceTripCoil_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'InsulationResistanceTripCoil_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'InsulationResistanceTripCoil_cond_ambient_temp'
                  },
                  cond_humidity: {
                    label: 'Humidity (cond.)',
                    value: 'InsulationResistanceTripCoil_cond_humidity'
                  },
                  cond_weather: {
                    label: 'Weather (cond.)',
                    value: 'InsulationResistanceTripCoil_cond_weather'
                  }
                }
              },
              MinimumPickup: {
                ...
                children: {
                  ...
                  condition_indicator: {
                    label: 'Condition indicator',
                    value: 'MinimumPickup_condition_indicator'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'MinimumPickup_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'MinimumPickup_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'MinimumPickup_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'MinimumPickup_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'MinimumPickup_cond_ambient_temp'
                  },
                  cond_humidity: {
                    label: 'Humidity (cond.)',
                    value: 'MinimumPickup_cond_humidity'
                  },
              ...
              MotorCurrent: {
                ...
                children: {
                  ...
                  charging_current: {
                    label: 'Charging current',
                    value: 'MotorCurrent_charging_current'
                  },
                  ...
                  condition_indicator: {
                    label: 'Condition indicator',
                    value: 'MotorCurrent_condition_indicator'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'MotorCurrent_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'MotorCurrent_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'MotorCurrent_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'MotorCurrent_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'MotorCurrent_cond_ambient_temp'
                  },
              ...
              OCOCOTiming: {
                ...
                children: {
                  ...
                  opening_sync_between_phase: {
                    label: 'Opening sync. between phase (ms)',
                    value: 'OCOCOTiming_opening_sync_between_phase'
                  },
                  assessment: { label: 'Assessment', value: 'OCOCOTiming_assessment' },
                  condition_indicator: {
                    label: 'Condition indicator',
                    value: 'OCOCOTiming_condition_indicator'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'OCOCOTiming_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'OCOCOTiming_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'OCOCOTiming_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'OCOCOTiming_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'OCOCOTiming_cond_ambient_temp'
                  },
              ...
              OCOTiming: {
                ...
                children: {
                  ...
                  opening_sync_between_phase: {
                    label: 'Opening sync. between phase (ms)',
                    value: 'OCOTiming_opening_sync_between_phase'
                  },
                  opening_sync_between_interrupter: {
                    label: 'Opening sync. between interrupter (ms)',
                    value: 'OCOTiming_opening_sync_between_interrupter'
                  },
                  closing_time: { label: 'Closing time', value: 'OCOTiming_closing_time' },
                  closing_sync_between_phase: {
                    label: 'Closing sync. between phase (ms)',
                    value: 'OCOTiming_closing_sync_between_phase'
                  },
                  closing_sync_between_interrupter: {
                    label: 'Closing sync. between interrupter (ms)',
                    value: 'OCOTiming_closing_sync_between_interrupter'
                  },
                  ...
                  condition_indicator: {
                    label: 'Condition indicator',
                    value: 'OCOTiming_condition_indicator'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'OCOTiming_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'OCOTiming_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'OCOTiming_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'OCOTiming_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'OCOTiming_cond_ambient_temp'
                  },
              ...
              OCTiming: {
                ...
                children: {
                  ...
                  opening_sync_between_interrupter: {
                    label: 'Opening sync. between interrupter (ms)',
                    value: 'OCTiming_opening_sync_between_interrupter'
                  },
                  opening_sync_between_phase: {
                    label: 'Opening sync. between phase (ms)',
                    value: 'OCTiming_opening_sync_between_phase'
                  },
                  ...
                  condition_indicator: {
                    label: 'Condition indicator',
                    value: 'OCTiming_condition_indicator'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'OCTiming_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'OCTiming_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'OCTiming_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'OCTiming_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'OCTiming_cond_ambient_temp'
                  },
              ...
              OTiming: {
                ...
                children: {
                  ...
                  opening_sync_between_phase: {
                    label: 'Opening sync. between phase (ms)',
                    value: 'OTiming_opening_sync_between_phase'
                  },
                  opening_sync_between_interrupter: {
                    label: 'Opening sync. between interrupter (ms)',
                    value: 'OTiming_opening_sync_between_interrupter'
                  },
                  assessment: { label: 'Assessment', value: 'OTiming_assessment' },
                  condition_indicator: {
                    label: 'Condition indicator',
                    value: 'OTiming_condition_indicator'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'OTiming_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'OTiming_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'OTiming_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'OTiming_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'OTiming_cond_ambient_temp'
                  },
              ...
              OverCurrentRelease: {
                ...
                children: {
                  ...
                  condition_indicator: {
                    label: 'Condition indicator',
                    value: 'OverCurrentRelease_condition_indicator'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'OverCurrentRelease_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'OverCurrentRelease_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'OverCurrentRelease_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'OverCurrentRelease_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'OverCurrentRelease_cond_ambient_temp'
                  },
                  cond_humidity: {
                    label: 'Humidity (cond.)',
                    value: 'OverCurrentRelease_cond_humidity'
                  },
                  cond_weather: {
                    label: 'Weather (cond.)',
                    value: 'OverCurrentRelease_cond_weather'
                  }
                }
              },
              PressureGauge: {
                ...
                children: {
                  ...
                  condition_indicator: {
                    label: 'Condition indicator',
                    value: 'PressureGauge_condition_indicator'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'PressureGauge_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'PressureGauge_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'PressureGauge_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'PressureGauge_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'PressureGauge_cond_ambient_temp'
                  },
                  cond_humidity: {
                    label: 'Humidity (cond.)',
                    value: 'PressureGauge_cond_humidity'
                  },
              ...
              SF6GasAnalysis: {
                ...
                children: {
                  ...
                  condition_indicator: {
                    label: 'Condition indicator',
                    value: 'SF6GasAnalysis_condition_indicator'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'SF6GasAnalysis_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'SF6GasAnalysis_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'SF6GasAnalysis_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'SF6GasAnalysis_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'SF6GasAnalysis_cond_ambient_temp'
                  },
                  cond_humidity: {
                    label: 'Humidity (cond.)',
                    value: 'SF6GasAnalysis_cond_humidity'
                  },
              ...
              SF6MoiturePurity: {
                ...
                children: {
                  ...
                  condition_indicator: {
                    label: 'Condition indicator',
                    value: 'SF6MoiturePurity_condition_indicator'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'SF6MoiturePurity_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'SF6MoiturePurity_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'SF6MoiturePurity_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'SF6MoiturePurity_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'SF6MoiturePurity_cond_ambient_temp'
                  },
                  cond_humidity: {
                    label: 'Humidity (cond.)',
                    value: 'SF6MoiturePurity_cond_humidity'
                  },
              ...
              UnderVoltageRelease: {
                ...
                children: {
                  trip_coil_no: {
                    label: 'Trip Coil No',
                    value: 'UnderVoltageRelease_trip_coil_no'
                  },
                  trip_voltage: {
                    label: 'Trip voltage',
                    value: 'UnderVoltageRelease_trip_voltage'
                  },
                  assessment: { label: 'Assessment', value: 'UnderVoltageRelease_assessment' },
                  condition_indicator: {
                    label: 'Condition indicator',
                    value: 'UnderVoltageRelease_condition_indicator'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'UnderVoltageRelease_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'UnderVoltageRelease_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'UnderVoltageRelease_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'UnderVoltageRelease_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'UnderVoltageRelease_cond_ambient_temp'
                  },
                  cond_humidity: {
                    label: 'Humidity (cond.)',
                    value: 'UnderVoltageRelease_cond_humidity'
                  },
                  cond_weather: {
                    label: 'Weather (cond.)',
                    value: 'UnderVoltageRelease_cond_weather'
                  }
                }
              }
            }
      ...
      Job_PowerCableJobDto: {
        label: 'Power Cable Job',
        children: {
          PropertiesDto: {
            label: 'Properties',
            children: {
            ...
            children: {
              AcVoltageInsulation: {
                ...
                children: {
                  ...
                  test_voltage: {
                    label: 'Test voltage',
                    value: 'AcVoltageInsulation_test_voltage'
                  },
                  ...
                  condition_indicator: {
                    label: 'Condition indicator',
                    value: 'AcVoltageInsulation_condition_indicator'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'AcVoltageInsulation_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'AcVoltageInsulation_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'AcVoltageInsulation_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'AcVoltageInsulation_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'AcVoltageInsulation_cond_ambient_temp'
                  },
                  cond_humidity: {
                    label: 'Humidity (cond.)',
                    value: 'AcVoltageInsulation_cond_humidity'
                  },
                  cond_weather: {
                    label: 'Weather (cond.)',
                    value: 'AcVoltageInsulation_cond_weather'
                  }
                }
              },
              DcVoltageInsulation: {
                ...
                children: {
                  ...
                  test_voltage: {
                    label: 'Test voltage',
                    value: 'DcVoltageInsulation_test_voltage'
                  },
                  leakage_current: {
                    label: 'Leakage current',
                    value: 'DcVoltageInsulation_leakage_current'
                  },
                  assessment: { label: 'Assessment', value: 'DcVoltageInsulation_assessment' },
                  condition_indicator: {
                    label: 'Condition indicator',
                    value: 'DcVoltageInsulation_condition_indicator'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'DcVoltageInsulation_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'DcVoltageInsulation_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'DcVoltageInsulation_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'DcVoltageInsulation_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'DcVoltageInsulation_cond_ambient_temp'
                  },
                  cond_humidity: {
                    label: 'Humidity (cond.)',
                    value: 'DcVoltageInsulation_cond_humidity'
                  },
                  cond_weather: {
                    label: 'Weather (cond.)',
                    value: 'DcVoltageInsulation_cond_weather'
                  }
                }
              },
              DcVoltageOverSheath: {
                ...
                children: {
                  ...
                  test_voltage: {
                    label: 'Test voltage',
                    value: 'DcVoltageOverSheath_test_voltage'
                  },
                  ...
                  condition_indicator: {
                    label: 'Condition indicator',
                    value: 'DcVoltageOverSheath_condition_indicator'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'DcVoltageOverSheath_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'DcVoltageOverSheath_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'DcVoltageOverSheath_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'DcVoltageOverSheath_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'DcVoltageOverSheath_cond_ambient_temp'
                  },
                  cond_humidity: {
                    label: 'Humidity (cond.)',
                    value: 'DcVoltageOverSheath_cond_humidity'
                  },
                  cond_weather: {
                    label: 'Weather (cond.)',
                    value: 'DcVoltageOverSheath_cond_weather'
                  }
                }
              },
              GeneralInspection: {
              ...
              ParticalDischarge: {
                ...
                children: {
                  ...
                  condition_indicator: {
                    label: 'Condition indicator',
                    value: 'ParticalDischarge_condition_indicator'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'ParticalDischarge_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'ParticalDischarge_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'ParticalDischarge_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'ParticalDischarge_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'ParticalDischarge_cond_ambient_temp'
                  },
                  cond_humidity: {
                    label: 'Humidity (cond.)',
                    value: 'ParticalDischarge_cond_humidity'
                  },
                  cond_weather: {
                    label: 'Weather (cond.)',
                    value: 'ParticalDischarge_cond_weather'
                  }
                }
              },
              TandeltaPowerAcSource: {
                ...
                children: {
                  ...
                  test_voltage: {
                    label: 'Test voltage',
                    value: 'TandeltaPowerAcSource_test_voltage'
                  },
                  ...
                  tan_delta: {
                    label: 'Tan delta [10⁻³]',
                    value: 'TandeltaPowerAcSource_tan_delta'
                  },
                  assessment: { label: 'Assessment', value: 'TandeltaPowerAcSource_assessment' },
                  condition_indicator: {
                    label: 'Condition indicator',
                    value: 'TandeltaPowerAcSource_condition_indicator'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'TandeltaPowerAcSource_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'TandeltaPowerAcSource_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'TandeltaPowerAcSource_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'TandeltaPowerAcSource_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'TandeltaPowerAcSource_cond_ambient_temp'
                  },
                  cond_humidity: {
                    label: 'Humidity (cond.)',
                    value: 'TandeltaPowerAcSource_cond_humidity'
                  },
                  cond_weather: {
                    label: 'Weather (cond.)',
                    value: 'TandeltaPowerAcSource_cond_weather'
                  }
                }
              },
              TandeltaVlfSource: {
                ...
                children: {
                  ...
                  ref_test_voltage: {
                    label: 'Reference test voltage',
                    value: 'TandeltaVlfSource_ref_test_voltage'
                  },
                  capacitance: { label: 'Capacitance', value: 'TandeltaVlfSource_capacitance' },
                  mtd: { label: 'MTD', value: 'TandeltaVlfSource_mtd' },
                  delta_td_each_step: {
                    label: 'ΔTD [10⁻³] (each step)',
                    value: 'TandeltaVlfSource_delta_td_each_step'
                  },
                  tan_delta_dtd: {
                    label: 'DTD [10⁻³] (0.5 U₀ & 1.5 U₀)',
                    value: 'TandeltaVlfSource_tan_delta_dtd'
                  },
                  tan_delta_tdts: {
                    label: 'TDTS [10⁻³]',
                    value: 'TandeltaVlfSource_tan_delta_tdts'
                  },
                  assessment: { label: 'Assessment', value: 'TandeltaVlfSource_assessment' },
                  condition_indicator: {
                    label: 'Condition indicator',
                    value: 'TandeltaVlfSource_condition_indicator'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'TandeltaVlfSource_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'TandeltaVlfSource_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'TandeltaVlfSource_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'TandeltaVlfSource_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'TandeltaVlfSource_cond_ambient_temp'
                  },
                  cond_humidity: {
                    label: 'Humidity (cond.)',
                    value: 'TandeltaVlfSource_cond_humidity'
                  },
                  cond_weather: {
                    label: 'Weather (cond.)',
                    value: 'TandeltaVlfSource_cond_weather'
                  }
                }
              },
              VlfTest: {
                ...
                children: {
                  ...
                  condition_indicator: {
                    label: 'Condition indicator',
                    value: 'VlfTest_condition_indicator'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'VlfTest_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'VlfTest_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'VlfTest_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'VlfTest_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'VlfTest_cond_ambient_temp'
                  },
      ...
      Job_SurgeArresterJobDto: {
        label: 'Surge Arrester Job',
        children: {
          PropertiesDto: {
            label: 'Properties',
            children: {
          ...
          Tests: {
            ...
            children: {
              ...
              LeakageCurrent: {
                label: 'Leakage current at continuous operating voltage',
                children: {
                  ...
                  condition_indicator: {
                    label: 'Condition indicator',
                    value: 'LeakageCurrent_condition_indicator'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'LeakageCurrent_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'LeakageCurrent_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'LeakageCurrent_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'LeakageCurrent_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'LeakageCurrent_cond_ambient_temp'
                  },
                  cond_humidity: {
                    label: 'Humidity (cond.)',
                    value: 'LeakageCurrent_cond_humidity'
                  },
                  cond_weather: { label: 'Weather (cond.)', value: 'LeakageCurrent_cond_weather' }
                }
              },
              PowerFrequency: {
                label: 'Power frequency voltage at reference current',
                children: {
                  ...
                  condition_indicator: {
                    label: 'Condition indicator',
                    value: 'PowerFrequency_condition_indicator'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'PowerFrequency_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'PowerFrequency_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'PowerFrequency_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'PowerFrequency_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'PowerFrequency_cond_ambient_temp'
                  },
                  cond_humidity: {
                    label: 'Humidity (cond.)',
                    value: 'PowerFrequency_cond_humidity'
                  },
      ...
      Job_DisconnectorJobDto: {
        label: 'Disconnector Job',
        children: {
          PropertiesDto: {
            label: 'Properties',
            children: {
            ...
            children: {
              ...
              ControlCheck: {
                ...
                children: {
                  ...
                  condition_indicator: {
                    label: 'Condition indicator',
                    value: 'ControlCheck_condition_indicator'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'ControlCheck_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'ControlCheck_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'ControlCheck_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'ControlCheck_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'ControlCheck_cond_ambient_temp'
                  },
              ...
              InsulationResMotor: {
                ...
                children: {
                  ...
                  condition_indicator: {
                    label: 'Condition indicator',
                    value: 'InsulationResMotor_condition_indicator'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'InsulationResMotor_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'InsulationResMotor_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'InsulationResMotor_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'InsulationResMotor_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'InsulationResMotor_cond_ambient_temp'
                  },
                  cond_humidity: {
                    label: 'Humidity (cond.)',
                    value: 'InsulationResMotor_cond_humidity'
                  },
                  cond_weather: {
                    label: 'Weather (cond.)',
                    value: 'InsulationResMotor_cond_weather'
                  }
                }
              },
              InsulationResistance: {
              ...
              OperatingTest: {
                ...
                children: {
                  ...
                  condition_indicator: {
                    label: 'Condition indicator',
                    value: 'OperatingTest_condition_indicator'
                  },
                  cond_top_oil_temp: {
                    label: 'Top oil temperature (cond.)',
                    value: 'OperatingTest_cond_top_oil_temp'
                  },
                  cond_bottom_oil_temp: {
                    label: 'Bottom oil temperature (cond.)',
                    value: 'OperatingTest_cond_bottom_oil_temp'
                  },
                  cond_winding_temp: {
                    label: 'Winding temperature (cond.)',
                    value: 'OperatingTest_cond_winding_temp'
                  },
                  cond_reference_temp: {
                    label: 'Reference temperature (cond.)',
                    value: 'OperatingTest_cond_reference_temp'
                  },
                  cond_ambient_temp: {
                    label: 'Ambient temperature (cond.)',
                    value: 'OperatingTest_cond_ambient_temp'
                  },
                  cond_humidity: {
                    label: 'Humidity (cond.)',
                    value: 'OperatingTest_cond_humidity'
                  },
      ...
      Job_RotatingMachineJobDto: {
        label: 'Rotating Machine Job',
        children: {
          PropertiesDto: {
            label: 'Properties',
            children: {
