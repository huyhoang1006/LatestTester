...
export default {
  ...
  methods: {
    async saveAsset() {
      try {
        if (
          this.circuitBreakerDto.properties.serial_no !== null &&
          this.circuitBreakerDto.properties.serial_no !== ''
        ) {
    ...
    checkLifecycleDate(data) {
      ...
      if (
        data.operatingMechanismLifecycleDateId == null ||
        data.operatingMechanismLifecycleDateId == ''
      ) {
    ...
    checkProductAssetModel(data) {
      ...
      if (
        data.operatingMechanismProductAssetModelId === null ||
        data.operatingMechanismProductAssetModelId === ''
      ) {
