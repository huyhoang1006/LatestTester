    ...
    <div class="content-toggle" v-if="openRatings">
      <el-row :gutter="20" class="content">
        <el-col :xs="24" :sm="18" :md="14" :lg="12" class="col-content">
          ...
          >
            <el-form-item
              v-if="ratingsData.rated_frequency.value !== 'Custom'"
              ...
              <div style="display: flex">
                ...
                <div style="width: 48%" v-if="ratingsData.rated_frequency.value === 'Custom'">
                  <el-input
                    type="text"
                    number="positive"
                    v-model="ratingsData.rated_frequency_custom.value"
                  >
          ...
          >
            ...
            <el-form-item label="Rated short-circuit breaking current">
              <el-input
                type="text"
                number="positive"
                v-model="ratingsData.rated_short_circuit_breaking_current.value"
              >
            ...
            <el-form-item label="Short-circuit nominal duration">
              <el-input
                type="text"
                number="positive"
                v-model="ratingsData.short_circuit_nominal_duration.value"
              >
            ...
            <el-form-item label="Rated insulation level (BIL)">
              <el-input
                type="text"
                number="positive"
                v-model="ratingsData.rated_insulation_level.value"
              >
                <template #append>kV</template>
              </el-input>
            </el-form-item>
            <el-form-item label="Rated interrupting time">
              <el-input
                type="text"
                number="positive"
                v-model="ratingsData.rated_interrupting_time.value"
              >
            ...
            <el-form-item label="interrupting duty cycle">
              <el-input
                type="text"
                number="positive"
                v-model="ratingsData.interrupting_duty_cycle"
              ></el-input>
            </el-form-item>
            <el-form-item label="Rated power at closing">
              <el-input
                type="text"
                number="positive"
                v-model="ratingsData.rated_power_at_closing.value"
              >
            ...
            <el-form-item label="Rated power at opening">
              <el-input
                type="text"
                number="positive"
                v-model="ratingsData.rated_power_at_opening.value"
              >
                <template #append>W</template>
              </el-input>
            </el-form-item>
            <el-form-item label="Rated power at motor charge">
              <el-input
                type="text"
                number="positive"
                v-model="ratingsData.rated_power_at_motor_charge.value"
              >
                <template #append>W</template>
              </el-input>
            </el-form-item>
