                    ...
                    <table class="table-strip-input-data" style="width: 100% !important;">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <el-input size="small" v-model="assessLimitsData.contact_resistance.abs.r_min.value">
                                        <template #append>&#181;&#8486;</template>
                                    </el-input>
                                </td>
                                <td>
                                    <el-input size="small" v-model="assessLimitsData.contact_resistance.abs.r_max.value">
                                        <template #append>&#181;&#8486;</template>
                                    </el-input>
                                </td>
                            </tr>
                    ...
                    <table class="table-strip-input-data" style="width: 100% !important;">
                        ...
                        <tbody>
                            <tr>
                                <td>Contact resistance</td>
                                <td>
                                    <el-input size="small" v-model="assessLimitsData.contact_resistance.rel.r_ref.value">
                                        <template #append>&#181;&#8486;</template>
                                    </el-input>
                                </td>
                                <td>
                                    <el-input size="small" v-model="assessLimitsData.contact_resistance.rel.r_dev.value">
                                        <template #append>&#181;&#8486;</template>
                                    </el-input>
                                </td>
                            </tr>
                    ...
                    <table class="table-strip-input-data" style="width: 100% !important;">
                        ...
                        <tbody>
                            <tr v-for="(item, index) in opening_times" :key="index">
                                <td>{{item.label}}</td>
                                <td>
                                    <el-input size="small" v-model="assessLimitsData.operating_time.abs[item.value].t_min.value">
                                        <template #append>ms</template>
                                    </el-input>
                                </td>
                                <td>
                                    <el-input size="small" v-model="assessLimitsData.operating_time.abs[item.value].t_max.value">
                                        <template #append>ms</template>
                                    </el-input>
                                </td>
                            </tr>
                    ...
                    <table class="table-strip-input-data" style="width: 100% !important;">
                        ...
                        <tbody>
                            <tr v-for="(item, index) in opening_times" :key="index">
                                <td>{{item.label}}</td>
                                <td>
                                    <el-input size="small" v-model="assessLimitsData.operating_time.rel[item.value].t_ref.value">
                                        <template #append>ms</template>
                                    </el-input>
                                </td>
                                <td>
                                    <el-input size="small" v-model="assessLimitsData.operating_time.rel[item.value].minus_t_dev.value">
                                        <template #append>ms</template>
                                    </el-input>
                                </td>
                                <td>
                                    <el-input size="small" v-model="assessLimitsData.operating_time.rel[item.value].plus_t_dev.value">
                                        <template #append>ms</template>
                                    </el-input>
                                </td>
                            </tr>
                    ...
                    <table class="table-strip-input-data" style="width: 100% !important;">
                        ...
                        <tbody>
                            <tr v-for="(item, index) in contact_travel" :key="index">
                                <td>{{item.label}}</td>
                                <td>
                                    <el-input size="small" v-model="assessLimitsData.contact_travel.abs[item.value].d_min.value">
                                        <template #append>mm</template>
                                    </el-input>
                                </td>
                                <td>
                                    <el-input size="small" v-model="assessLimitsData.contact_travel.abs[item.value].d_max.value">
                                        <template #append>mm</template>
                                    </el-input>
                                </td>
                            </tr>
                    ...
                    <table class="table-strip-input-data" style="width: 100% !important;">
                        ...
                        <tbody>
                            <tr v-for="(item, index) in contact_travel" :key="index">
                                <td>{{item.label}}</td>
                                <td>
                                    <el-input size="small" v-model="assessLimitsData.contact_travel.rel[item.value].d_ref.value">
                                        <template #append>mm</template>
                                    </el-input>
                                </td>
                                <td>
                                    <el-input size="small" v-model="assessLimitsData.contact_travel.rel[item.value].d_dev.value">
                                        <template #append>mm</template>
                                    </el-input>
                                </td>
                            </tr>
                    ...
                    <table class="table-strip-input-data" style="width: 100% !important;">
                        ...
                        <tbody>
                            <tr v-for="(item, index) in Auxiliary_contact" :key="index">
                                ...
                                <td>
                                    <el-input size="small" v-model="assessLimitsData.auxiliary_contacts.trip_operation.abs[item.value].t_min.value">
                                        <template #append>ms</template>
                                    </el-input>
                                </td>
                                <td>
                                    <el-input size="small" v-model="assessLimitsData.auxiliary_contacts.trip_operation.abs[item.value].t_max.value">
                                        <template #append>ms</template>
                                    </el-input>
                                </td>
                            </tr>
                    ...
                    <table class="table-strip-input-data" style="width: 100% !important;">
                        ...
                        <tbody>
                            <tr v-for="(item, index) in Auxiliary_contact" :key="index">
                                ...
                                <td>
                                    <el-input size="small" v-model="assessLimitsData.auxiliary_contacts.trip_operation.rel[item.value].t_ref.value">
                                        <template #append>ms</template>
                                    </el-input>
                                </td>
                                <td>
                                    <el-input size="small" v-model="assessLimitsData.auxiliary_contacts.trip_operation.rel[item.value].t_dev.value">
                                        <template #append>ms</template>
                                    </el-input>
                                </td>
                            </tr>
                    ...
                    <table class="table-strip-input-data" style="width: 100% !important;">
                        ...
                        <tbody>
                            <tr v-for="(item, index) in Auxiliary_contact" :key="index">
                                ...
                                <td>
                                    <el-input size="small" v-model="assessLimitsData.auxiliary_contacts.close_operation.abs[item.value].t_min.value">
                                        <template #append>ms</template>
                                    </el-input>
                                </td>
                                <td>
                                    <el-input size="small" v-model="assessLimitsData.auxiliary_contacts.close_operation.abs[item.value].t_max.value">
                                        <template #append>ms</template>
                                    </el-input>
                                </td>
                            </tr>
                    ...
                    <table class="table-strip-input-data" style="width: 100% !important;">
                        ...
                        <tbody>
                            <tr v-for="(item, index) in Auxiliary_contact" :key="index">
                                ...
                                <td>
                                    <el-input size="small" v-model="assessLimitsData.auxiliary_contacts.close_operation.rel[item.value].t_ref.value">
                                        <template #append>ms</template>
                                    </el-input>
                                </td>
                                <td>
                                    <el-input size="small" v-model="assessLimitsData.auxiliary_contacts.close_operation.rel[item.value].t_dev.value">
                                        <template #append>ms</template>
                                    </el-input>
                                </td>
                            </tr>
                    ...
                    <table class="table-strip-input-data" style="width: 100% !important;">
                        ...
                        <tbody>
                            <tr v-for="(item, index) in miscellaneous" :key="index">
                                <td>{{item.label}}</td>
                                <td>
                                    <el-input v-if="index === 1" size="small" v-model="assessLimitsData.miscellaneous.abs[item.value].min.value">
                                    </el-input>
                                    <el-input v-else size="small" v-model="assessLimitsData.miscellaneous.abs[item.value].min.value">
                                        <template #append>ms</template>
                                    </el-input>
                                </td>
                                <td>
                                    <el-input v-if="index === 1" size="small" v-model="assessLimitsData.miscellaneous.abs[item.value].max.value">
                                    </el-input>
                                    <el-input v-else size="small" v-model="assessLimitsData.miscellaneous.abs[item.value].max.value">
                                        <template #append>ms</template>
                                    </el-input>
                                </td>
                            </tr>
                    ...
                    <table class="table-strip-input-data" style="width: 100% !important;">
                        ...
                        <tbody>
                            <tr v-for="(item, index) in miscellaneous" :key="index">
                                <td>{{item.label}}</td>
                                <td>
                                    <el-input v-if="index === 1" size="small" v-model="assessLimitsData.miscellaneous.rel[item.value].ref.value">
                                    </el-input>
                                    <el-input v-else size="small" v-model="assessLimitsData.miscellaneous.rel[item.value].ref.value">
                                        <template v-if="item !== 1">ms</template>
                                    </el-input>
                                </td>
                                <td>
                                    <el-input v-if="index === 1" size="small" v-model="assessLimitsData.miscellaneous.rel[item.value].dev.value">
                                    </el-input>
                                    <el-input v-else size="small" v-model="assessLimitsData.miscellaneous.rel[item.value].dev.value">
                                        <template v-if="item !== 1">ms</template>
                                    </el-input>
                                </td>
                            </tr>
                    ...
                    <table class="table-strip-input-data" style="width: 100% !important;">
                        ...
                        <tbody>
                            <tr v-for="(item, index) in coilCharacteristics" :key="index">
                                <td>{{item.label}}</td>
                                <td>
                                    <el-input size="small" v-model="assessLimitsData.coil_characteristics.abs[item.value].min.value">
                                ...
                                <td>
                                    <el-input size="small" v-model="assessLimitsData.coil_characteristics.abs[item.value].max.value">
                                        <template v-if="index <= 3" slot="append">A</template>
                                        <template v-else-if="3 < index && index <= 5" slot="append">V</template>
                                        <template v-else slot="append">&#8486;</template>
                                    </el-input>
                    ...
                    <table class="table-strip-input-data" style="width: 100% !important;">
                        ...
                        <tbody>
                            <tr v-for="(item, index) in coilCharacteristics" :key="index">
                                <td>{{item.label}}</td>
                                <td>
                                    <el-input size="small" v-model="assessLimitsData.coil_characteristics.rel[item.value].ref.value">
                                        <template v-if="index <= 3" slot="append">A</template>
                                        <template v-else-if="3 < index && index <= 5" slot="append">V</template>
                                        <template v-else slot="append">&#8486;</template>
                                    </el-input>
                                ...
                                <td>
                                    <el-input size="small" v-model="assessLimitsData.coil_characteristics.rel[item.value].minus_dev.value">
                                        <template v-if="index <= 3" slot="append">A</template>
                                        <template v-else-if="3 < index && index <= 5" slot="append">V</template>
                                        <template v-else slot="append">&#8486;</template>
                                    </el-input>
                                ...
                                <td>
                                    <el-input size="small" v-model="assessLimitsData.coil_characteristics.rel[item.value].plus_dev.value">
                                        <template v-if="index <= 3" slot="append">A</template>
                                        <template v-else-if="3 < index && index <= 5" slot="append">V</template>
                                        <template v-else slot="append">&#8486;</template>
                                    </el-input>
                    ...
                    <table class="table-strip-input-data" style="width: 100% !important;">
                        ...
                        <tbody>
                            <tr v-for="(item, index) in pickupVoltage" :key="index">
                                <td>{{item.label}}</td>
                                <td>
                                    <el-input size="small" v-model="assessLimitsData.pickup_voltage.abs[item.value].v_min.value">
                                        <template #append>V</template>
                                    </el-input>
                                </td>
                                <td>
                                    <el-input size="small" v-model="assessLimitsData.pickup_voltage.abs[item.value].v_max.value">
                                        <template #append>V</template>
                                    </el-input>
                                </td>
                            </tr>
                    ...
                    <table class="table-strip-input-data" style="width: 100% !important;">
                        ...
                        <tbody>
                            <tr v-for="(item, index) in pickupVoltage" :key="index">
                                <td>{{item.label}}</td>
                                <td>
                                <el-input size="small" v-model="assessLimitsData.pickup_voltage.rel[item.value].v_ref.value">
                                    <template #append>V</template>
                                </el-input>
                                </td>
                                <td>
                                    <el-input size="small" v-model="assessLimitsData.pickup_voltage.rel[item.value].v_dev.value">
                                        <template #append>V</template>
                                    </el-input>
                                </td>
                            </tr>
                    ...
                    <table class="table-strip-input-data" style="width: 100% !important;">
                        ...
                        <tbody>
                            <tr v-for="(item, index) in motorCharacteristics" :key="index">
                                <td>{{item.label}}</td>
                                <td>
                                    <el-input size="small" v-model="assessLimitsData.motor_characteristics.abs[item.value].min.value">
                                ...
                                <td>
                                    <el-input size="small" v-model="assessLimitsData.motor_characteristics.abs[item.value].max.value">
                                        <template v-if="index === 1" slot="append">s</template>
                                        <template v-else-if="index === 3" slot="append">V</template>
                                        <template v-else slot="append">A</template>
                                    </el-input>
                    ...
                    <table class="table-strip-input-data" style="width: 100% !important;">
                        ...
                        <tbody>
                            <tr v-for="(item, index) in motorCharacteristics" :key="index">
                                <td>{{item.label}}</td>
                                <td>
                                    <el-input size="small" v-model="assessLimitsData.motor_characteristics.rel[item.value].ref.value">
                                        <template v-if="index === 1" slot="append">s</template>
                                        <template v-else-if="index === 3" slot="append">V</template>
                                        <template v-else slot="append">A</template>
                                    </el-input>
                                ...
                                <td>
                                    <el-input size="small" v-model="assessLimitsData.motor_characteristics.rel[item.value].dev.value">
                                        <template v-if="index === 1" slot="append">s</template>
                                        <template v-else-if="index === 3" slot="append">V</template>
                                        <template v-else slot="append">A</template>
                                    </el-input>
                    ...
                    <table class="table-strip-input-data" style="width: 100% !important;">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <el-input size="small" v-model="assessLimitsData.under_voltage_release.abs.uv_coil_trip_voltage.min.value">
                                        <template #append>V</template>
                                    </el-input>
                                </td>
                                <td>
                                    <el-input size="small" v-model="assessLimitsData.under_voltage_release.abs.uv_coil_trip_voltage.max.value">
                                        <template #append>V</template>
                                    </el-input>
                                </td>
                            </tr>
                    ...
                    <table class="table-strip-input-data" style="width: 100% !important;">
                        ...
                        <tbody>
                            <tr>
                                <td>UV Coil Trip Voltage</td>
                                <td>
                                    <el-input size="small" v-model="assessLimitsData.under_voltage_release.rel.uv_coil_trip_voltage.ref.value">
                                        <template #append>V</template>
                                    </el-input>
                                </td>
                                <td>
                                    <el-input size="small" v-model="assessLimitsData.under_voltage_release.rel.uv_coil_trip_voltage.dev.value">
                                        <template #append>V</template>
                                    </el-input>
                                </td>
                            </tr>
                    ...
                    <table class="table-strip-input-data" style="width: 100% !important;">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <el-input size="small" v-model="assessLimitsData.overcurrent_release.abs.oc_replay_trip_current.min.value">
                                        <template #append>A</template>
                                    </el-input>
                                </td>
                                <td>
                                    <el-input size="small" v-model="assessLimitsData.overcurrent_release.abs.oc_replay_trip_current.max.value">
                                        <template #append>A</template>
                                    </el-input>
                                </td>
                            </tr>
                    ...
                    <table class="table-strip-input-data" style="width: 100% !important;">
                        ...
                        <tbody>
                            <tr>
                                <td>OC Relay Trip Current</td>
                                <td>
                                    <el-input size="small" v-model="assessLimitsData.overcurrent_release.rel.oc_replay_trip_current.ref.value">
                                        <template #append>A</template>
                                    </el-input>
                                </td>
                                <td>
                                    <el-input size="small" v-model="assessLimitsData.overcurrent_release.rel.oc_replay_trip_current.dev.value" >
                                        <template #append>A</template>
                                    </el-input>
                                </td>
                            </tr>
...
:deep(.inline-radios .el-radio-group) {
    display: flex;
    width: 100%;
    align-items: center;
    min-height: 28px;
...
:deep(.inline-radios .el-radio__label) {
    font-size: 12px;
}

:deep(.inline-radios .el-radio__content) {
    display: flex;
    align-items: center;
    line-height: normal;
}

:deep(.inline-radios .el-radio) {
    flex: 1;
    margin-right: 0;
    display: inline-flex;
    align-items: center;
