<template>
  <div id="assessmentLimits" class="mgt-20">
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <el-input
                    size="small"
                    v-model="assessLimitsData.contact_resistance.abs.r_min.value"
                  >
                ...
                <td>
                  <el-input
                    size="small"
                    v-model="assessLimitsData.contact_resistance.abs.r_max.value"
                  >
                    <template #append>&#181;&#8486;</template>
                  </el-input>
                </td>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <el-input
                    size="small"
                    v-model="assessLimitsData.contact_resistance.rel.r_ref.value"
                  >
                    <template #append>&#181;&#8486;</template>
                  </el-input>
                </td>
                <td>
                  <el-input
                    size="small"
                    v-model="assessLimitsData.contact_resistance.rel.r_dev.value"
                  >
                    <template #append>&#181;&#8486;</template>
                  </el-input>
                </td>
    ...
    <el-row>
      <el-col :span="24">
        <div
          class="header-toggle pointer font_size_12"
          @click="openOperatingTime = !openOperatingTime"
        >
      ...
      <el-row :gutter="20" class="content">
        <transition>
          <div>
            ...
            <el-col v-else :span="24" class="col-content">
              <div class="operating-time-scroll">
                    ...
                    <tr v-for="(item, index) in opening_times" :key="index">
                      ...
                      <td>
                        <el-input
                          size="small"
                          v-model="
                            assessLimitsData.operating_time.rel[item.value].minus_t_dev.value
                          "
                        >
                          <template #append>ms</template>
                        </el-input>
    ...
    <el-row>
      <el-col :span="24">
        <div
          class="header-toggle pointer font_size_12"
          @click="openContactTravel = !openContactTravel"
        >
                ...
                <tbody>
                  <tr v-for="(item, index) in contact_travel" :key="index">
                    ...
                    <td>
                      <el-input
                        size="small"
                        v-model="assessLimitsData.contact_travel.abs[item.value].d_min.value"
                      >
                    ...
                    <td>
                      <el-input
                        size="small"
                        v-model="assessLimitsData.contact_travel.abs[item.value].d_max.value"
                      >
                        <template #append>mm</template>
                      </el-input>
                    </td>
                ...
                <tbody>
                  <tr v-for="(item, index) in contact_travel" :key="index">
                    ...
                    <td>
                      <el-input
                        size="small"
                        v-model="assessLimitsData.contact_travel.rel[item.value].d_ref.value"
                      >
                        <template #append>mm</template>
                      </el-input>
                    </td>
                    <td>
                      <el-input
                        size="small"
                        v-model="assessLimitsData.contact_travel.rel[item.value].d_dev.value"
                      >
                        <template #append>mm</template>
                      </el-input>
                    </td>
                  ...
                  <tr v-for="(item, index) in Auxiliary_contact" :key="index">
                    ...
                    <td>
                      <el-input
                        size="small"
                        v-model="
                          assessLimitsData.auxiliary_contacts.trip_operation.abs[item.value].t_min
                            .value
                        "
                      >
                        <template #append>ms</template>
                    ...
                    <td>
                      <el-input
                        size="small"
                        v-model="
                          assessLimitsData.auxiliary_contacts.trip_operation.abs[item.value].t_max
                            .value
                        "
                      >
                        <template #append>ms</template>
                  ...
                  <tr v-for="(item, index) in Auxiliary_contact" :key="index">
                    ...
                    <td>
                      <el-input
                        size="small"
                        v-model="
                          assessLimitsData.auxiliary_contacts.trip_operation.rel[item.value].t_ref
                            .value
                        "
                      >
                        <template #append>ms</template>
                    ...
                    <td>
                      <el-input
                        size="small"
                        v-model="
                          assessLimitsData.auxiliary_contacts.trip_operation.rel[item.value].t_dev
                            .value
                        "
                      >
                        <template #append>ms</template>
                  ...
                  <tr v-for="(item, index) in Auxiliary_contact" :key="index">
                    ...
                    <td>
                      <el-input
                        size="small"
                        v-model="
                          assessLimitsData.auxiliary_contacts.close_operation.abs[item.value].t_min
                            .value
                        "
                      >
                        <template #append>ms</template>
                    ...
                    <td>
                      <el-input
                        size="small"
                        v-model="
                          assessLimitsData.auxiliary_contacts.close_operation.abs[item.value].t_max
                            .value
                        "
                      >
                        <template #append>ms</template>
                  ...
                  <tr v-for="(item, index) in Auxiliary_contact" :key="index">
                    ...
                    <td>
                      <el-input
                        size="small"
                        v-model="
                          assessLimitsData.auxiliary_contacts.close_operation.rel[item.value].t_ref
                            .value
                        "
                      >
                        <template #append>ms</template>
                    ...
                    <td>
                      <el-input
                        size="small"
                        v-model="
                          assessLimitsData.auxiliary_contacts.close_operation.rel[item.value].t_dev
                            .value
                        "
                      >
                        <template #append>ms</template>
                  ...
                  <tr v-for="(item, index) in miscellaneous" :key="index">
                    ...
                    <td>
                      <el-input
                        v-if="index === 1"
                        size="small"
                        v-model="assessLimitsData.miscellaneous.abs[item.value].min.value"
                      >
                      </el-input>
                      <el-input
                        v-else
                    ...
                    <td>
                      <el-input
                        v-if="index === 1"
                        size="small"
                        v-model="assessLimitsData.miscellaneous.abs[item.value].max.value"
                      >
                      </el-input>
                      <el-input
                        v-else
                  ...
                  <tr v-for="(item, index) in miscellaneous" :key="index">
                    ...
                    <td>
                      <el-input
                        v-if="index === 1"
                        size="small"
                        v-model="assessLimitsData.miscellaneous.rel[item.value].ref.value"
                      >
                      </el-input>
                      <el-input
                        v-else
                    ...
                    <td>
                      <el-input
                        v-if="index === 1"
                        size="small"
                        v-model="assessLimitsData.miscellaneous.rel[item.value].dev.value"
                      >
                      </el-input>
                      <el-input
                        v-else
                ...
                <tbody>
                  <tr v-for="(item, index) in coilCharacteristics" :key="index">
                    ...
                    <td>
                      <el-input
                        size="small"
                        v-model="assessLimitsData.coil_characteristics.abs[item.value].min.value"
                      >
                    ...
                    <td>
                      <el-input
                        size="small"
                        v-model="assessLimitsData.coil_characteristics.abs[item.value].max.value"
                      >
                        <template v-if="index <= 3" #append>A</template>
                        <template v-else-if="3 < index && index <= 5" #append>V</template>
                        <template v-else #append>&#8486;</template>
                ...
                <tbody>
                  <tr v-for="(item, index) in coilCharacteristics" :key="index">
                    ...
                    <td>
                      <el-input
                        size="small"
                        v-model="assessLimitsData.coil_characteristics.rel[item.value].ref.value"
                      >
                        <template v-if="index <= 3" #append>A</template>
                        <template v-else-if="3 < index && index <= 5" #append>V</template>
                        <template v-else #append>&#8486;</template>
                    ...
                    <td>
                      <el-input
                        size="small"
                        v-model="
                          assessLimitsData.coil_characteristics.rel[item.value].minus_dev.value
                        "
                      >
                        <template v-if="index <= 3" #append>A</template>
                        <template v-else-if="3 < index && index <= 5" #append>V</template>
                    ...
                    <td>
                      <el-input
                        size="small"
                        v-model="
                          assessLimitsData.coil_characteristics.rel[item.value].plus_dev.value
                        "
                      >
                        <template v-if="index <= 3" #append>A</template>
                        <template v-else-if="3 < index && index <= 5" #append>V</template>
                ...
                <tbody>
                  <tr v-for="(item, index) in pickupVoltage" :key="index">
                    ...
                    <td>
                      <el-input
                        size="small"
                        v-model="assessLimitsData.pickup_voltage.abs[item.value].v_min.value"
                      >
                    ...
                    <td>
                      <el-input
                        size="small"
                        v-model="assessLimitsData.pickup_voltage.abs[item.value].v_max.value"
                      >
                        <template #append>V</template>
                      </el-input>
                    </td>
                ...
                <tbody>
                  <tr v-for="(item, index) in pickupVoltage" :key="index">
                    ...
                    <td>
                      <el-input
                        size="small"
                        v-model="assessLimitsData.pickup_voltage.rel[item.value].v_ref.value"
                      >
                        <template #append>V</template>
                      </el-input>
                    </td>
                    <td>
                      <el-input
                        size="small"
                        v-model="assessLimitsData.pickup_voltage.rel[item.value].v_dev.value"
                      >
                        <template #append>V</template>
                      </el-input>
                    </td>
                ...
                <tbody>
                  <tr v-for="(item, index) in motorCharacteristics" :key="index">
                    ...
                    <td>
                      <el-input
                        size="small"
                        v-model="assessLimitsData.motor_characteristics.abs[item.value].min.value"
                      >
                        <template v-if="index === 1" #append>s</template>
                        <template v-else-if="index === 3" #append>V</template>
                        <template v-else #append>A</template>
                      </el-input>
                    </td>
                    <td>
                      <el-input
                        size="small"
                        v-model="assessLimitsData.motor_characteristics.abs[item.value].max.value"
                      >
                        <template v-if="index === 1" #append>s</template>
                        <template v-else-if="index === 3" #append>V</template>
                        <template v-else #append>A</template>
                ...
                <tbody>
                  <tr v-for="(item, index) in motorCharacteristics" :key="index">
                    ...
                    <td>
                      <el-input
                        size="small"
                        v-model="assessLimitsData.motor_characteristics.rel[item.value].ref.value"
                      >
                        <template v-if="index === 1" #append>s</template>
                        <template v-else-if="index === 3" #append>V</template>
                        <template v-else #append>A</template>
                    ...
                    <td>
                      <el-input
                        size="small"
                        v-model="assessLimitsData.motor_characteristics.rel[item.value].dev.value"
                      >
                        <template v-if="index === 1" #append>s</template>
                        <template v-else-if="index === 3" #append>V</template>
                        <template v-else #append>A</template>
    ...
    <el-row>
      <el-col :span="24">
        <div
          class="header-toggle pointer font_size_12"
          @click="openUnderVoltageR = !openUnderVoltageR"
        >
              ...
              <tr>
                ...
                <td>
                  <el-input
                    size="small"
                    v-model="
                      assessLimitsData.under_voltage_release.abs.uv_coil_trip_voltage.min.value
                    "
                  >
                    <template #append>V</template>
                  </el-input>
                ...
                <td>
                  <el-input
                    size="small"
                    v-model="
                      assessLimitsData.under_voltage_release.abs.uv_coil_trip_voltage.max.value
                    "
                  >
                    <template #append>V</template>
                  </el-input>
              ...
              <tr>
                ...
                <td>
                  <el-input
                    size="small"
                    v-model="
                      assessLimitsData.under_voltage_release.rel.uv_coil_trip_voltage.ref.value
                    "
                  >
                    <template #append>V</template>
                  </el-input>
                ...
                <td>
                  <el-input
                    size="small"
                    v-model="
                      assessLimitsData.under_voltage_release.rel.uv_coil_trip_voltage.dev.value
                    "
                  >
                    <template #append>V</template>
                  </el-input>
    ...
    <el-row>
      <el-col :span="24">
        <div
          class="header-toggle pointer font_size_12"
          @click="openOvercurrentR = !openOvercurrentR"
        >
              ...
              <tr>
                ...
                <td>
                  <el-input
                    size="small"
                    v-model="
                      assessLimitsData.overcurrent_release.abs.oc_replay_trip_current.min.value
                    "
                  >
                ...
                <td>
                  <el-input
                    size="small"
                    v-model="
                      assessLimitsData.overcurrent_release.abs.oc_replay_trip_current.max.value
                    "
                  >
                    <template #append>A</template>
                  </el-input>
              ...
              <tr>
                ...
                <td>
                  <el-input
                    size="small"
                    v-model="
                      assessLimitsData.overcurrent_release.rel.oc_replay_trip_current.ref.value
                    "
                  >
                    <template #append>A</template>
                  </el-input>
                ...
                <td>
                  <el-input
                    size="small"
                    v-model="
                      assessLimitsData.overcurrent_release.rel.oc_replay_trip_current.dev.value
                    "
                  >
                    <template #append>A</template>
                  </el-input>
...
.operating-time-table :deep(.el-input) {
  width: 132px;
  max-width: 100%;
}

.operating-time-table :deep(.el-input-group__append) {
  min-width: 38px;
  padding: 0 8px;
}
