        ...
        <el-col :xs="24" :md="12" class="col-content">
          ...
          >
            ...
            <el-form-item label="Number of trip coils">
              <el-select
                @change="changeTripCoil(operatingData.number_of_trip_coil)"
            ...
            <el-form-item label="Number of close coils">
              <el-select
                @change="changeCloseCoil(operatingData.number_of_close_coil)"
                v-model="operatingData.number_of_close_coil"
              >
                <el-option v-for="item in 3" :key="item + 3" :label="item" :value="item">
                </el-option>
              </el-select>
            </el-form-item>
          </el-form>
