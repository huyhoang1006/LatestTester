                    ...
                    <el-form :inline-message="true" :label-width="labelWidth" size="small" label-position="left">
                        ...
                        <el-form-item label="Interrupting medium">
                            <el-select style="width: 100%;"
                                v-if="['MiniOil', 'DeadTankOCB'].includes(propertiesData.type)"
                                v-model="circuitBreakerData.interruptingMedium">
                                <el-option label="Oil" value="Oil"></el-option>
                            </el-select>
                            <el-select style="width: 100%;" v-else-if="propertiesData.type === 'AirBlast'"
                                v-model="circuitBreakerData.interruptingMedium">
                                <el-option label="Air" value="Air"></el-option>
                            </el-select>
                            <el-select style="width: 100%;" v-else-if="propertiesData.type === 'Vacuum'"
                                v-model="circuitBreakerData.interruptingMedium">
                                <el-option label="Vacuum" value="Vacuum"></el-option>
                            </el-select>
                            <el-select style="width: 100%;" v-else-if="propertiesData.type === 'GenCirGCB'"
                                v-model="circuitBreakerData.interruptingMedium">
                            ...
                            <el-select style="width: 100%;" v-else-if="propertiesData.type === 'GasInsuGIS'"
                                v-model="circuitBreakerData.interruptingMedium">
                                <el-option label="SF6" value="SF6"> </el-option>
                                <el-option label="SF6/N2" value="SF6/N2"> </el-option>
                                <el-option label="SF6/CF4" value="SF6/CF4"> </el-option>
                            ...
                            <el-select style="width: 100%;" v-else-if="propertiesData.type === 'Miscell'"
                                v-model="circuitBreakerData.interruptingMedium">
                                <el-option label="SF6" value="SF6"> </el-option>
                                <el-option label="SF6/N2" value="SF6/N2"> </el-option>
                                <el-option label="SF6/CF4" value="SF6/CF4"> </el-option>
                        ...
                        <el-form-item label="Tank type">
                            <el-select style="width: 100%;"
                                v-if="['GenCirGCB', 'GasInsuGIS'].includes(propertiesData.type)"
                                v-model="circuitBreakerData.tankType">
                                <el-option label="---" value="noValue"></el-option>
                            </el-select>
                            <el-select style="width: 100%;" v-else-if="['Miscell'].includes(propertiesData.type)"
                                v-model="circuitBreakerData.tankType">
                            ...
                            <el-select style="width: 100%;"
                                v-else-if="['DeadTankOCB', 'DeadTankSF6'].includes(propertiesData.type)"
                                v-model="circuitBreakerData.tankType">
                                <el-option label="Dead tank" value="deadTank"></el-option>
                            </el-select>
