      ...
      <el-row :gutter="20" class="content">
        <el-col :xs="24" :sm="18" :md="14" :lg="12" class="col-content">
          ...
          >
            ...
            <el-form-item
              v-if="propertiesData.type !== 'Vacuum'"
            ...
            <el-form-item v-if="propertiesData.type !== 'Vacuum'" label="PIR value">
              <el-input
                :disabled="!circuitBreakerData.hasPIR"
                type="text"
                number="positive"
            ...
            <el-form-item v-if="propertiesData.type !== 'Vacuum'" label="Capacitor value">
              <el-input
                :disabled="!circuitBreakerData.hasGradingCapacitors"
                type="text"
                number="positive"
            ...
            <el-form-item label="Interrupting medium">
              ...
              <el-select
                style="width: 100%"
                v-else-if="propertiesData.type === 'AirBlast'"
                v-model="circuitBreakerData.interruptingMedium"
              >
              ...
              <el-select
                style="width: 100%"
                v-else-if="propertiesData.type === 'Vacuum'"
                v-model="circuitBreakerData.interruptingMedium"
              >
              ...
              <el-select
                style="width: 100%"
                v-else-if="propertiesData.type === 'GenCirGCB'"
                v-model="circuitBreakerData.interruptingMedium"
              >
              ...
              <el-select
                style="width: 100%"
                v-else-if="propertiesData.type === 'GasInsuGIS'"
                v-model="circuitBreakerData.interruptingMedium"
              >
                <el-option label="SF6" value="SF6"> </el-option>
                <el-option label="SF6/N2" value="SF6/N2"> </el-option>
              ...
              <el-select
                style="width: 100%"
                v-else-if="propertiesData.type === 'Miscell'"
                v-model="circuitBreakerData.interruptingMedium"
              >
                <el-option label="SF6" value="SF6"> </el-option>
                <el-option label="SF6/N2" value="SF6/N2"> </el-option>
            ...
            <el-form-item label="Tank type">
              ...
              <el-select
                style="width: 100%"
                v-else-if="['Miscell'].includes(propertiesData.type)"
                v-model="circuitBreakerData.tankType"
              >
