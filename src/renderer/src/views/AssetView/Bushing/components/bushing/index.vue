      ...
      <el-form :inline-message="true" :label-width="labelWidth" size="small" label-position="left">
        ...
        <el-form-item label="Rated frequency">
          <el-input
            ...
            number="positive"
            style="width: 100%"
            v-model="bushingData.rated_frequency.value"
          >
        ...
        <el-form-item label="Insul. level LL (BIL)">
          <el-input
            ...
            number="positive"
            style="width: 100%"
            v-model="bushingData.insulation_level.value"
          >
        ...
        <el-form-item label="Max. system voltage">
          <el-input
            ...
            style="width: 100%"
            filterable
            v-model="bushingData.max_system_voltage.value"
          >
      ...
      <el-form :inline-message="true" :label-width="labelWidth" size="small" label-position="left">
        ...
        <el-form-item label="DF (C1)">
          <el-input
            ...
            number="positive"
            style="width: 100%"
            v-model="bushingData.df_c1.value"
          >
        ...
        <el-form-item label="Cap. (C1)">
          <el-input
            ...
            number="positive"
            style="width: 100%"
            v-model="bushingData.cap_c1.value"
          >
        ...
        <el-form-item label="Cap. (C2)">
          <el-input
            ...
            number="positive"
            style="width: 100%"
            v-model="bushingData.cap_c2.value"
          >
        ...
        <el-form-item label="Insul. type">
          <el-select v-model="bushingData.insulation_type" style="width: 100%">
            <el-option
              v-for="(item, index) in insulationKindList"
              :key="index"
              :label="item.label"
              :value="item.value"
            ></el-option>
