...
export default {
  ...
  methods: {
    ...
    async saveAsset() {
      try {
        if (
          this.transformerDto.properties.type &&
          this.transformerDto.properties.kind &&
          this.transformerDto.properties.serial_no
        ) {
    ...
    async loadSurgeArrester(surgeTemp, surgeArray) {
      ...
      for (const winding of windingData) {
        for (let i = 0; i < surgeArray[winding].length; i++) {
          ...
          const data = surgeTemp[winding].find((x) => x.ratings.pos === surgeData.ratings.pos)
    ...
    checkPsrId(data) {
      if (
        this.parentData.mrid !== null &&
        this.parentData.mrid !== '' &&
        this.parentData.mrid !== undefined
      ) {
    ...
    checkCurrentRating(data) {
      for (let item of data.ratings.current_ratings) {
        if (
          data.properties.type === this.$constant.WITHOUT_TERT ||
          data.properties.type === this.$constant.TWO_WINDING
        ) {
          if (item.mrid === null || item.mrid === '') {
            item.mrid = uuid.newUuid()
          }
    ...
    checkShortCircuitRatings(data) {
      if (data.ratings.short_circuit.mrid === null || data.ratings.short_circuit.mrid === '') {
        ...
        if (
          data.ratings.short_circuit.ka.mrid === null ||
          data.ratings.short_circuit.ka.mrid === ''
        ) {
          data.ratings.short_circuit.ka.mrid = uuid.newUuid()
        }
        if (
          data.ratings.short_circuit.s.mrid === null ||
          data.ratings.short_circuit.s.mrid === ''
        ) {
          ...
          if (item.hasOwnProperty(key)) {
            if (typeof item[key] === 'object' && item[key] !== null) {
              if (item[key].mrid === null || item[key].mrid === '') {
                ...
                if (
                  item[key].data &&
                  (item[key].data.mrid === null || item[key].data.mrid === '')
                ) {
                  item[key].data.mrid = uuid.newUuid()
                }
              }
    ...
    checkZeroImpedance(data) {
      if (
        data.impedances.zero_sequence_impedance.mrid === null ||
        data.impedances.zero_sequence_impedance.mrid === ''
      ) {
        data.impedances.zero_sequence_impedance.mrid = uuid.newUuid()
      }
      if (
        data.impedances.zero_sequence_impedance.base_power.mrid === null ||
        data.impedances.zero_sequence_impedance.base_power.mrid === ''
      ) {
        data.impedances.zero_sequence_impedance.base_power.mrid = uuid.newUuid()
      }
      if (
        data.impedances.zero_sequence_impedance.base_power.data.mrid === null ||
        data.impedances.zero_sequence_impedance.base_power.data.mrid === ''
      ) {
        data.impedances.zero_sequence_impedance.base_power.data.mrid = uuid.newUuid()
      }
      if (
        data.impedances.zero_sequence_impedance.base_voltage.mrid === null ||
        data.impedances.zero_sequence_impedance.base_voltage.mrid === ''
      ) {
        data.impedances.zero_sequence_impedance.base_voltage.mrid = uuid.newUuid()
      }
      if (
        data.impedances.zero_sequence_impedance.base_voltage.data.mrid === null ||
        data.impedances.zero_sequence_impedance.base_voltage.data.mrid === ''
      ) {
        data.impedances.zero_sequence_impedance.base_voltage.data.mrid = uuid.newUuid()
      }
      if (
        data.impedances.zero_sequence_impedance.zero_percent.prim.mrid === null ||
        data.impedances.zero_sequence_impedance.zero_percent.prim.mrid === ''
      ) {
        data.impedances.zero_sequence_impedance.zero_percent.prim.mrid = uuid.newUuid()
      }
      if (
        data.impedances.zero_sequence_impedance.zero_percent.prim.data.mrid === null ||
        data.impedances.zero_sequence_impedance.zero_percent.prim.data.mrid === ''
      ) {
        data.impedances.zero_sequence_impedance.zero_percent.prim.data.mrid = uuid.newUuid()
      }
      if (
        data.impedances.zero_sequence_impedance.zero_percent.sec.mrid === null ||
        data.impedances.zero_sequence_impedance.zero_percent.sec.mrid === ''
      ) {
        data.impedances.zero_sequence_impedance.zero_percent.sec.mrid = uuid.newUuid()
      }
      if (
        data.impedances.zero_sequence_impedance.zero_percent.sec.data.mrid === null ||
        data.impedances.zero_sequence_impedance.zero_percent.sec.data.mrid === ''
      ) {
        data.impedances.zero_sequence_impedance.zero_percent.sec.data.mrid = uuid.newUuid()
      }
      if (
        data.impedances.zero_sequence_impedance.zero_percent.zero.mrid === null ||
        data.impedances.zero_sequence_impedance.zero_percent.zero.mrid === ''
      ) {
        data.impedances.zero_sequence_impedance.zero_percent.zero.mrid = uuid.newUuid()
      }
      if (
        data.impedances.zero_sequence_impedance.zero_percent.zero.data.mrid === null ||
        data.impedances.zero_sequence_impedance.zero_percent.zero.data.mrid === ''
      ) {
    ...
    checkOther(data) {
      ...
      if (
        data.others.insulation.weight.mrid === null ||
        data.others.insulation.weight.mrid === ''
      ) {
        data.others.insulation.weight.mrid = uuid.newUuid()
      }
      if (
        data.others.insulation.volume.mrid === null ||
        data.others.insulation.volume.mrid === ''
      ) {
    ...
    checkTapChangerId(data) {
      if (data.tap_changers.mode != '') {
        ...
        if (
          data.tap_changers.productAssetModelId == null ||
          data.tap_changers.productAssetModelId === ''
        ) {
    ...
    checkSurgeArrester(data) {
      for (const surgeArrester of data.surge_arrester.prim) {
        ...
        if (
          surgeArrester.properties.assetInfoId === '' ||
          surgeArrester.properties.assetInfoId === null
        ) {
          surgeArrester.properties.assetInfoId = uuid.newUuid()
        }
        if (
          surgeArrester.properties.lifecycleDateId === '' ||
          surgeArrester.properties.lifecycleDateId === null
        ) {
          surgeArrester.properties.lifecycleDateId = uuid.newUuid()
        }
        if (
          surgeArrester.properties.productAssetModelId === '' ||
          surgeArrester.properties.productAssetModelId === null
        ) {
        ...
        if (this.transformerDto.winding_configuration.phases === '1') {
          ...
          if (this.transformerDto.bushing_data.prim.length === 0) {
            for (let i = 1; i <= 2; i++) {
              ...
              bushing.pos = this.bushingPosReturn(
                i,
                'prim',
                this.transformerDto.properties.type,
            ...
            for (let i = 1; i <= this.transformerDto.bushing_data.prim.length; i++) {
              this.transformerDto.bushing_data.prim[i - 1].pos = this.bushingPosReturn(
                i,
                'prim',
                this.transformerDto.properties.type,
                this.transformerDto.winding_configuration.phases
          ...
          if (this.transformerDto.bushing_data.sec.length === 0) {
            ...
            for (let i = 1; i <= this.transformerDto.bushing_data.sec.length; i++) {
              this.transformerDto.bushing_data.sec[i - 1].pos = this.bushingPosReturn(
                i,
                'sec',
                this.transformerDto.properties.type,
                this.transformerDto.winding_configuration.phases
          ...
          if (this.transformerDto.bushing_data.prim.length === 0) {
            if (
              this.transformerDto.winding_configuration.vector_group.prim === WindingConnection.Yn
            ) {
              for (let i = 1; i <= 4; i++) {
                const bushing = Object.assign({}, bushingTemplate)
                bushing.pos = this.bushingPosReturn(
            ...
            if (
              this.transformerDto.winding_configuration.vector_group.prim ===
          ...
          if (this.transformerDto.bushing_data.sec.length === 0) {
            if (
              this.transformerDto.winding_configuration.vector_group.sec.i === WindingConnection.Yn
            ) {
              for (let i = 1; i <= 4; i++) {
                const bushing = Object.assign({}, bushingTemplate)
                bushing.pos = this.bushingPosReturn(
            ...
            if (
              this.transformerDto.winding_configuration.vector_group.sec.i ===
                WindingConnection.Yn ||
              this.transformerDto.winding_configuration.vector_group.sec.i === ''
            ) {
        ...
        if (this.transformerDto.winding_configuration.phases === '1') {
          ...
          if (this.transformerDto.bushing_data.tert.length === 0) {
            ...
            for (let i = 1; i <= this.transformerDto.bushing_data.tert.length; i++) {
              this.transformerDto.bushing_data.tert[i - 1].pos = this.bushingPosReturn(
                i,
                'tert',
                this.transformerDto.properties.type,
                this.transformerDto.winding_configuration.phases
          ...
          if (this.transformerDto.bushing_data.sec.length === 0) {
            if (
              this.transformerDto.winding_configuration.vector_group.sec.i ===
                WindingConnection.Yn ||
              this.transformerDto.winding_configuration.vector_group.sec.i === '' ||
              this.transformerDto.winding_configuration.vector_group.sec.i === WindingConnection.Zn
            ) {
              for (let i = 1; i <= 4; i++) {
                const bushing = Object.assign({}, bushingTemplate)
                bushing.pos = this.bushingPosReturn(
          ...
          if (this.transformerDto.bushing_data.tert.length === 0) {
            if (
              this.transformerDto.winding_configuration.vector_group.tert.i ===
                WindingConnection.Yn ||
              this.transformerDto.winding_configuration.vector_group.tert.i === '' ||
              this.transformerDto.winding_configuration.vector_group.tert.i === WindingConnection.Zn
            ) {
              for (let i = 1; i <= 4; i++) {
                const bushing = Object.assign({}, bushingTemplate)
                bushing.pos = this.bushingPosReturn(
      ...
      if (type == this.$constant.TWO_WINDING) {
        if (phases === '1') {
          if (end_label === 'prim') {
            if (i == 1) {
              if (
                vectorGroup.prim === WindingConnection.I + PhaseCode.A ||
                vectorGroup.prim === WindingConnection.I + PhaseCode.AB
              ) {
                return PhaseCode.A
              } else if (
                vectorGroup.prim === WindingConnection.I + PhaseCode.B ||
                vectorGroup.prim === WindingConnection.I + PhaseCode.BC
              ) {
                return PhaseCode.B
              } else if (
                vectorGroup.prim === WindingConnection.I + PhaseCode.C ||
                vectorGroup.prim === WindingConnection.I + PhaseCode.CA
              ) {
                return PhaseCode.C
              } else {
                return 1
            ...
            if (i == 1) {
              if (
                vectorGroup.prim === WindingConnection.I + PhaseCode.A ||
                vectorGroup.sec === WindingConnection.I + PhaseCode.AB
              ) {
                return PhaseCode.a1
              } else if (
                vectorGroup.prim === WindingConnection.I + PhaseCode.B ||
                vectorGroup.sec === WindingConnection.I + PhaseCode.BC
              ) {
                return PhaseCode.b1
              } else if (
                vectorGroup.prim === WindingConnection.I + PhaseCode.C ||
                vectorGroup.sec === WindingConnection.I + PhaseCode.CA
              ) {
                return PhaseCode.c1
        ...
        if (phases === '1') {
          if (end_label === 'prim') {
            ...
            if (i === 1) {
              if (
                vectorGroup.prim === WindingConnection.I + PhaseCode.A ||
                vectorGroup.tert === WindingConnection.I + PhaseCode.AB
              ) {
                return PhaseCode.a2
              } else if (
                vectorGroup.prim === WindingConnection.I + PhaseCode.B ||
                vectorGroup.tert === WindingConnection.I + PhaseCode.BC
              ) {
                return PhaseCode.b2
              } else if (
                vectorGroup.prim === WindingConnection.I + PhaseCode.C ||
                vectorGroup.tert === WindingConnection.I + PhaseCode.CA
              ) {
                return PhaseCode.c2
              } else {
                return 9
    ...
    changeSurgeArresterData() {
      ...
      if (this.transformerDto.surge_arrester.prim.length === 0) {
        ...
        if (
          this.transformerDto.surge_arrester.prim.length <
          this.transformerDto.bushing_data.prim.length
        ) {
          for (
            let i = this.transformerDto.surge_arrester.prim.length;
            i < this.transformerDto.bushing_data.prim.length;
            i++
          ) {
            const surgeArresterPrim = JSON.parse(JSON.stringify(surgeArresterTemplate))
            surgeArresterPrim.ratings.pos = this.transformerDto.bushing_data.prim[i].pos
          ...
          for (
            let i = this.transformerDto.bushing_data.prim.length;
            i < this.transformerDto.surge_arrester.prim.length;
            i++
          ) {
        ...
        for (let i = 0; i < this.transformerDto.surge_arrester.prim.length; i++) {
          this.transformerDto.surge_arrester.prim[i].ratings.pos =
            this.transformerDto.bushing_data.prim[i].pos
        }
      }
      //secondary
      ...
      if (this.transformerDto.surge_arrester.sec.length === 0) {
        ...
        if (
          this.transformerDto.surge_arrester.sec.length <
          this.transformerDto.bushing_data.sec.length
        ) {
          for (
            let i = this.transformerDto.surge_arrester.sec.length;
            i < this.transformerDto.bushing_data.sec.length;
            i++
          ) {
          ...
          for (
            let i = this.transformerDto.bushing_data.sec.length;
            i < this.transformerDto.surge_arrester.sec.length;
            i++
          ) {
        ...
        for (let i = 0; i < this.transformerDto.surge_arrester.sec.length; i++) {
          this.transformerDto.surge_arrester.sec[i].ratings.pos =
            this.transformerDto.bushing_data.sec[i].pos
        }
      }
      //tertiary
      if (this.transformerDto.surge_arrester.tert.length === 0) {
        ...
        if (
          this.transformerDto.surge_arrester.tert.length <
          this.transformerDto.bushing_data.tert.length
        ) {
          for (
            let i = this.transformerDto.surge_arrester.tert.length;
            i < this.transformerDto.bushing_data.tert.length;
            i++
          ) {
            const surgeArresterTert = JSON.parse(JSON.stringify(surgeArresterTemplate))
            surgeArresterTert.ratings.pos = this.transformerDto.bushing_data.tert[i].pos
          ...
          for (
            let i = this.transformerDto.bushing_data.tert.length;
            i < this.transformerDto.surge_arrester.tert.length;
            i++
          ) {
        ...
        for (let i = 0; i < this.transformerDto.surge_arrester.tert.length; i++) {
          this.transformerDto.surge_arrester.tert[i].ratings.pos =
            this.transformerDto.bushing_data.tert[i].pos
        }
      }
    },
    ...
    removeShortCircuitTest(mrid) {
      for (let index in this.transformerDto.shortCircuitTestTransformerEndInfo) {
        if (
          this.transformerDto.shortCircuitTestTransformerEndInfo[index].short_circuit_test_id ===
          mrid
        ) {
    ...
    removeShortCircuitTestArr(mrids) {
      this.transformerDto.shortCircuitTestTransformerEndInfo =
        this.transformerDto.shortCircuitTestTransformerEndInfo.filter(
          (item) => !mrids.includes(item.short_circuit_test_id)
        )
    },
