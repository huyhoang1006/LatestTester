<template>
  <div id="impedances" class="mgy-5">
    ...
    <div class="content-toggle" v-if="openImpedances">
          ...
          >
            <el-form-item label="Ref. temp">
              <el-input type="text" number="positive" v-model="impedancesData.ref_temp.value">
                <template #append>{{ unitSymbol.degC }}</template>
              </el-input>
            </el-form-item>
          </el-form>
        </el-col>
        ...
        <el-col :span="24" class="col-content">
          <el-row :gutter="8">
            <el-col :xs="24" :md="12">
              <el-row :gutter="8">
                <el-col :span="12">
                  <el-button size="small" type="primary" class="btn-fluid" @click="addPrimSec">
                    <i class="fas fa-plus"></i>
                    Add
                  </el-button>
                </el-col>
                <el-col :span="12">
                  <el-button size="small" class="btn-fluid" @click="removeAllPrimSec">
            ...
            <table class="table-strip-input-data fixed-table">
              ...
              <thead>
                <tr>
                  ...
                  <th>DETC position</th>
                  <th class="action-col">
                    <el-button size="small" type="danger" class="w-100" @click="removeAllPrimSec">
              ...
              <tbody>
                <tr v-for="(item, index) in impedancesData.prim_sec" :key="index">
                  <td>
                    ...
                    >
                      <template #append>{{ unitSymbol.percent }}</template>
                    </el-input>
                  </td>
                  <td>
                    <el-input
                    ...
                    >
                      <template #append>
                        <el-select
                          ...
                          v-model="item.base_power.data.unit"
                        >
                          <el-option
                            :label="unitMultiplier.M + unitSymbol.VA"
                            :value="unitMultiplier.M + '|' + unitSymbol.VA"
                          ></el-option>
                          <el-option
                            :label="unitMultiplier.k + unitSymbol.VA"
                            :value="unitMultiplier.k + '|' + unitSymbol.VA"
                          ></el-option>
                        </el-select>
                      </template>
                    </el-input>
                    ...
                    >
                      <template #append>
                        <el-select
                          size="small"
                          class="select-in-input"
                          v-model="item.base_voltage.data.unit"
                        >
                          <el-option
                            :label="unitMultiplier.k + unitSymbol.V"
                            :value="unitMultiplier.k + '|' + unitSymbol.V"
                          ></el-option>
                  ...
                  <td>
                    ...
                    >
                      <template #append>{{ unitSymbol.W }}</template>
                    </el-input>
                  </td>
                  <td>
                    <el-select
                      size="small"
                      v-model="item.oltc_position"
                    ...
                    <el-select size="small" v-model="item.oltc_position" v-else> </el-select>
                  </td>
                  <td>
                    <el-select
                      size="small"
                      v-model="item.detc_position"
                    ...
                    <el-select size="small" v-model="item.detc_position" v-else> </el-select>
                  </td>
                  <td>
                    <el-button
                      size="small"
      ...
      <el-row
        :gutter="20"
        class="content mgt-10"
        v-if="
          properties.type === $constant.THREE_WINDING || properties.type === $constant.WITH_TERT
        "
      >
        <el-col :span="24" class="col-content">
        ...
        <el-col :span="24" class="col-content">
          <el-row :gutter="8">
            <el-col :xs="24" :md="12">
              <el-row :gutter="8">
                <el-col :span="12">
                  <el-button size="small" type="primary" class="btn-fluid" @click="addPrimTert">
                    <i class="fas fa-plus"></i>
                    Add
                  </el-button>
                </el-col>
                <el-col :span="12">
                  <el-button size="small" class="btn-fluid" @click="removeAllPrimTert">
                    <i class="fas fa-xmark"></i>
                    Remove all
                  </el-button>
                </el-col>
            ...
            <table class="table-strip-input-data fixed-table">
              ...
              <thead>
                <tr>
                  ...
                  <th>DETC position</th>
                  <th class="action-col">
                    <el-button size="small" type="danger" class="w-100" @click="removeAllPrimTert">
                      <i class="fas fa-trash"></i>
                    </el-button>
                  </th>
                </tr>
        ...
        <el-col :span="24" class="col-content">
          <el-row :gutter="8">
            <el-col :xs="24" :md="12">
              <el-row :gutter="8">
                <el-col :span="12">
                  <el-button size="small" type="primary" class="btn-fluid" @click="addSecTert">
                    <i class="fas fa-plus"></i>
                    Add
                  </el-button>
                </el-col>
                <el-col :span="12">
                  <el-button size="small" class="btn-fluid" @click="removeAllSecTert">
                    <i class="fas fa-xmark"></i>
                    Remove all
                  </el-button>
                </el-col>
            ...
            <table class="table-strip-input-data fixed-table">
              ...
              <thead>
                <tr>
                  ...
                  <th>DETC position</th>
                  <th class="action-col">
                    <el-button size="small" type="danger" class="w-100" @click="removeAllSecTert">
                      <i class="fas fa-trash"></i>
                    </el-button>
                  </th>
                </tr>
          ...
          >
              ...
              >
                <template #append>
                  <el-select
                    size="small"
                    class="select-in-input"
                    v-model="impedancesData.zero_sequence_impedance.base_power.data.unit"
                  >
                    <el-option
                      :label="unitMultiplier.M + unitSymbol.VA"
                      :value="unitMultiplier.M + '|' + unitSymbol.VA"
            ...
            <el-form-item label="Zero sequence Z0(%)">
              <el-input
                ...
                v-if="
                  properties.type === $constant.TWO_WINDING ||
                  properties.type === $constant.THREE_WINDING
                "
                class="ref-temp-input"
              >
                <template #append>{{ unitSymbol.percent }}</template>
              ...
              <table
                class="table-strip-input-data"
                style="width: 300px"
                v-if="
                  properties.type === $constant.WITH_TERT ||
                  properties.type === $constant.WITHOUT_TERT
                "
              >
                <tbody>
                  <tr>
                    ...
                    <td>
                      <el-input
                        ...
                        number="positive"
                        v-model="
                          impedancesData.zero_sequence_impedance.zero_percent.prim.data.value
                        "
                      >
                        <template #append>{{ unitSymbol.percent }}</template>
                      </el-input>
...
export default {
  ...
  methods: {
    ...
    removeAllPrimSec() {
      this.$emit(
        'removeArr',
        JSON.parse(JSON.stringify(this.impedancesData.prim_sec.map((item) => item.mrid)))
      )
    ...
    removeAllPrimTert() {
      this.$emit(
        'removeArr',
        JSON.parse(JSON.stringify(this.impedancesData.prim_tert.map((item) => item.mrid)))
      )
    ...
    removeAllSecTert() {
      this.$emit(
        'removeArr',
        JSON.parse(JSON.stringify(this.impedancesData.sec_tert.map((item) => item.mrid)))
      )
...
:deep(.ref-temp-form .el-form-item) {
  margin-bottom: 0;
}
