                    ...
                    <el-row :gutter="8">
                        <el-col :xs="24" :md="12">
                            <el-row :gutter="8">
                                ...
                                <el-col :span="12">
                                    <el-button size="small" type="primary" class="btn-fluid" @click="removeAllPrimSec">
                        ...
                        <table class="table-strip-input-data fixed-table">
                            ...
                            <tbody>
                                <tr v-for="(item, index) in impedancesData.prim_sec" :key="index">
                                    ...
                                    <td>
                                        <el-select size="small" v-model="item.oltc_position"
                                        ...
                                        <el-select size="small" v-model="item.oltc_position" v-else>
                                        </el-select>
                                    </td>
                                    <td>
                                        <el-select size="small" v-model="item.detc_position"
                                            v-if="tapChangers.mode === 'detc'">
                                            <el-option v-for="(_item, _index) in tapChangers.voltage_table"
                                                :key="_index" :label="_item.tap" :value="_item.mrid"></el-option>
                                        </el-select>
                                        <el-select size="small" v-model="item.detc_position" v-else>
                                        </el-select>
                                    </td>
                                    <td>
                ...
                <el-col :span="24" class="col-content">
                    <el-row :gutter="8">
                        <el-col :xs="24" :md="12">
                            <el-row :gutter="8">
                                <el-col :span="12">
                                    <el-button size="small" type="primary" class="btn-fluid" @click="addPrimTert"> <i
                                            class="fas fa-plus"></i>
                                        Add
                                    </el-button>
                                </el-col>
                                <el-col :span="12">
                                    <el-button size="small" type="primary" class="btn-fluid" @click="removeAllPrimTert">
                                        <i class="fas fa-xmark"></i>
                                        Remove all
                                    </el-button>
                                </el-col>
                ...
                <el-col :span="24" class="col-content">
                    <el-row :gutter="8">
                        <el-col :xs="24" :md="12">
                            <el-row :gutter="8">
                                <el-col :span="12">
                                    <el-button size="small" type="primary" class="btn-fluid" @click="addSecTert"> <i
                                            class="fas fa-plus"></i>
                                        Add
                                    </el-button>
                                </el-col>
                                <el-col :span="12">
                                    <el-button size="small" type="primary" class="btn-fluid" @click="removeAllSecTert">
                                        <i class="fas fa-xmark"></i>
                                        Remove all
                                    </el-button>
                                </el-col>
