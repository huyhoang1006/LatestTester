                        ...
                        <el-form-item label="Insulation" class="insulation-item">
                            <el-radio-group v-model="othersData.insulation.key" class="insulation-group">
                                <div class="insulation-row">
                                    ...
                                    <el-input type="text" number="positive" v-model="othersData.insulation.weight.value" size="small"
                                ...
                                <div class="insulation-row">
                                    ...
                                    <el-input type="text" number="positive" v-model="othersData.insulation.volume.value" size="small"
