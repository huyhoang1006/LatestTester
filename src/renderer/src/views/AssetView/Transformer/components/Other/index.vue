    ...
    <div class="content-toggle" v-if="openOthers">
      <el-row :gutter="20" class="content">
        <el-col :xs="24" :md="16" :lg="12" class="col-content">
          <el-form :model="othersData" :label-width="labelWidth" size="small" label-position="left">
              ...
              <el-radio-group v-model="othersData.insulation.key" class="insulation-group">
                <div class="insulation-row">
                  ...
                  <el-input
                    type="text"
                    number="positive"
                    v-model="othersData.insulation.weight.value"
                    size="small"
                    class="insulation-input"
                    :disabled="othersData.insulation.key !== 'Weight'"
                  >
                    <template #append>{{ othersData.insulation.weight.unit }}</template>
                  </el-input>
                </div>
                <div class="insulation-row">
                  ...
                  <el-input
                    type="text"
                    number="positive"
                    v-model="othersData.insulation.volume.value"
                    size="small"
                    class="insulation-input"
                    :disabled="othersData.insulation.key !== 'Volume'"
                  >
                    <template #append>{{ othersData.insulation.volume.unit }}</template>
                  </el-input>
                </div>
              </el-radio-group>
            </el-form-item>
            <el-form-item label="Total weight">
              <el-input type="text" number="positive" v-model="othersData.total_weight.value">
                <template #append>{{ othersData.total_weight.unit }}</template>
              </el-input>
            </el-form-item>
          </el-form>
        </el-col>
            ...
            <table class="table-strip-input-data fixed-table">
              ...
              <tbody>
                <tr>
                  <td>Prim</td>
                  <td>
                    <el-select v-model="othersData.winding.prim" size="small">
                ...
                <tr>
                  <td>Sec</td>
                  <td>
                    <el-select v-model="othersData.winding.sec" size="small">
                      <el-option label="Aluminum" value="Aluminum"></el-option>
                      <el-option label="Copper" value="Copper"></el-option>
                    </el-select>
                  </td>
                ...
                >
                  <td>Tert</td>
                  <td>
                    <el-select v-model="othersData.winding.tert" size="small">
                      <el-option label="Aluminum" value="Aluminum"></el-option>
                      <el-option label="Copper" value="Copper"></el-option>
                    </el-select>
                  </td>
...
:deep(.insulation-item .el-form-item__content) {
  display: flex;
...
:deep(.insulation-row:last-child) {
  margin-bottom: 0;
}

:deep(.insulation-row .el-radio) {
  width: 40px;
  flex-shrink: 0;
}

:deep(.insulation-row .el-radio__label) {
  font-size: 12px;
}

:deep(.insulation-input) {
  flex: 1;
  min-width: 0;
}
