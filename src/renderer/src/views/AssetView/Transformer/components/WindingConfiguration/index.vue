        ...
        <el-col :xs="24" :sm="24" :md="12" class="col-content">
          ...
          >
            ...
            <el-form-item label="Vector group">
              <div
                v-if="vectorGroup !== null && vectorGroup !== '' && vectorGroup !== undefined"
              ...
              <el-input
                size="small"
                v-model="windingConfigurationData.vector_group_custom"
                placeholder="Enter custom vector group"
              ></el-input>
              <el-button
                type="primary"
                style="
              ...
              <el-input
                size="small"
                v-model="windingConfigurationData.unsupported_vector_group"
                placeholder="Enter unsupported vector group"
              ></el-input>
            </el-form-item>
          </el-form>
        </el-col>
...
export default {
  ...
  computed: {
    ...
    vectorGroup: function () {
      ...
      this.windingConfigurationData.vector_group_data =
  ...
  methods: {
    ...
    onOpenVectorGroup() {
      if (
        ...
        this.windingConfigurationData.phases === '' ||
        this.windingConfigurationData.phases === undefined
      ) {
...
@media (max-width: 767px) {
  ...
  :deep(.inline-phases .el-form-item__label) {
    width: 80px !important;
    padding-bottom: 0;
  }

  :deep(.inline-phases .el-form-item__content) {
    width: auto;
  }

  :deep(.inline-phases .el-radio-group) {
    display: flex;
    gap: 12px;
  }
}
