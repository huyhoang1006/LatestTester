  ...
  >
        ...
        <table class="w-100 mgt-5 table-strip-input-data">
          ...
          <tbody>
            <tr>
              ...
              <td>
                <el-input size="small" type="text" number="positive" v-model="voltage_1">
            ...
            <tr>
              ...
              <td>
                <el-input size="small" type="text" number="positive" v-model="voltage_2">
                  <template #append>V</template>
                </el-input>
              </td>
            </tr>
        ...
        <table class="w-100 mgt-5 table-strip-input-data">
          ...
          <tbody>
            <tr>
              ...
              <td>
                <el-input size="small" type="text" number="positive" v-model="voltage_first">
                  <template #append>V</template>
                </el-input>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <el-input size="small" type="text" number="positive" v-model="voltage_middle">
                  <template #append>V</template>
                </el-input>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <el-input size="small" type="text" number="positive" v-model="voltage_last">
                  <template #append>V</template>
                </el-input>
              </td>
            </tr>
    ...
    <template #footer>
      <span class="dialog-footer custom-footer">
        <el-button class="footer-btn" type="danger" @click="handleCancel" size="small"
          >Cancel</el-button
        >
        <el-button class="footer-btn" type="primary" @click="handleCalculate" size="small"
          >Calculate</el-button
        >
      </span>
    </template>
  ...
  methods: {
    ...
    async handleCalculate() {
      if (this.activeName == 'fas') {
        ...
        let a = parseInt(
          Math.abs(this.voltage_middle - this.voltage_first) / parseInt((this.numberOfTaps - 1) / 2)
        )
