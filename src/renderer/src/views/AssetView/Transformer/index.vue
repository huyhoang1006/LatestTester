        ...
        <el-row :gutter="8">
          <el-col :xs="12" :sm="6" :md="6">
            <el-button
              ...
              type="primary"
              style="width: 100%"
              @click="switchData('Transformer')"
              >Transformer</el-button
            >
          </el-col>
          <el-col :xs="12" :sm="6" :md="6">
            <el-button
          ...
          <el-col :xs="12" :sm="6" :md="6">
            <el-button
              ...
              type="primary"
              style="width: 100%"
              @click="switchData('Tap changer')"
              >Tap changer</el-button
            >
          </el-col>
          <el-col :xs="12" :sm="6" :md="6">
            <el-button
              ...
              type="primary"
              style="width: 100%"
              @click="switchData('Surge Arrester')"
              >Surge Arrester</el-button
            >
          </el-col>
        </el-row>
      </el-col>
    ...
    <div style="flex: 1; display: flex; flex-direction: column">
      <div v-if="this.switch == 'Transformer'">
        ...
        <property
          ...
          :data="this.transformerDto.properties"
        ...
        <rating
          :properties="this.transformerDto.properties"
          :data="this.transformerDto.ratings"
          style="font-size: 12px !important"
        ></rating>

        <!-- Impedances -->
        <impedance
          @add="addShortCircuitTest"
          @remove="removeShortCircuitTest"
          @removeArr="removeShortCircuitTestArr"
          :tapChangers="this.transformerDto.tap_changers"
          :data="this.transformerDto.impedances"
          :properties="this.transformerDto.properties"
          style="font-size: 12px !important"
        ></impedance>
        ...
        <!-- Others -->
        <other
          :data="this.transformerDto.others"
          :properties="this.transformerDto.properties"
      ...
      <div v-else-if="this.switch == 'Tap changer'">
        ...
        <tap-changer
          :properties="this.transformerDto.properties"
          :data="this.transformerDto.tap_changers"
          style="font-size: 12px !important"
        ></tap-changer>
      </div>
      ...
      <div
        ...
        v-else-if="this.switch == 'Bushings'"
      >
        <bushing
