        ...
        <el-form :label-width="labelWidth" size="small" label-position="left">
          ...
          <el-form-item label="Rated power">
            <el-input
              ...
              @input="
                updateField('ratings', 'rated_power', $event.target ? $event.target.value : $event)
              "
            >
...
export default {
  ...
  methods: {
    ...
    updateField(type, field, value) {
      ...
      switch (type) {
        case 'ratings':
          target = this.ratingsData
          break
        case 'capacitance':
          target = this.internalCapacitanceData
          break
        case 'dissipationFactor':
          target = this.internalDissipationFactorData
          break
        case 'others':
          target = this.othersData
          break
      }
