...
export default {
  ...
  methods: {
    ...
    updateConfigs(configs) {
      ...
      if (
        this.capacitorOld &&
        this.capacitorOld.configsData &&
        oldPhase !== newPhase &&
        this.capacitorOld.configsData.phase === newPhase
      ) {
        ...
        this.capacitor.dissipationFactor = JSON.parse(
          JSON.stringify(this.capacitorOld.dissipationFactor)
        )
