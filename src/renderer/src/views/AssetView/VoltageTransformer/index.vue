    ...
    <div style="min-height: 500px; display: flex; flex-direction: column">
      <div style="flex: 1; display: flex; flex-direction: column">
        <voltageTransProperty
          ...
          @editManu="editManu"
          :title="title"
          v-model:properties="voltageTransformer.properties"
        ...
        <ratings
          v-model:ratings="voltageTransformer.ratings"
          :properties="voltageTransformer.properties"
        >
        </ratings>
        <currentVTConfig v-model:configs="voltageTransformer.vt_Configuration"></currentVTConfig>
      </div>
    </div>
    <manufacturerAdd
