...
export default {
  ...
  methods: {
    async saveAsset() {
      try {
        if (
          this.voltageTransformer.properties.serial_no !== null &&
          this.voltageTransformer.properties.serial_no !== ''
        ) {
    ...
    checkWindings(data) {
      if (
        data.vt_Configuration.windings.mrid === null ||
        data.vt_Configuration.windings.mrid === ''
      ) {
