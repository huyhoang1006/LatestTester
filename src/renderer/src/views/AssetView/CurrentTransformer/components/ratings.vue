<template>
  <div id="ratings" class="mgt-10">
    ...
    <div class="content-toggle" v-if="openRatings">
      ...
      <el-row
        v-if="openShow && ratingsData.standard.value !== 'IEEEC5713'"
        class="content rating-wrapper"
      >
              ...
              <el-col :xs="24" :md="12" :lg="10" class="custom-col-spacing">
                ...
                <el-form-item label="U withstand (r.m.s) ">
                  <el-input
                    type="text"
                    number="positive"
                    v-model="ratingsData.u_withstand_rms.value"
                  >
                    <template #append>V</template>
                  </el-input>
                </el-form-item>
          ...
          <el-form-item label="Rating factor (RF)">
            <el-row type="flex" align="middle" :gutter="8">
              <el-col :xs="10" :sm="10" :md="6" :lg="4">
                <el-select style="width: 100%" size="small" v-model="ratingsData.rating_factor">
                  <el-option
                    v-for="item in ratedFactorArr"
                    :label="item"
                    :value="item"
                    :key="item"
                  ></el-option>
...
:deep(.nom-max-sel .el-form-item__label) {
  display: none;
}

:deep(.nom-max-sel .el-form-item__content) {
