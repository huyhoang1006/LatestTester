        ...
        <el-col :xs="12" :sm="12" :md="8" class="col-content">
          ...
          >
            <el-form-item label="Cores">
              <el-select
                style="width: 100%"
                @change="changeCoreData(configsData.cores)"
      ...
      <el-row>
        <div id="cores">
          <el-tabs v-if="!isNaN(parseInt(configsData.cores))" type="card" class="w-100 h-100">
            <el-tab-pane
              v-for="(item, index) in this.configsData.dataCT"
              :key="index"
            ...
            >
                ...
                <el-col :span="12" class="col-content margin-data">
                  ...
                  >
                    <el-form-item label="Common tap">
                      <el-select
                        @change="
                          (changeCommonTap(item.taps, index),
                          chooseCommonTap(item.taps, item.commonTap, index),
                          chosenCommonTap(item.taps, item.commonTap, index))
                        "
                ...
                <el-col :span="24">
                  ...
                  <div style="width: fit-content" class="fulltap-data">
                    <table style="width: 100%; background-color: white">
                      ...
                      <tbody>
                        <tr>
                          ...
                          >
                            <i
                              v-if="!item.fullTap.table.isShow"
                          ...
                          <td style="width: 30px" class="last-right">
                            <el-checkbox
                              @change="changeInuse(item.fullTap.table.inUse, index, '', 'fulltap')"
                              v-model="item.fullTap.table.inUse"
                              size="large"
                            />
                          </td>
                        </tr>
                    ...
                    >
                        ...
                        <el-col :span="11">
                          ...
                          >
                            ...
                            <el-form-item v-else label="Class">
                              ...
                              >
                                <el-option
                                  v-for="item in multipleC57.metering"
                                  :key="item"
                                  :label="item"
                                  :value="item"
                                >
                              ...
                              >
                                <el-option
                                  v-for="item in multipleC57.protection"
                                  :key="item"
                                  :label="item"
                                  :value="item"
                                >
                              ...
                              <el-select
                                class="width-half"
                                @change="
                                  changeRatingClassC57(index, item.fullTap.classRating.class)
                                "
                                v-else
                                v-model="item.fullTap.classRating.class"
                              >
                                <el-option
                                  v-for="item in multipleC57.all"
                                  :key="item"
                                  :label="item"
                                  :value="item"
                                >
                            ...
                            <el-form-item
                              v-if="
                                ['PX', 'TPS', 'TPX', 'TPY', 'TPZ', 'X'].includes(
                                  item.fullTap.classRating.class
                                ) || protectionData.PR.includes(item.fullTap.classRating.class)
                              "
                            ...
                            <el-form-item v-if="item.fullTap.classRating.class == 'TPS'" label="K">
                              <el-input
                                class="width-half"
                                size="small"
                                v-model="item.fullTap.classRating.k"
                              ></el-input>
                            </el-form-item>
                            <el-form-item
                              v-if="item.fullTap.classRating.app == 'metering'"
                            ...
                            >
                              <el-input
                                class="width-half"
                                size="small"
                                v-model="item.fullTap.classRating.fs"
                              ></el-input>
                            </el-form-item>
                            <el-form-item
                              v-if="
                                ['TPS', 'TPX', 'TPY', 'TPZ'].includes(
                                  item.fullTap.classRating.class
                                )
                              "
                              label="KSSC"
                            >
                              <el-input
                                class="width-half"
                                size="small"
                                v-model="item.fullTap.classRating.kssc"
                              ></el-input>
                            </el-form-item>
                            <el-form-item
                            ...
                            >
                              <el-input
                                class="width-half"
                                size="small"
                                v-model="item.fullTap.classRating.ktd"
                              ></el-input>
                            </el-form-item>
                            <el-form-item
                      ...
                      <el-row
                        v-if="
                          item.fullTap.classRating.app == 'protection' &&
                          (protectionData.P.includes(item.fullTap.classRating.class) ||
                            protectionData.PR.includes(item.fullTap.classRating.class))
                        "
                        style="width: 100%"
                      >
                          ...
                          >
                            <el-form-item label="ALF">
                              <el-input
                                class="width-half"
                                size="small"
                                v-model="item.fullTap.classRating.alf"
                              ></el-input>
                            </el-form-item>
                          </el-form>
                        </el-col>
                          ...
                          >
                            <el-form-item label="Ts">
                              <el-input
                                class="width-half"
                                size="small"
                                v-model="item.fullTap.classRating.ts"
                              ></el-input>
                            </el-form-item>
                          </el-form>
                        </el-col>
                          ...
                          >
                            <el-form-item label="Ek">
                              <el-input
                                class="width-half"
                                size="small"
                                v-model="item.fullTap.classRating.ek"
                              ></el-input>
                            </el-form-item>
                          </el-form>
                        </el-col>
                          ...
                          >
                            <el-form-item label="le">
                              <el-input
                                class="width-half"
                                size="small"
                                v-model="item.fullTap.classRating.le"
                              ></el-input>
                            </el-form-item>
                          </el-form>
                        </el-col>
                      ...
                      <el-row
                        v-if="['PX', 'TPS'].includes(item.fullTap.classRating.class)"
                        style="width: 100%"
                      >
                        <el-col :span="11">
                          <el-form
                          ...
                          >
                            <el-form-item label="E1">
                              <el-input
                                class="width-half"
                                size="small"
                                v-model="item.fullTap.classRating.e1"
                              ></el-input>
                            </el-form-item>
                          </el-form>
                        </el-col>
                          ...
                          >
                            <el-form-item label="le1">
                              <el-input
                                class="width-half"
                                size="small"
                                v-model="item.fullTap.classRating.le1"
                              ></el-input>
                            </el-form-item>
                          </el-form>
                        </el-col>
                          ...
                          >
                            <el-form-item label="Val">
                              <el-input
                                class="width-half"
                                size="small"
                                v-model="item.fullTap.classRating.val"
                              ></el-input>
                            </el-form-item>
                          </el-form>
                        </el-col>
                          ...
                          >
                            <el-form-item label="lal">
                              <el-input
                                class="width-half"
                                size="small"
                                v-model="item.fullTap.classRating.lal"
                              ></el-input>
                            </el-form-item>
                          </el-form>
                        </el-col>
                          ...
                          >
                            <el-form-item label="t1">
                              <el-input
                                class="width-half"
                                size="small"
                                v-model="item.fullTap.classRating.t1"
                              ></el-input>
                            </el-form-item>
                          </el-form>
                        </el-col>
                          ...
                          >
                            <el-form-item label="tal1">
                              <el-input
                                class="width-half"
                                size="small"
                                v-model="item.fullTap.classRating.tal1"
                              ></el-input>
                            </el-form-item>
                          </el-form>
                        </el-col>
                          ...
                          >
                            <el-form-item label="Tp">
                              <el-input
                                class="width-half"
                                size="small"
                                v-model="item.fullTap.classRating.tp"
                              ></el-input>
                            </el-form-item>
                          </el-form>
                        </el-col>
                        <el-col
                          v-if="['TPY', 'TPZ'].includes(item.fullTap.classRating.class)"
                          :span="2"
                        >
                          <br />
                        </el-col>
                          ...
                          >
                            <el-form-item label="Ts">
                              <el-input
                                class="width-half"
                                size="small"
                                v-model="item.fullTap.classRating.tpts"
                              ></el-input>
                            </el-form-item>
                          </el-form>
                        </el-col>
                      ...
                      <el-row
                        v-if="['T', 'X'].includes(item.fullTap.classRating.class)"
                        style="width: 100%"
                      >
                        <el-col :span="11">
                          <el-form
                          ...
                          >
                            <el-form-item label="Vk">
                              <el-input
                                class="width-half"
                                size="small"
                                v-model="item.fullTap.classRating.vk"
                              ></el-input>
                            </el-form-item>
                          </el-form>
                        </el-col>
                          ...
                          >
                            <el-form-item label="lk">
                              <el-input
                                class="width-half"
                                size="small"
                                v-model="item.fullTap.classRating.lk"
                              ></el-input>
                            </el-form-item>
                          </el-form>
                        </el-col>
                          ...
                          >
                            <el-form-item label="Vk1">
                              <el-input
                                class="width-half"
                                size="small"
                                v-model="item.fullTap.classRating.vk1"
                              ></el-input>
                            </el-form-item>
                          </el-form>
                        </el-col>
                          ...
                          >
                            <el-form-item label="lk1">
                              <el-input
                                class="width-half"
                                size="small"
                                v-model="item.fullTap.classRating.lk1"
                              ></el-input>
                            </el-form-item>
                          </el-form>
                        </el-col>
                          ...
                          >
                            <el-form-item label="cos φ">
                              <el-input
                                ...
                                class="width-half"
                                size="small"
                                v-model="item.fullTap.classRating.burdenCos"
                              ></el-input>
                            </el-form-item>
                          </el-form>
                        </el-col>
                          ...
                          >
                            <el-form-item label="cos φ">
                              <el-input
                                ...
                                class="width-half"
                                size="small"
                                v-model="item.fullTap.classRating.operatingBurdenCos"
                              ></el-input>
                            </el-form-item>
                          </el-form>
                        </el-col>
              ...
              <el-row
                v-if="item.taps > 2 && item.commonTap != ''"
                        ...
                        <tbody>
                          <tr>
                            <td
                              ...
                              style="width: 30px; cursor: pointer; border-left: none"
                              @click="
                                item.mainTap.data[element - 1].table.isShow =
                                  !item.mainTap.data[element - 1].table.isShow
                              "
                            >
                              <i
                                v-if="!item.mainTap.data[element - 1].table.isShow"
                                class="fa-solid fa-caret-right"
                              ></i>
                              <i v-else class="fa-solid fa-caret-right fa-rotate-90"></i>
                            </td>
                            <td style="width: 60px">
                              {{ item.mainTap.data[element - 1].table.name }}
                            </td>
                            <td style="width: 250px">
                              <el-input
                                size="small"
                            ...
                            <td style="width: 30px">
                              <el-checkbox
                                @change="
                                  changeInuse(
                                    item.mainTap.data[element - 1].table.inUse,
                                    index,
                                    element - 1,
                                    'maintap'
                                  )
                            ...
                            >
                              <el-form-item label="Rated burden">
                                <el-input
                                  ...
                                  size="small"
                                  v-model="
                                    item.mainTap.data[element - 1].classRating.rated_burden.value
                                  "
                                >
                                  <template #append>VA</template>
                                </el-input>
                          ...
                          <el-col :span="11">
                            ...
                            >
                              <el-form-item label="">
                                <el-checkbox
                                  v-model="
                                    item.mainTap.data[element - 1].classRating.extended_burden
                                  "
                                  label="Extended burden"
                                  size="large"
                                />
                            ...
                            >
                              <el-form-item label="cos φ">
                                <el-input
                                  ...
                                  class="width-half"
                                  size="small"
                                  v-model="item.mainTap.data[element - 1].classRating.burdenCos"
                                ></el-input>
                              </el-form-item>
                            </el-form>
                          </el-col>
                            ...
                            >
                              <el-form-item label="Operating burden">
                                <el-input
                                  ...
                                  size="small"
                                  v-model="
                                    item.mainTap.data[element - 1].classRating.operatingBurden.value
                                  "
                                >
                                  <template #append>VA</template>
                                </el-input>
                            ...
                            >
                              <el-form-item label="cos φ">
                                <el-input
                                  ...
                                  size="small"
                                  v-model="
                                    item.mainTap.data[element - 1].classRating.operatingBurdenCos
                                  "
                                ></el-input>
                              </el-form-item>
                            </el-form>
                        ...
                        <tbody>
                          <tr>
                            <td
                              ...
                              style="width: 30px; cursor: pointer; border-left: none"
                              @click="
                                item.interTap.data[i].table.isShow =
                                  !item.interTap.data[i].table.isShow
                              "
                            >
                              <i
                                v-if="!item.interTap.data[i].table.isShow"
                                class="fa-solid fa-caret-right"
                              ></i>
                              <i v-else class="fa-solid fa-caret-right fa-rotate-90"></i>
                            </td>
                            ...
                            <td style="width: 30px">
                              <el-checkbox
                                @change="
                                  changeInuse(
                                    item.interTap.data[i].table.inUse,
                                    index,
                                    i,
                                    'intertap'
                                  )
                            ...
                            >
                              <el-form-item label="cos φ">
                                <el-input
                                  ...
                                  class="width-half"
                                  size="small"
                                  v-model="item.interTap.data[i].classRating.burdenCos"
                                ></el-input>
                              </el-form-item>
                            </el-form>
                          </el-col>
                            ...
                            >
                              <el-form-item label="cos φ">
                                <el-input
                                  ...
                                  class="width-half"
                                  size="small"
                                  v-model="item.interTap.data[i].classRating.operatingBurdenCos"
                                ></el-input>
                              </el-form-item>
                            </el-form>
                          </el-col>
  ...
  methods: {
          ...
          const coreData = {
            ...
            fullTap: {
              table: {
                ...
                isShow: false,
                name:
                  i === 0 && this.configsData.cores === 1 ? 'S1 - S2' : `${i + 1}S1 - ${i + 1}S2`,
    ...
    changeCommonTap(data, index) {
      if (index == 0 && this.configsData.cores == 1) {
        ...
        this.configsData.dataCT[index].fullTap.table.name =
          `${index + 1}` + 'S1 - ' + `${index + 1}` + 'S' + data
      }
    },
    chooseCommonTap(taps, commonTap, index) {
      if (index == 0 && this.configsData.cores == 1) {
        ...
        if (taps > commonTap) {
          ...
          this.configsData.dataCT[index].mainTap.data.forEach((element, i) => {
            element.table.name =
              `${index + 1}` + 'S' + `${i + 2}` + ' - ' + `${index + 1}` + 'S' + `${commonTap}`
          })
        }
      }
    },
    ...
    async changedTap(data, index) {
      ...
      for (let i = 2; i <= parseInt(data); i++) {
        for (let j = i + 1; j <= data; j++) {
          const name =
            index == 0 && this.configsData.cores == 1
              ? 'S' + `${i}` + ' - ' + 'S' + `${j}`
              : `${index + 1}` + 'S' + `${i}` + ' - ' + `${index + 1}` + 'S' + `${j}`
          ...
          dataArr.push({
            ...
            classRating: {
              ...
              rated_burden: existingItem
                ? existingItem.classRating.rated_burden
                : { mrid: '', value: '', unit: UnitSymbol.VA },
              extended_burden: existingItem ? existingItem.classRating.extended_burden : false,
              burden: existingItem
                ? existingItem.classRating.burden
                : { mrid: '', value: '', unit: UnitSymbol.VA },
              burdenCos: existingItem ? existingItem.classRating.burdenCos : '',
              operatingBurden: existingItem
                ? existingItem.classRating.operatingBurden
                : { mrid: '', value: '', unit: UnitSymbol.VA },
