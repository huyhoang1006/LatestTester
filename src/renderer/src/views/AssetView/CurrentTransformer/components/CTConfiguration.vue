                        ...
                        <el-tab-pane v-for="(item, index) in this.configsData.dataCT" :key="index"
                            ...
                            <el-row style="background-color: #F5F5F5;">
                                <el-col :span="12" class="col-content margin-data">
                                    <el-form :inline-message="true" :label-width="labelWidth" size="small"
                                        label-position="left">
                                        <el-form-item label="Taps">
                                            <el-select
                                                @change="changeTap(item.taps, index), changedTap(item.taps, index)"
                                                v-model="item.taps">
                                ...
                                <el-col :span="12" class="col-content margin-data">
                                    <el-form :inline-message="true" :label-width="labelWidth" size="small"
                                        ...
                                        <el-form-item label="Common tap">
                                            <el-select
                                                @change="changeCommonTap(item.taps, index), chooseCommonTap(item.taps, item.commonTap, index), chosenCommonTap(item.taps, item.commonTap, index)"
                                                v-model="item.commonTap">
                                    ...
                                    <div style="width: fit-content" class="fulltap-data">
                                        <table style=" width: 100%; background-color: white;">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="last-left"
                                                        style="width : 30px; cursor: pointer; border-left: none;"
                                                        @click="item.fullTap.table.isShow = !item.fullTap.table.isShow">
                                                        <i v-if="!item.fullTap.table.isShow"
                                                            class="fa-solid fa-caret-right"></i>
                                                        <i v-else class="fa-solid fa-caret-right fa-rotate-90"></i>
                                                    </td>
                                                    <td style="width : 60px;">{{ item.fullTap.table.name }}</td>
                                                    <td style="width : 250px;">
                                                        <el-input size="small" v-model="item.fullTap.table.ipn.value">
                                                            <template #append>A</template>
                                                        </el-input>
                                                    </td>
                                                    <td style="width : 10px;">:</td>
                                                    <td style="width : 250px;">
                                                        <el-input size="small" v-model="item.fullTap.table.isn.value">
                                                            <template #append>A</template>
                                                        </el-input>
                                                    </td>
                                                    <td style="width : 30px;" class="last-right"><el-checkbox
                                                            @change="changeInuse(item.fullTap.table.inUse, index, '', 'fulltap')"
                                                            v-model="item.fullTap.table.inUse" size="large" /></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                        <div v-if="item.fullTap.table.isShow"
                                            ...
                                            <el-row style="width: 100%;">
                                                <el-col :span="11">
                                                    <el-form :inline-message="true" label-width="150px" size="small"
                                                        label-position="left" style="width: 100%;">
                                                        <el-form-item label="Application">
                                                            <el-select class="width-half" @change="appDataChange(index)"
                                                                v-model="item.fullTap.classRating.app">
                                                                <el-option label="Choose application"
                                                                    value="chooseApp"></el-option>
                                                                <el-option label="Metering"
                                                                    value="metering"></el-option>
                                                                <el-option label="Protection"
                                                                    value="protection"></el-option>
                                                            </el-select>
                                                        </el-form-item>
                                                        <el-form-item v-if="ratingsData.standard != 'IEEEC5713'"
                                                            label="Class">
                                                            <el-select class="width-half"
                                                                v-if="item.fullTap.classRating.app === 'metering'"
                                                                v-model="item.fullTap.classRating.class">
                                                                <el-option v-for="item in metering" :key="item"
                                                                    :label="item" :value="item"> </el-option>
                                                            </el-select>
                                                            <el-select class="width-half"
                                                                v-else-if="item.fullTap.classRating.app === 'protection'"
                                                                v-model="item.fullTap.classRating.class">
                                                                <el-option v-for="item in protection" :key="item"
                                                                    :label="item" :value="item"> </el-option>
                                                            </el-select>
                                                            <el-select class="width-half"
                                                                @change="changeRatingClass(index, item.fullTap.classRating.class)"
                                                                v-else v-model="item.fullTap.classRating.class">
                                                                <el-option v-for="item in multiple" :key="item"
                                                                    :label="item" :value="item"> </el-option>
                                                            </el-select>
                                                        </el-form-item>
                                                        <el-form-item v-else label="Class">
                                                            <el-select class="width-half"
                                                                v-if="item.fullTap.classRating.app === 'metering'"
                                                                v-model="item.fullTap.classRating.class">
                                                                <el-option v-for="item in multipleC57.metering"
                                                            ...
                                                            <el-select class="width-half"
                                                                v-else-if="item.fullTap.classRating.app === 'protection'"
                                                                v-model="item.fullTap.classRating.class">
                                                                <el-option v-for="item in multipleC57.protection"
                                                                    :key="item" :label="item" :value="item">
                                                                </el-option>
                                                            </el-select>
                                                            <el-select class="width-half"
                                                                @change="changeRatingClassC57(index, item.fullTap.classRating.class)"
                                                                v-else v-model="item.fullTap.classRating.class">
                                                                <el-option v-for="item in multipleC57.all" :key="item"
                                                                    :label="item" :value="item"> </el-option>
                                                            </el-select>
                                                        </el-form-item>
                                                        <el-form-item
                                                            ...
                                                            <el-input class="width-half" size="small"
                                                                v-model="item.fullTap.classRating.wr.value">
                                                                <template #append>Ω</template>
                                                            </el-input>
                                                        </el-form-item>
                                                        <el-form-item v-if="item.fullTap.classRating.class == 'PX'"
                                                            label="Kx">
                                                            <el-input class="width-half" size="small"
                                                                v-model="item.fullTap.classRating.kx">
                                                            </el-input>
                                                        </el-form-item>
                                                        <el-form-item
                                                        ...
                                                        <el-form-item v-if="item.fullTap.classRating.class == 'TPS'"
                                                            label="K">
                                                            <el-input class="width-half" size="small"
                                                                v-model="item.fullTap.classRating.k"></el-input>
                                                        </el-form-item>
                                                        <el-form-item v-if="item.fullTap.classRating.app == 'metering'"
                                                            label="FS">
                                                            <el-input class="width-half" size="small"
                                                                v-model="item.fullTap.classRating.fs"></el-input>
                                                        </el-form-item>
                                                        <el-form-item
                                                            v-if="['TPS', 'TPX', 'TPY', 'TPZ'].includes(item.fullTap.classRating.class)"
                                                            label="KSSC">
                                                            <el-input class="width-half" size="small"
                                                                v-model="item.fullTap.classRating.kssc"></el-input>
                                                        </el-form-item>
                                                        <el-form-item
                                                            v-if="['TPX', 'TPY', 'TPZ'].includes(item.fullTap.classRating.class)"
                                                            label="Ktd">
                                                            <el-input class="width-half" size="small"
                                                                v-model="item.fullTap.classRating.ktd"></el-input>
                                                        </el-form-item>
                                                        <el-form-item
                                                            v-if="['TPX', 'TPY'].includes(item.fullTap.classRating.class)"
                                                            label="Duty">
                                                            <el-select class="width-half"
                                                                v-model="item.fullTap.classRating.duty">
                                            ...
                                            <el-row
                                                v-if="item.fullTap.classRating.app == 'protection' && (protectionData.P.includes(item.fullTap.classRating.class) || protectionData.PR.includes(item.fullTap.classRating.class))"
                                                style="width: 100%;">
                                                <el-col :span="11">
                                                    <el-form :inline-message="true" label-width="150px" size="small"
                                                        label-position="left" style="width: 100%;">
                                                        <el-form-item label="ALF">
                                                            <el-input class="width-half" size="small"
                                                                v-model="item.fullTap.classRating.alf"></el-input>
                                                        </el-form-item>
                                                    </el-form>
                                                </el-col>
                                                <el-col
                                                    v-if="protectionData.PR.includes(item.fullTap.classRating.class)"
                                                    :span="2">
                                                    <br />
                                                </el-col>
                                                <el-col
                                                    ...
                                                    <el-form :inline-message="true" label-width="150px" size="small"
                                                        ...
                                                        <el-form-item label="Ts">
                                                            <el-input class="width-half" size="small"
                                                                v-model="item.fullTap.classRating.ts"></el-input>
                                                        </el-form-item>
                                                    </el-form>
                                                </el-col>
                                            </el-row>
                                                ...
                                                <el-col :span="11">
                                                    <el-form :inline-message="true" label-width="150px" size="small"
                                                        ...
                                                        <el-form-item label="Ek">
                                                            <el-input class="width-half" size="small"
                                                                v-model="item.fullTap.classRating.ek"></el-input>
                                                        </el-form-item>
                                                    </el-form>
                                                </el-col>
                                                <el-col :span="2">
                                                ...
                                                <el-col :span="11">
                                                    <el-form :inline-message="true" label-width="150px" size="small"
                                                        ...
                                                        <el-form-item label="le">
                                                            <el-input class="width-half" size="small"
                                                                v-model="item.fullTap.classRating.le"></el-input>
                                                        </el-form-item>
                                                    </el-form>
                                                </el-col>
                                            </el-row>
                                            <el-row v-if="['PX', 'TPS'].includes(item.fullTap.classRating.class)"
                                                style="width: 100%;">
                                                <el-col :span="11">
                                                    <el-form :inline-message="true" label-width="150px" size="small"
                                                        label-position="left" style="width: 100%;">
                                                        <el-form-item label="E1">
                                                            <el-input class="width-half" size="small"
                                                                v-model="item.fullTap.classRating.e1"></el-input>
                                                        </el-form-item>
                                                    </el-form>
                                                </el-col>
                                                <el-col :span="2">
                                                ...
                                                <el-col :span="11">
                                                    <el-form :inline-message="true" label-width="150px" size="small"
                                                        ...
                                                        <el-form-item label="le1">
                                                            <el-input class="width-half" size="small"
                                                                v-model="item.fullTap.classRating.le1"></el-input>
                                                        </el-form-item>
                                                    </el-form>
                                                </el-col>
                                            </el-row>
                                                ...
                                                <el-col :span="11">
                                                    <el-form :inline-message="true" label-width="150px" size="small"
                                                        ...
                                                        <el-form-item label="Val">
                                                            <el-input class="width-half" size="small"
                                                                v-model="item.fullTap.classRating.val"></el-input>
                                                        </el-form-item>
                                                    </el-form>
                                                </el-col>
                                                <el-col :span="2">
                                                ...
                                                <el-col :span="11">
                                                    <el-form :inline-message="true" label-width="150px" size="small"
                                                        ...
                                                        <el-form-item label="lal">
                                                            <el-input class="width-half" size="small"
                                                                v-model="item.fullTap.classRating.lal"></el-input>
                                                        </el-form-item>
                                                    </el-form>
                                                </el-col>
                                            </el-row>
                                            <el-row v-if="['TPX', 'TPY'].includes(item.fullTap.classRating.class)"
                                                style="width: 100%;">
                                                <el-col :span="11">
                                                    <el-form :inline-message="true" label-width="150px" size="small"
                                                        label-position="left" style="width: 100%;">
                                                        <el-form-item label="t1">
                                                            <el-input class="width-half" size="small"
                                                                v-model="item.fullTap.classRating.t1"></el-input>
                                                        </el-form-item>
                                                    </el-form>
                                                </el-col>
                                                <el-col :span="2">
                                                ...
                                                <el-col :span="11">
                                                    <el-form :inline-message="true" label-width="150px" size="small"
                                                        ...
                                                        <el-form-item label="tal1">
                                                            <el-input class="width-half" size="small"
                                                                v-model="item.fullTap.classRating.tal1"></el-input>
                                                        </el-form-item>
                                                    </el-form>
                                                </el-col>
                                            </el-row>
                                                ...
                                                <el-col :span="11">
                                                    <el-form :inline-message="true" label-width="150px" size="small"
                                                        ...
                                                        <el-form-item label="Tp">
                                                            <el-input class="width-half" size="small"
                                                                v-model="item.fullTap.classRating.tp"></el-input>
                                                        </el-form-item>
                                                    </el-form>
                                                </el-col>
                                                <el-col v-if="['TPY', 'TPZ'].includes(item.fullTap.classRating.class)"
                                                    :span="2">
                                                    <br />
                                                </el-col>
                                                <el-col v-if="['TPY', 'TPZ'].includes(item.fullTap.classRating.class)"
                                                    ...
                                                    <el-form :inline-message="true" label-width="150px" size="small"
                                                        ...
                                                        <el-form-item label="Ts">
                                                            <el-input class="width-half" size="small"
                                                                v-model="item.fullTap.classRating.tpts"></el-input>
                                                        </el-form-item>
                                                    </el-form>
                                                </el-col>
                                            </el-row>
                                            <el-row v-if="['T', 'X'].includes(item.fullTap.classRating.class)"
                                                style="width: 100%">
                                                <el-col :span="11">
                                                    <el-form :inline-message="true" label-width="150px" size="small"
                                                        label-position="left" style="width: 100%;">
                                                        <el-form-item label="Vk">
                                                            <el-input class="width-half" size="small"
                                                                v-model="item.fullTap.classRating.vk"></el-input>
                                                        </el-form-item>
                                                    </el-form>
                                                </el-col>
                                                <el-col :span="2">
                                                ...
                                                <el-col :span="11">
                                                    <el-form :inline-message="true" label-width="150px" size="small"
                                                        ...
                                                        <el-form-item label="lk">
                                                            <el-input class="width-half" size="small"
                                                                v-model="item.fullTap.classRating.lk"></el-input>
                                                        </el-form-item>
                                                    </el-form>
                                                </el-col>
                                            </el-row>
                                                ...
                                                <el-col :span="11">
                                                    <el-form :inline-message="true" label-width="150px" size="small"
                                                        ...
                                                        <el-form-item label="Vk1">
                                                            <el-input class="width-half" size="small"
                                                                v-model="item.fullTap.classRating.vk1"></el-input>
                                                        </el-form-item>
                                                    </el-form>
                                                </el-col>
                                                <el-col :span="2">
                                                ...
                                                <el-col :span="11">
                                                    <el-form :inline-message="true" label-width="150px" size="small"
                                                        ...
                                                        <el-form-item label="lk1">
                                                            <el-input class="width-half" size="small"
                                                                v-model="item.fullTap.classRating.lk1"></el-input>
                                                        </el-form-item>
                                                    </el-form>
                                                </el-col>
                                            </el-row>
                                            ...
                                            <el-row style="width: 100%; margin-top: 20px;">
                                                <el-col :span="11">
                                                    <el-form :inline-message="true" label-width="150px" size="small"
                                                        ...
                                                        <el-form-item label="Rated burden">
                                                            <el-input type="text" number="positive" class="width-half" size="small"
                                                                v-model="item.fullTap.classRating.rated_burden.value">
                                                                <template #append>VA</template>
                                                            </el-input>
                                                        </el-form-item>
                                                    </el-form>
                                                </el-col>
                                                ...
                                                <el-col :span="11">
                                                    <el-form :inline-message="true" label-width="150px" size="small"
                                                        ...
                                                        <el-form-item label="">
                                                            <el-checkbox
                                                                v-model="item.fullTap.classRating.extended_burden"
                                                                label="Extended burden" size="large" />
                                                        </el-form-item>
                                                    </el-form>
                                                </el-col>
                                            </el-row>
                                            ...
                                            <table style=" background-color: white;">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="last-left"
                                                            style="width : 30px; cursor: pointer; border-left: none;"
                                                            @click="item.mainTap.data[element - 1].table.isShow = !item.mainTap.data[element - 1].table.isShow">
                                                            <i v-if="!item.mainTap.data[element - 1].table.isShow"
                                                                class="fa-solid fa-caret-right"></i>
                                                            <i v-else class="fa-solid fa-caret-right fa-rotate-90"></i>
                                                        </td>
                                                        <td style="width : 60px;">{{
                                                        ...
                                                        <td style="width: 30px;"><el-checkbox
                                                                @change="changeInuse(item.mainTap.data[element - 1].table.inUse, index, element - 1, 'maintap')"
                                                                v-model="item.mainTap.data[element - 1].table.inUse" />
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                                ...
                                                <el-row style="width: 100%; margin-top: 20px;">
                                                    ...
                                                    <el-col :span="11">
                                                        <el-form :inline-message="true" label-width="150px" size="small"
                                                            ...
                                                            <el-form-item label="">
                                                                <el-checkbox
                                                                    v-model="item.mainTap.data[element - 1].classRating.extended_burden"
                                                                    label="Extended burden" size="large" />
                                                            </el-form-item>
                                                        </el-form>
                                                    </el-col>
                                            ...
                                            <table style=" width: 100%; background-color: white;">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="last-left"
                                                            style="width : 30px; cursor: pointer; border-left: none;"
                                                            @click="item.interTap.data[i].table.isShow = !item.interTap.data[i].table.isShow">
                                                            <i v-if="!item.interTap.data[i].table.isShow"
                                                                class="fa-solid fa-caret-right"></i>
                                                            <i v-else class="fa-solid fa-caret-right fa-rotate-90"></i>
                                                        </td>
                                                        ...
                                                        <td style="width : 30px;"><el-checkbox
                                                                @change="changeInuse(item.interTap.data[i].table.inUse, index, i, 'intertap')"
                                                                v-model="item.interTap.data[i].table.inUse"
                                                                size="large" /></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                                ...
                                                <el-row style="width: 100%; margin-top: 20px;">
                                                    ...
                                                    <el-col :span="11">
                                                        <el-form :inline-message="true" label-width="150px" size="small"
                                                            ...
                                                            <el-form-item label="">
                                                                <el-checkbox
                                                                    v-model="item.interTap.data[i].classRating.extended_burden"
                                                                    label="Extended burden" size="large" />
                                                            </el-form-item>
                                                        </el-form>
                                                    </el-col>
...
export default {
    ...
    methods: {
        ...
        changeCoreData(data) {
            ...
            if (this.configsData.dataCT.length === 0) {
                for (let i = 0; i < this.configsData.cores; i++) {
                    ...
                    const coreData = {
                        ...
                        fullTap: {
                            ...
                            classRating: {
                                class: '',
                                app: '',
                                wr: { mrid: '', value: '', unit: UnitSymbol.ohm },
                                kx: '',
                                re20lsn: '',
                                k: '',
                                fs: '',
                    ...
                    this.configsData.dataCT.push(coreData);
                }
            } else {
                ...
                if (data > length) {
                    for (let i = 0; i < (data - length); i++) {
                        ...
                        this.configsData.dataCT.push(newCoreData);
                    }
                } else {
                    this.configsData.dataCT.splice(data, length - data)
                }
            }
            // Initialize the first core's tap configuration
            if (this.configsData.dataCT.length > 0) {
        ...
        async changedTap(data, index) {
            const oldData = this.configsData.dataCT[index].interTap.data || [];
            const oldDataMap = {};
            oldData.forEach((item) => {
                oldDataMap[item.table.name] = item;
            });
                ...
                for (let j = i + 1; j <= data; j++) {
                    ...
                    dataArr.push({
                        table: {
                            ...
                            isShow: false,
                            name: name,
                            ipn: existingItem ? existingItem.table.ipn : { mrid: '', value: '', unit: "A" },
                            isn: existingItem ? existingItem.table.isn : { mrid: '', value: '', unit: "A" },
                            inUse: existingItem ? existingItem.table.inUse : false,
                            type: 'intertap'
                        },
                        classRating: {
                            mrid: existingItem ? existingItem.classRating.mrid : '',
                            rated_burden: existingItem ? existingItem.classRating.rated_burden : { mrid: '', value: '', unit: UnitSymbol.VA },
                            extended_burden: existingItem ? existingItem.classRating.extended_burden : false,
                            burden: existingItem ? existingItem.classRating.burden : { mrid: '', value: '', unit: UnitSymbol.VA },
                            burdenCos: existingItem ? existingItem.classRating.burdenCos : '',
                            operatingBurden: existingItem ? existingItem.classRating.operatingBurden : { mrid: '', value: '', unit: UnitSymbol.VA },
                            operatingBurdenCos: existingItem ? existingItem.classRating.operatingBurdenCos : '',
                            core_index: i + 1
                        }
                    })
                }
