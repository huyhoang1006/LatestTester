<template>
  <div id="asset">
    <div style="min-height: 500px; display: flex; flex-direction: column">
      <div style="flex: 1; display: flex; flex-direction: column">
        <currentTransProperty
          ...
          @editManu="editManu"
          :title="title"
          v-model:properties="currentTransformer.properties"
          @createAdd="updateShowAdd"
          :manufact="manufacturerCustom"
          @reloadManu="reloadManu()"
        >
        </currentTransProperty>
        <currentTransRating v-model:ratings="currentTransformer.ratings"></currentTransRating>
        <currentCTConfig
          v-if="currentTransformer.ctConfiguration"
          v-model:configs="currentTransformer.ctConfiguration"
    ...
    <manufacturerAdd
      ...
      v-model:showAdd="showAdd"
      @backSign="backSign()"
      @backSignUpdate="backSignUpdate"
      :title="title"
      :modeManu="modeManu"
    ></manufacturerAdd>
  </div>
