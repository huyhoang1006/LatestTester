<template>
    <div id="online-monitoring-data">
        ...
        <div style="margin-top: 100px;">
                                ...
                                <table class="table-strip-input-data" style="width: 420px">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>Ageing rate</td>
                                            <td>
                                                <el-input size="small" type="number" v-model="online_monitoring.aois.ar"></el-input>
                                            </td>
                                        </tr>
                                        <tr style="white-space: nowrap;">
                                            <td style="white-space: nowrap;">Lifetime consumption (absolute)</td>
                                            <td>
                                                <el-input size="small" type="number" v-model="online_monitoring.aois.lc"></el-input>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>         
                                ...
                                <table class="table-strip-input-data" style="width: 420px">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <el-input size="small" type="number" v-model="online_monitoring.moip.input_data.wcit">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <el-input size="small" type="number" v-model="online_monitoring.moip.input_data.tot">
                                ...
                                <table class="table-strip-input-data" style="width: 420px">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <el-input size="small" type="number" v-model="online_monitoring.moip.cal.moip">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <el-input :class="nameColor(online_monitoring.moip.cal.ci)" size="small" v-model="online_monitoring.moip.cal.ci">
                                    ...
                                    <table class="table-strip-input-data" style="width: 500px">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <el-input size="small" type="number" v-model="online_monitoring.bushings.bf.c_c_hv_ph1">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <el-input size="small" type="number" v-model="online_monitoring.bushings.bf.c_c_hv_ph2" >
                                                        <template slot="append">pF</template>
                                                    </el-input>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <el-input size="small" type="number" v-model="online_monitoring.bushings.bf.c_c_hv_ph3">
                                                        <template slot="append">pF</template>
                                                    </el-input>
                                                </td>
                                            </tr>
                                        ...
                                        <table class="table-strip-input-data" style="width: 550px">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>HV Ph.1</td>
                                                    <td>
                                                        <el-input size="small" type="number" v-model="online_monitoring.bushings.deltaC.hv_ph1.result">
                                                            <template slot="append">%</template>
                                                        </el-input>
                                                    </td>
                                                    <td>
                                                        <el-input :class="nameColor(online_monitoring.bushings.deltaC.hv_ph1.ci)" size="small" v-model="online_monitoring.bushings.deltaC.hv_ph1.ci">
                                                        </el-input>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>HV Ph.2</td>
                                                    <td>
                                                        <el-input size="small" type="number" v-model="online_monitoring.bushings.deltaC.hv_ph2.result">
                                                            <template slot="append">%</template>
                                                        </el-input>
                                                    </td>
                                                    <td>
                                                        <el-input :class="nameColor(online_monitoring.bushings.deltaC.hv_ph2.ci)" size="small" v-model="online_monitoring.bushings.deltaC.hv_ph2.ci">
                                                        </el-input>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>HV Ph.3</td>
                                                    <td>
                                                        <el-input size="small" type="number" v-model="online_monitoring.bushings.deltaC.hv_ph3.result">
                                                            <template slot="append">%</template>
                                                        </el-input>
                                                    </td>
                                                    <td>
                                                        <el-input :class="nameColor(online_monitoring.bushings.deltaC.hv_ph3.ci)" size="small" v-model="online_monitoring.bushings.deltaC.hv_ph3.ci">
                                                        </el-input>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        ...
                                        <table class="table-strip-input-data" style="width: 550px">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>HV Ph.1</td>
                                                    <td>
                                                        <el-input size="small" type="number" v-model="online_monitoring.bushings.deltaDF.hv_ph1.result">
                                                            <template slot="append">%</template>
                                                        </el-input>
                                                    </td>
                                                    <td>
                                                        <el-input :class="nameColor(online_monitoring.bushings.deltaDF.hv_ph1.ci)" size="small" v-model="online_monitoring.bushings.deltaDF.hv_ph1.ci">
                                                        </el-input>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>HV Ph.2</td>
                                                    <td>
                                                        <el-input size="small" type="number" v-model="online_monitoring.bushings.deltaDF.hv_ph2.result">
                                                            <template slot="append">%</template>
                                                        </el-input>
                                                    </td>
                                                    <td>
                                                        <el-input :class="nameColor(online_monitoring.bushings.deltaDF.hv_ph2.ci)" size="small" v-model="online_monitoring.bushings.deltaDF.hv_ph2.ci">
                                                        </el-input>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>HV Ph.3</td>
                                                    <td>
                                                        <el-input size="small" type="number" v-model="online_monitoring.bushings.deltaDF.hv_ph3.result">
                                                            <template slot="append">%</template>
                                                        </el-input>
                                                    </td>
                                                    <td>
                                                        <el-input :class="nameColor(online_monitoring.bushings.deltaDF.hv_ph3.ci)" size="small" v-model="online_monitoring.bushings.deltaDF.hv_ph3.ci">
                                                        </el-input>
                                                    </td>
                                                </tr>
                                            </tbody>
                                ...
                                <table id="dga" class="table-strip-input-data" style="width: 100%">
                                    ...
                                    <tbody v-for="(item, index) in air" :key="index">
                                        <tr>
                                            ...
                                            <td>
                                                <el-input size="small" type="number" v-model="online_monitoring.dga[item.toLowerCase()].result">
                                                    <template slot="append">ppm</template>
                                                </el-input>
                                            </td>
                                            <td>
                                                <el-input size="small" type="number" v-model="online_monitoring.dga[item.toLowerCase()].condition"></el-input>
                                            </td>
                                        </tr>
            ...
            <el-dialog class="dialog_assess" title="Assessment settings" :model-value="openConditionSetting" @update:model-value="openConditionSetting = $event">
                <table class="table-strip-input-data" style="width: 550px">
                    <thead>
                        <tr>
                            <th>Result</th>
            ...
            <el-dialog class="dialog_assess" title="Assessment settings" :model-value="openCondition" @update:model-value="openCondition = $event">
                <el-row>
                    <el-col :span="12">
                        <table class="table-strip-input-data" style="width: 550px">
                            <thead>
