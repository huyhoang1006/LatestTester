  ...
  <div id="online-monitoring-data">
    ...
    <div style="margin-top: 100px">
      <el-row style="height: 100%">
        <el-col style="width: 200px; height: 100%">
          <div class="rectangle">
            ...
            <el-divider />
            <div style="margin-bottom: 30px; text-align: center; margin-top: 30px">ONLINE DATA</div>
            <el-button @click="AgeingShow()" style="width: 100%"> Ageing </el-button>
            ...
            <el-button @click="DgaShow()" style="width: 100%; margin-left: 0px"> DGA </el-button>
            <el-button @click="Option()" style="width: 100%; margin-left: 0px"> Option </el-button>
          </div>
        </el-col>
                    ...
                    <tr>
                      ...
                      <td>
                        <el-input
                          size="small"
                          type="number"
                          v-model="online_monitoring.aois.ar"
                        ></el-input>
                      </td>
                    </tr>
                    <tr style="white-space: nowrap">
                      ...
                      <td>
                        <el-input
                          size="small"
                          type="number"
                          v-model="online_monitoring.aois.lc"
                        ></el-input>
                      </td>
                    </tr>
                  </tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <el-input
                          size="small"
                          type="number"
                          v-model="online_monitoring.moip.input_data.wcit"
                        >
                    ...
                    <tr>
                      ...
                      <td>
                        <el-input
                          size="small"
                          type="number"
                          v-model="online_monitoring.moip.input_data.tot"
                        >
                ...
                <table class="table-strip-input-data" style="width: 420px">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <el-input
                          size="small"
                          type="number"
                          v-model="online_monitoring.moip.cal.moip"
                        >
                    ...
                    <tr>
                      ...
                      <td>
                        <el-input
                          :class="nameColor(online_monitoring.moip.cal.ci)"
                          size="small"
                          v-model="online_monitoring.moip.cal.ci"
                        >
              ...
              <div id="bushings" class="mgy-5">
                      ...
                      <tr>
                        ...
                        <td>
                          <el-input
                            size="small"
                            type="number"
                            v-model="online_monitoring.bushings.bf.c_c_hv_ph1"
                          >
                      ...
                      <tr>
                        ...
                        <td>
                          <el-input
                            size="small"
                            type="number"
                            v-model="online_monitoring.bushings.bf.c_c_hv_ph2"
                          >
                            <template #append>pF</template>
                          </el-input>
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          <el-input
                            size="small"
                            type="number"
                            v-model="online_monitoring.bushings.bf.c_c_hv_ph3"
                          >
                            <template #append>pF</template>
                          </el-input>
                        </td>
                        ...
                        <tr>
                          ...
                          <th>
                            ...
                            <span style="float: right"
                              ><i @click="openCondition = true" class="fa-solid fa-sliders"></i
                            ></span>
                          </th>
                        </tr>
                      </thead>
                        ...
                        <tr>
                          ...
                          <td>
                            <el-input
                              size="small"
                              type="number"
                              v-model="online_monitoring.bushings.deltaC.hv_ph1.result"
                            >
                              <template #append>%</template>
                            </el-input>
                          </td>
                          <td>
                            <el-input
                              :class="nameColor(online_monitoring.bushings.deltaC.hv_ph1.ci)"
                              size="small"
                              v-model="online_monitoring.bushings.deltaC.hv_ph1.ci"
                            >
                            </el-input>
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td>
                            <el-input
                              size="small"
                              type="number"
                              v-model="online_monitoring.bushings.deltaC.hv_ph2.result"
                            >
                              <template #append>%</template>
                            </el-input>
                          </td>
                          <td>
                            <el-input
                              :class="nameColor(online_monitoring.bushings.deltaC.hv_ph2.ci)"
                              size="small"
                              v-model="online_monitoring.bushings.deltaC.hv_ph2.ci"
                            >
                            </el-input>
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td>
                            <el-input
                              size="small"
                              type="number"
                              v-model="online_monitoring.bushings.deltaC.hv_ph3.result"
                            >
                              <template #append>%</template>
                            </el-input>
                          </td>
                          <td>
                            <el-input
                              :class="nameColor(online_monitoring.bushings.deltaC.hv_ph3.ci)"
                              size="small"
                              v-model="online_monitoring.bushings.deltaC.hv_ph3.ci"
                            >
                            </el-input>
                          </td>
                        </tr>
                        ...
                        <tr>
                          ...
                          <td>
                            <el-input
                              size="small"
                              type="number"
                              v-model="online_monitoring.bushings.deltaDF.hv_ph1.result"
                            >
                              <template #append>%</template>
                            </el-input>
                          </td>
                          <td>
                            <el-input
                              :class="nameColor(online_monitoring.bushings.deltaDF.hv_ph1.ci)"
                              size="small"
                              v-model="online_monitoring.bushings.deltaDF.hv_ph1.ci"
                            >
                            </el-input>
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td>
                            <el-input
                              size="small"
                              type="number"
                              v-model="online_monitoring.bushings.deltaDF.hv_ph2.result"
                            >
                              <template #append>%</template>
                            </el-input>
                          </td>
                          <td>
                            <el-input
                              :class="nameColor(online_monitoring.bushings.deltaDF.hv_ph2.ci)"
                              size="small"
                              v-model="online_monitoring.bushings.deltaDF.hv_ph2.ci"
                            >
                            </el-input>
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td>
                            <el-input
                              size="small"
                              type="number"
                              v-model="online_monitoring.bushings.deltaDF.hv_ph3.result"
                            >
                              <template #append>%</template>
                            </el-input>
                          </td>
                          <td>
                            <el-input
                              :class="nameColor(online_monitoring.bushings.deltaDF.hv_ph3.ci)"
                              size="small"
                              v-model="online_monitoring.bushings.deltaDF.hv_ph3.ci"
                            >
                            </el-input>
                          </td>
                        </tr>
                ...
                <el-row style="margin-top: 25px; width: 50%">
                  ...
                  <el-col style="width: 10%">
                    <el-button @click="getData()" style="margin-left: 10px"> Get data </el-button>
                  </el-col>
                </el-row>
                <el-row>
                  <el-col style="width: 50%">
                ...
                <table class="table-strip-input-data" style="width: 500px">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <el-input size="small" type="number" v-model="online_monitoring.pd.coc_1">
                          <template #append>pC</template>
                        </el-input>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        <el-input size="small" type="number" v-model="online_monitoring.pd.coc_2">
                          <template #append>pC</template>
                        </el-input>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        <el-input size="small" type="number" v-model="online_monitoring.pd.coc_3">
                          <template #append>pC</template>
                        </el-input>
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td>
                        <el-input
                          size="small"
                          type="number"
                          v-model="online_monitoring.dga[item.toLowerCase()].result"
                        >
                          <template #append>ppm</template>
                        </el-input>
                      </td>
                      <td>
                        <el-input
                          size="small"
                          type="number"
                          v-model="online_monitoring.dga[item.toLowerCase()].condition"
                        ></el-input>
                      </td>
                    </tr>
                  </tbody>
      ...
      <el-dialog
        ...
        :model-value="openConditionSetting"
        @update:model-value="openConditionSetting = $event"
      >
        <table class="table-strip-input-data" style="width: 550px">
          <thead>
            <tr>
          ...
          <tbody>
            ...
            <tr>
              <td>
                {{ online_monitoring.moip.cis.moip.good }}.0 &lt; % moisture in paper ≤
                {{ online_monitoring.moip.cis.moip.fair }}
              </td>
              <td bgcolor="#FFFF00">Fair</td>
            </tr>
            <tr>
              <td>
                {{ online_monitoring.moip.cis.moip.fair }} &lt; % moisture in paper ≤
                {{ online_monitoring.moip.cis.moip.bad }}
              </td>
      ...
      <el-dialog
        class="dialog_assess"
        title="Assessment settings"
        :model-value="openCondition"
        @update:model-value="openCondition = $event"
      >
        <el-row>
          <el-col :span="12">
            <table class="table-strip-input-data" style="width: 550px">
              ...
              <tbody>
                <tr>
                  <td>
                    DF change ≤ {{ online_monitoring.bushings.cis.df_change.good.result }} time
                    previous, new values
                  </td>
                  <td bgcolor="#00CC00">Good</td>
                ...
                <tr>
                  <td>
                    {{ online_monitoring.bushings.cis.df_change.fair.result_small }} &lt; DF change
                    ≤ {{ online_monitoring.bushings.cis.df_change.fair.result_big }} time previous,
                    new values
                  </td>
                  <td bgcolor="#FFFF00">Fair</td>
                ...
                <tr>
                  <td>
                    {{ online_monitoring.bushings.cis.df_change.fair.result_big }} &lt; DF change ≤
                    {{ online_monitoring.bushings.cis.df_change.poor.result }} time previous, new
                    values
                  </td>
                  <td bgcolor="#FFC000">Poor</td>
                ...
                <tr>
                  <td>
                    DF change > {{ online_monitoring.bushings.cis.df_change.bad.result }} time
                    previous, new values
                  </td>
                  <td bgcolor="#FF0000">Bad</td>
          ...
          <el-col :span="12">
            <table class="table-strip-input-data" style="width: 450px">
              ...
              <tbody>
                ...
                <tr>
                  <td>
                    {{ online_monitoring.bushings.cis.c_meas.fair.result_small }} &lt; Δ C meas ≤
                    {{ online_monitoring.bushings.cis.c_meas.fair.result_big }}
                  </td>
                  <td bgcolor="#FFFF00">Fair</td>
                ...
                <tr>
                  <td>
                    {{ online_monitoring.bushings.cis.c_meas.poor.result_small }} &lt; Δ C meas ≤
                    {{ online_monitoring.bushings.cis.c_meas.poor.result_big }}
                  </td>
                  <td bgcolor="#FFC000">Poor</td>
      ...
      <el-dialog class="dialog_assess" :model-value="option" @update:model-value="option = $event">
        <el-row style="width: 80%">
          <el-form :inline-message="true" label-width="200px" size="small" label-position="left">
...
export default {
  ...
  computed: {
    selectedAsset() {
      return this.$userStore().selectedAsset
    }
  },
  methods: {
    backToManage() {
    ...
    changeRate() {
      if (!isNaN(parseFloat(this.sampleRate))) {
        ...
        ;(this.getData(), this.getOnlineData())
      }
      this.option = false
    }
  },
