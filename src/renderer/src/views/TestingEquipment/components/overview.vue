    ...
    <div class="ov-grid">
      <div class="panel">
        ...
        <div class="frow">
          ...
          <div class="fvalue">
            <input class="inp" v-model="form.name" placeholder="e.g. OMICRON CMC 356" />
          </div>
        </div>
        <div class="frow">
      ...
      <div class="ov-side">
        <div class="panel">
          ...
          <div class="frow">
            ...
            <div class="fvalue">
              <input class="inp" v-model="form.asset_tag" placeholder="Internal tag" />
            </div>
          </div>
          <div class="frow">
        ...
        <div class="panel">
          ...
          <div class="cbox">
            <textarea
              ...
              placeholder="Notes about this equipment…"
            ></textarea>
          </div>
        </div>
      </div>
