...
export const DISCONNECTOR_FIELD_DEFS = [
  ...
  },
  {
    ...
    fields: [
      ...
      {
        key: 'ratings.rated_duration_of_short_circuit.value',
        label: 'Rated Duration of Short Circuit'
      },
      {
        key: 'ratings.power_freq_withstand_voltage_earth_poles.value',
        label: 'PF Withstand to Earth/Poles'
      },
      {
        key: 'ratings.power_freq_withstand_voltage_isolating_distance.value',
        label: 'PF Withstand Isolating Distance'
      }
    ]
  }
]
