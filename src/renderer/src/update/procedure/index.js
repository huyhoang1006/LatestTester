...
export const createProcedure = async (dbsql) => {
  try {
    ...
    await surgeArresterProcedureFunc.createProcedureSurgeArrester(
      dbsql,
      procedureDataMap,
      testDataMap,
      testConditionMap,
    ...
    await voltageTransformerProcedureFunc.createProcedureVoltageTransformer(
      dbsql,
      procedureDataMap,
      testDataMap,
      testConditionMap,
    ...
    await currentTransformerProcedureFunc.createProcedureCurrentTransformer(
      dbsql,
      procedureDataMap,
      testDataMap,
      testConditionMap,
    ...
    await disconnectorProcedureFunc.createProcedureDisconnector(
      dbsql,
      procedureDataMap,
      testDataMap,
      testConditionMap,
    ...
    await powerCableProcedureFunc.createProcedurePowerCable(
      dbsql,
      procedureDataMap,
      testDataMap,
      testConditionMap,
