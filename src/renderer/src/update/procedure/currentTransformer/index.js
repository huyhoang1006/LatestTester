...
export const createProcedureCurrentTransformer = async (
  dbsql,
  procedureDataMap,
  testDataMap,
  testConditionMap,
  ...
  const currentTransformerTestDefinitions = await getTestDefinitionInfo(
    currentTransformerTestDefinitionInfo
  )
  const currentTransformerTestingConditions = await getTestConditionInfo(
    currentTransformerTestingConditionInfo
  )
