...
export const createProcedureCircuitBreaker = async (
  dbsql,
  procedureDataMap,
  testDataMap,
  testConditionMap,
  ...
  const circuitBreakerTestDefinitions = await getTestDefinitionInfo(
    circuitBreakerTestDefinitionInfo
  )
  const circuitBreakerTestingConditions = await getTestConditionInfo(
    circuitBreakerTestingConditionInfo
  )
