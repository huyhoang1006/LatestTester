<template>
    <div id="top-bar">
            ...
            <div class="right-bar">
                            ...
                            <el-dropdown ref="notificationDropdown" trigger="click" placement="bottom-end"
                                ...
                                <div class="notification-header">
                                    ...
                                    <div class="notification-header-actions">
                                        <el-button type="primary" link size="small" @click.stop="loadNotifications"
                                            title="Refresh Notifications">
                                            <i class="fas fa-sync-alt" :class="{ 'fa-spin': isReloading }"></i>
                                        </el-button>
                                        <el-button type="primary" link size="small" @click.stop="deleteAllNotifications"
                                    ...
                                    <div v-for="notification in displayedNotifications" :key="notification.mrid"
                                        ...
                                        <el-dropdown trigger="click" placement="bottom-end" :append-to-body="false">
                                            ...
                                            <template #dropdown>
                                                ...
                                                <el-dropdown-item
                                                    @click.stop="deleteNotification(notification.mrid)">
                                ...
                                <div class="notification-footer">
                                    ...
                                    <div class="notification-footer-actions">
                                        <el-button v-if="currentPage < totalPages" size="small" type="primary" link
                                            @click.stop="nextPage">
                                            Next Page
                                        </el-button>
                                        <el-button v-if="currentPage > 1" size="small" type="primary" link
                                            @click.stop="prevPage">
                                            Previous Page
                                        </el-button>
                                    </div>
                ...
                <el-tooltip content="Settings" placement="bottom">
                    <span @click.stop="handleDropdown" class="dropdown-trigger-wrapper">
                        <el-dropdown ref="dropdown" @command="handleCommand" trigger="click" placement="bottom-end" :show-arrow="false">
        ...
        <!-- Server address -->
        <el-dialog custom-class="app-dialog" title="Config server address" v-model="dialogConfig" :modal="true"
            append-to-body>
        ...
        <!-- Update Dialog -->
        <el-dialog custom-class="app-dialog" title="New Version Available" v-model="dialogUpdate" :modal="true"
        ...
        <el-dialog custom-class="app-dialog" title="Notifications Details" v-model="dialogNotificationDetail"
...
:deep(.app-dialog .el-dialog__headerbtn .el-dialog__close) {
...
:deep(.app-dialog .el-dialog__headerbtn:hover .el-dialog__close) {
    color: #ffffff !important;
    text-shadow: 0 0 10px rgba(255, 255, 255, 0.4);
}

:deep(.app-dialog .el-dialog__headerbtn i) {
    line-height: 1;
...
:deep(.app-dialog .el-form-item__label) {
...
:deep(.app-dialog .el-input__inner) {
    width: 100%;
...
:deep(.app-dialog .el-input__inner:focus) {
...
:deep(.custom-footer .footer-btn.el-button--default) {
...
:deep(.custom-footer .footer-btn.el-button--default:hover) {
...
:deep(.custom-footer .footer-btn.el-button--primary) {
...
:deep(.custom-footer .footer-btn.el-button--primary:hover) {
...
:deep(.custom-footer .footer-btn.el-button--danger) {
...
:deep(.custom-footer .footer-btn.el-button--danger:hover) {
...
:deep(.custom-footer .footer-btn:active) {
    transform: translateY(0);
    filter: brightness(0.9);
}

:deep(.custom-footer .footer-btn i) {
    font-size: 14px;
    color: inherit;
}
...
:deep(.changelog-body li) {
    margin: 6px 0;
    color: rgba(255, 255, 255, 0.85);
}

:deep(.changelog-body br) {
    display: block;
    content: "";
    margin: 4px 0;
}
