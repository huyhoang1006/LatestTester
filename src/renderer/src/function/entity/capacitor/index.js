...
} from '@/function/cim/capacitorInfo'
import {
  insertCapacitanceCapacitorInfoTransaction,
  getCapacitanceCapacitorInfoById,
...
import {
  ...
  getDissipationFactorCapacitorInfoById,
  ...
  try {
    if (id == null || id === '') {
      ...
      if (dataCapacitor.success) {
        ...
        const dataCapacitanceCapacitorInfo = await getCapacitanceCapacitorInfoByIds([
        ...
        const dataDissipationFactorCapacitorInfo = await getDissipationFactorCapacitorInfoByIds([
          entity.asset.asset_info
        ])
