...
import {
  getDisconnectorInfoById,
  insertDisconnectorInfoTransaction,
  deleteDisconnectorInfoTransaction
} from '@/function/cim/disconnectorInfo'
          ...
          if (switchInfoRes.success && switchInfoRes.data) {
            ...
            entity.disconnectorInfo = {
              ...
              short_time_withstand_current:
                sw.short_time_withstand_current ||
