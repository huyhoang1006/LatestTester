...
export const getTestStandardById = async (mrid) => {
  try {
    ...
    return new Promise((resolve, reject) => {
      db.get(`SELECT * FROM test_standard WHERE mrid=?`, [mrid], (err, row) => {
...
export const insertTestStandardTransaction = async (testStandard, dbsql) => {
  return new Promise(async (resolve, reject) => {
    try {
      ...
      const idObjResult = await identifiedObjectFunc.insertIdentifiedObjectTransaction(
        testStandard,
        dbsql
      )
...
export const updateTestStandardByIdTransaction = async (mrid, testStandard, dbsql) => {
  return new Promise(async (resolve, reject) => {
    try {
      ...
      const idObjResult = await identifiedObjectFunc.updateIdentifiedObjectByIdTransaction(
        mrid,
        testStandard,
        dbsql
      )
