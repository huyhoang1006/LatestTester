...
export const getStringMeasurementById = async (mrid) => {
  try {
    ...
    return new Promise((resolve, reject) => {
      db.get(`SELECT * FROM string_measurement WHERE mrid=?`, [mrid], (err, row) => {
        if (err)
...
export const insertStringMeasurementTransaction = async (stringMeasurement, dbsql) => {
  return new Promise(async (resolve, reject) => {
    try {
      ...
      const measResult = await measurementFunc.insertMeasurementTransaction(
        stringMeasurement,
        dbsql
      )
...
export const updateStringMeasurementByIdTransaction = async (mrid, stringMeasurement, dbsql) => {
  return new Promise(async (resolve, reject) => {
    try {
      ...
      const measResult = await measurementFunc.updateMeasurementByIdTransaction(
        mrid,
        stringMeasurement,
        dbsql
      )
