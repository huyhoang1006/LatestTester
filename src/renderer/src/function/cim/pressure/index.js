...
export const getPressureById = async (mrid) => {
  return new Promise((resolve, reject) => {
    db.get(`SELECT * FROM pressure WHERE mrid = ?`, [mrid], (err, row) => {
...
export const getPressureByIds = async (mrids) => {
  return new Promise((resolve, reject) => {
    ...
    db.all(`SELECT * FROM pressure WHERE mrid IN (${placeholders})`, mrids, (err, rows) => {
      if (err) {
...
export const deletePressureByIdTransaction = async (mrid, dbsql) => {
  return new Promise((resolve, reject) => {
    dbsql.run(`DELETE FROM pressure WHERE mrid = ?`, [mrid], function (err) {
