...
export const getZeroSequenceImpedanceTableById = async (mrid) => {
  return new Promise((resolve, reject) => {
    db.get(`SELECT * FROM zero_sequence_impedance_table WHERE mrid = ?`, [mrid], (err, row) => {
...
export const deleteZeroSequenceImpedanceTableTransaction = async (mrid, dbsql) => {
  return new Promise((resolve, reject) => {
    dbsql.run(`DELETE FROM zero_sequence_impedance_table WHERE mrid = ?`, [mrid], function (err) {
