...
export const insertOldSurgeArresterInfoTransaction = (info, dbsql) => {
  return new Promise(async (resolve, reject) => {
    try {
      const arresterInfoResult = await SurgeArresterInfoFunc.insertSurgeArresterInfoTransaction(
        info,
        dbsql
      )
      if (!arresterInfoResult.success) {
...
export const updateOldSurgeArresterInfoTransaction = (mrid, info, dbsql) => {
  return new Promise(async (resolve, reject) => {
    try {
      const arresterInfoResult = await SurgeArresterInfoFunc.updateSurgeArresterInfoTransaction(
        mrid,
        info,
        dbsql
      )
