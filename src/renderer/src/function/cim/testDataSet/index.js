...
export const getTestDataSetById = async (mrid) => {
  try {
    ...
    return new Promise((resolve, reject) => {
      db.get(`SELECT * FROM test_dataset WHERE mrid=?`, [mrid], (err, row) => {
...
export const insertTestDataSetTransaction = async (testDataSet, dbsql) => {
  return new Promise(async (resolve, reject) => {
    try {
      ...
      const procResult = await procedureDataSetFunc.insertProcedureDataSetTransaction(
        testDataSet,
        dbsql
      )
...
export const updateTestDataSetByIdTransaction = async (mrid, testDataSet, dbsql) => {
  return new Promise(async (resolve, reject) => {
    try {
      ...
      const procResult = await procedureDataSetFunc.updateProcedureDataSetByIdTransaction(
        mrid,
        testDataSet,
        dbsql
      )
