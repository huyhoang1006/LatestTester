...
export const getSurgeArresterTestDataSetById = async (mrid) => {
  try {
    ...
    return new Promise((resolve, reject) => {
      db.get(`SELECT * FROM surge_arrester_test_dataset WHERE mrid=?`, [mrid], (err, row) => {
        if (err)
          return reject({
            success: false,
            err,
...
export const insertSurgeArresterTestDataSetTransaction = async (
  ...
  return new Promise(async (resolve, reject) => {
    try {
      ...
      const testResult = await testDataSetFunc.insertTestDataSetTransaction(
        surgeArresterTestDataSet,
        dbsql
      )
...
export const updateSurgeArresterTestDataSetByIdTransaction = async (
  ...
  return new Promise(async (resolve, reject) => {
    try {
      ...
      const testResult = await testDataSetFunc.updateTestDataSetByIdTransaction(
        mrid,
        surgeArresterTestDataSet,
        dbsql
      )
