...
//     return client.get(`/api/bay/cim/${id}`)
// }
...
export const getBushingById = (id) => {
    return client.get(`/api/bushing/${id}`)
}

export const getSurgeArresterById = (id) => {
    return client.get(`/api/surge-arrester/${id}`)
}

export const getCircuitBreakerById = (id) => {
    return client.get(`/api/circuit-breaker/${id}`)
}

export const getCurrentTransformerById = (id) => {
    return client.get(`/api/current-transformer/${id}`)
}

export const getVoltageTransformerById = (id) => {
    return client.get(`/api/voltage-transformer/${id}`)
}

export const getDisconnectorById = (id) => {
    return client.get(`/api/disconnector/${id}`)
}

export const getPowerCableById = (id) => {
    return client.get(`/api/power-cable/${id}`)
}

export const getCapacitorById = (id) => {
    return client.get(`/api/capacitor/${id}`)
}

export const getReactorById = (id) => {
    return client.get(`/api/reactor/${id}`)
}

export const getRotatingMachineById = (id) => {
    return client.get(`/api/rotating-machine/${id}`)
}
