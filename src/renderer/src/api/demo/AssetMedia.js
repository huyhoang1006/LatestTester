...
export const getAssetMedia = (assetType, assetId) => {
  return client.get(`/${prefix}/${assetType}/${toServerId(assetId)}/media`)
}

export const uploadAssetMedia = (assetType, assetId, formData, options = {}) => {
  return client.post(`/${prefix}/${assetType}/${toServerId(assetId)}/media`, formData, {
    params: {
...
export const downloadAssetMedia = (assetType, assetId, mediaId) => {
  return client.get(
    `/${prefix}/${assetType}/${toServerId(assetId)}/media/${toServerId(mediaId)}/download`,
    {
      responseType: 'blob'
    }
  )
...
export const getAssetMediaDownloadUrl = (assetType, assetId, mediaId) => {
  ...
  return `${base}/${prefix}/${assetType}/${toServerId(assetId)}/media/${toServerId(mediaId)}/download`
}

export const deleteAssetMedia = (assetType, assetId, mediaId) => {
  return client.delete(
    `/${prefix}/${assetType}/${toServerId(assetId)}/media/${toServerId(mediaId)}`
  )
}
