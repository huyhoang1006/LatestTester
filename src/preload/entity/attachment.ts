...
export const attachmentPreload = () => ({
  ...
  getAttachmentById: (id_foreign: string, type: string) =>
    ipcRenderer.invoke('getAttachmentById', id_foreign, type),
  ...
  downloadFileData: (base64: string, dirFile: string) =>
    ipcRenderer.invoke('downloadFileData', base64, dirFile)
})
