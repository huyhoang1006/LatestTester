...
export const syncStatePreload = () => {
  return {
    ...
    markNodeDirty: (nodeMrid, nodeType, lastError) =>
      ipcRenderer.invoke('markNodeDirty', nodeMrid, nodeType, lastError),
    markNodeSyncing: (nodeMrid, nodeType) =>
      ipcRenderer.invoke('markNodeSyncing', nodeMrid, nodeType),
    markNodeSynced: (nodeMrid, nodeType, serverId) =>
      ipcRenderer.invoke('markNodeSynced', nodeMrid, nodeType, serverId),
    markNodeSyncFailed: (nodeMrid, nodeType, error) =>
      ipcRenderer.invoke('markNodeSyncFailed', nodeMrid, nodeType, error),
