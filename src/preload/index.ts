...
const ipcMain = Object.assign(
    ...
    userPreload(),
    {
        ...
        deleteAttachment: (id_foreign: string) =>
            ipcRenderer.invoke('deleteAttachment', id_foreign),
        deleteAttachmentpath: (name: string) =>
            ipcRenderer.invoke('deleteAttachmentpath', name),
        ...
        exportBay: (bayId: string, user_id: string) =>
            ipcRenderer.invoke('exportBay', bayId, user_id),
        ...
        importCircuitBreaker: (filePath: string) => ipcRenderer.invoke('importCircuitBreaker', filePath),
        ...
        importVoltageTransformer: (filePath: string) => ipcRenderer.invoke('importVoltageTransformer', filePath),
        importCurrentTransformer: (filePath: string) => ipcRenderer.invoke('importCurrentTransformer', filePath),
        ...
        importRotatingMachine: (filePath: string) => ipcRenderer.invoke('importRotatingMachine', filePath),
        ...
        updateLicense: (mrid: string, data: unknown) =>
            ipcRenderer.invoke('updateLicense', mrid, data),
        deleteLicense: (mrid: string) => ipcRenderer.invoke('deleteLicense', mrid),
        updatePerson: (mrid: string, data: unknown) =>
            ipcRenderer.invoke('updatePerson', mrid, data),
        ...
        insertProductAssetModel: (data: unknown) =>
            ipcRenderer.invoke('insertProductAssetModel', data),
        ...
        getLocationDetailByMrid: (mrid: string) =>
            ipcRenderer.invoke('getLocationDetailByMrid', mrid),
        ...
        deleteSubstationByMrid: (mrid: string) =>
            ipcRenderer.invoke('deleteSubstationByMrid', mrid),
        updateLocationByMrid: (mrid: string, data: unknown) =>
            ipcRenderer.invoke('updateLocationByMrid', mrid, data),
        deleteLocationByMrid: (mrid: string) =>
            ipcRenderer.invoke('deleteLocationByMrid', mrid),
        ...
        convertFileToJSON: (filePath: string) =>
            ipcRenderer.invoke('convertFileToJSON', filePath)
    }
)
