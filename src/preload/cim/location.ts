...
export const locationPreload = () => ({
    ...
    getLocationByOrganisationId: (organisationId: string) => ipcRenderer.invoke('getLocationByOrganisationId', organisationId),
    ...
    updateLocationByMrid: (mrid: string, data: unknown) => ipcRenderer.invoke('updateLocationByMrid', mrid, data),
