...
export const productAssetModelPreload = () => ({
    getProductAssetModelByMrid: (mrid: string) => ipcRenderer.invoke('getProductAssetModelByMrid', mrid),
    ...
    deleteProductAssetModelByMrid: (mrid: string) => ipcRenderer.invoke('deleteProductAssetModelByMrid', mrid)
})