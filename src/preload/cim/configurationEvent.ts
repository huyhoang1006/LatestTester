...
export const configurationEventPreload = () => ({
    getConfigurationEventByMrid: (mrid: string) => ipcRenderer.invoke('getConfigurationEventByMrid', mrid),
    ...
    deleteConfigurationEventByMrid: (mrid: string) => ipcRenderer.invoke('deleteConfigurationEventByMrid', mrid)
})