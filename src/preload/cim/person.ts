...
export const personPreload = () => ({
    ...
    getPersonByOrganisationId: (organisationId: string) => ipcRenderer.invoke('getPersonByOrganisationId', organisationId),
    insertPerson: (data: unknown) => ipcRenderer.invoke('insertPerson', data),
    updatePersonByMrid: (mrid: string, data: unknown) => ipcRenderer.invoke('updatePersonByMrid', mrid, data),
