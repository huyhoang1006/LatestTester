...
export const openFile = () => {
  ipcMain.handle('openFile', async function (_event, path) {
    try {
...
export const readFileData = () => {
  ipcMain.handle('readFileData', async function (_event, file_Path) {
    try {
...
export const downloadFileData = () => {
  ipcMain.handle('downloadFileData', async function (_event, base64, dirFile) {
    try {
      await fs.promises.writeFile(Path.join(pathUpload, `/${dirFile}`), base64, {
        encoding: 'base64'
      })
      return { success: true }
    } catch (err) {
...
export const downloadFile = () => {
  ipcMain.handle('downloadFile', async function (_event, path) {
    try {
...
export const getAttachmentpath = () => {
  ipcMain.handle('getAttachmentpath', async function (_event) {
    try {
      const rs: any = await dialog.showOpenDialog({
...
export const insertAttachment = () => {
  ipcMain.handle('insertAttachment', async function (_event, attachment) {
    try {
      const rs: any = await attachmentFunc.uploadAttachment(attachment)
      return rs
    } catch (err) {
...
export const deleteAttachmentById = () => {
  ipcMain.handle('deleteAttachmentById', async function (_event, id) {
    try {
      const rs: any = await attachmentFunc.deleteAttachmentById(id)
      return rs
    } catch (err) {
...
export const updateAttachmentById = () => {
  ipcMain.handle('updateAttachmentById', async function (_event, id, attachment) {
    try {
      const rs: any = await attachmentFunc.updateAttachmentById(id, attachment)
      return rs
    } catch (err) {
...
export const getAttachmentById = () => {
  ipcMain.handle('getAttachmentById', async function (_event, id) {
    try {
      const rs: any = await attachmentFunc.getAttachmentById(id)
      return rs
    } catch (err) {
...
export const getAttachmentByIdForeignAndType = () => {
  ipcMain.handle('getAttachmentByIdForeignAndType', async function (_event, id_foreign, type) {
    try {
      const rs: any = await attachmentFunc.getAttachmentByForeignIdAndType(id_foreign, type)
      return rs
    } catch (err) {
