...
import {
  insertRotatingMachineInfoTransaction,
  getRotatingMachineInfoById,
  deleteRotatingMachineInfoTransaction
} from '@/function/cim/rotatingMachineInfo'
import {
  ...
  try {
    if (entity.asset.mrid === null || entity.asset.mrid === '') {
      ...
      return {
        success: true,
        data: entity,
        message: 'Rotating machine entity inserted successfully'
      }
    }
  } catch (error: any) {
    restoreFiles(null, null, entity.asset.mrid)
  ...
  try {
    if (id == null || id === '') {
      ...
      if (dataRotatingMachine.success) {
        ...
        const dataRotatingMachineInfo: any = await getRotatingMachineInfoById(
        ...
        return {
          success: false,
          error: dataRotatingMachine.error,
          message: dataRotatingMachine.message
        }
      }
    }
  } catch (error: any) {
