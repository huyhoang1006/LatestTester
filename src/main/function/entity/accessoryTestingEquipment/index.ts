...
export const getAccessoriesByEquipmentId = async (equipmentId: string) => {
...
export const getAccessoryDetailsByEquipmentId = async (equipmentId: string) => {
  return new Promise((resolve, reject) => {
    db.all(
      ...
      (err: any, rows: any) => {
        ...
        return resolve({
          success: true,
          data: rows || [],
          message: 'Get accessory details completed'
        })
      }
    )
  })
...
export const getEquipmentsByAccessoryId = async (accessoryId: string) => {
  return new Promise((resolve, reject) => {
    db.all(
      `SELECT *
            FROM accessory_testing_equipment
...
export const insertAccessoryTestingEquipmentTransaction = async (
  ...
  return new Promise((resolve, reject) => {
    dbsql.run(
      ...
      [accessoryTestingEquipment.equipment, accessoryTestingEquipment.accessory],
      function (err: any) {
        if (err)
          return reject({
            success: false,
