...
export const getOrganisationEntityById: any = async (id: string) => {
    try {
        if(!id) {
            ...
            const dataStreetAddress: any = await getStreetAddressById(orgEntity.organisation.street_address);
            ...
            const dataElectronicAddress: any = await getElectronicAddressById(orgEntity.organisation.electronic_address);
            ...
            const dataAttachment: any = await getAttachmentByForeignIdAndType(orgEntity.organisation.mrid, 'organisation');
