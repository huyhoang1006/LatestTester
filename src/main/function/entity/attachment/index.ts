...
export const getAttachmentByForeignIdAndType = async (id_foreign: string, type: string) => {
    return new Promise((resolve, reject) => {
        db.get("SELECT * FROM attachment where id_foreign=? and type=?", [id_foreign, type], (err: any, row: any) => {
...
export const syncFilesWithFullRollback = (srcList: any[], dest: string | null, fatherMrid: string) => {
    const result = {
        success: false,
...
export const backupAllFilesInDir = (srcDir: string | null, backupDir: string | null, fatherMrid: string) => {
...
export const syncFilesWithDeletion = (srcList: any[], destDir: string | null, fatherMrid: string) => {
    const result = {
        success: false,
        copiedFiles: [] as string[],
...
export const restoreFiles = (backupDir: string | null, destDir: string | null, fatherMrid: string) => {
