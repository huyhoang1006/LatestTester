...
import { insertResistanceTransaction, deleteResistanceByIdTransaction, getResistanceByIds } from '@/function/cim/resistance';
import { insertLengthTransaction, deleteLengthByIdTransaction, getLengthByIds } from '@/function/cim/length'
...
import { insertPressureTransaction, deletePressureByIdTransaction, getPressureByIds } from '@/function/cim/pressure'
import { insertTemperatureTransaction, deleteTemperatureByIdTransaction, getTemperatureByIds } from '@/function/cim/temperature'
import { insertQuantityValueTransaction, deleteQuantityValueTransaction, getQuantityValueByIds } from '@/function/cim/quantityValue'
import { insertCapacitanceTransaction, deleteCapacitanceByIdTransaction, getCapacitanceByIds } from '@/function/cim/capacitance'
import { insertSecondsTransaction, deleteSecondsByIdTransaction, getSecondByIds } from '@/function/cim/seconds'
import { insertActivePowerTransaction, deleteActivePowerByIdTransaction, getActivePowerByIds } from '@/function/cim/activePower'
...
void _oldLocation;
            ...
            for (const tableType of tableTypes) {
                ...
                const toDelete = old_entity[tableType].filter((v: any) => v.mrid && !newIds.includes(v.mrid));
        ...
        if (id == null || id === '') {
            ...
            if (dataBreaker.success) {
                ...
                if (entity.oldBreakerInfo && entity.oldBreakerInfo.mrid) {
                    const dataBreakerRatingInfo: any = await getBreakerRatingInfoByBreakerInfoId(entity.oldBreakerInfo.mrid);
                    ...
                    const dataBreakerContactSystemInfo: any = await getBreakerContactSystemInfoByBreakerInfoId(entity.oldBreakerInfo.mrid);
                    ...
                    const dataBreakerOtherInfo: any = await getBreakerOtherInfoByBreakerInfoId(entity.oldBreakerInfo.mrid);
                    ...
                    const dataAssessmentLimitBreakerInfo: any = await getAssessmentLimitBreakerInfoByBreakerInfoId(entity.oldBreakerInfo.mrid);
                    if (dataAssessmentLimitBreakerInfo.success) {
                        entity.assessmentLimitBreakerInfo = dataAssessmentLimitBreakerInfo.data;

                        const dataAuxiliaryContactsBreakerInfo: any = await getAuxiliaryContactsBreakerInfoByAssessmentLimitId(entity.assessmentLimitBreakerInfo.mrid);
                        if (dataAuxiliaryContactsBreakerInfo.success && dataAuxiliaryContactsBreakerInfo.data) {
                            ...
                            if (entity.auxiliaryContactsBreakerInfo) {
                                const dataTripOperation: any = await getTripOperationByAuxiliaryContactsId(entity.auxiliaryContactsBreakerInfo.mrid);
                                ...
                                const dataCloseOperation: any = await getCloseOperationByAuxiliaryContactsId(entity.auxiliaryContactsBreakerInfo.mrid);
                        ...
                        const dataContactResistance: any = await getContactResistanceBreakerInfoByAssessmentLimitBreakerInfoId(entity.assessmentLimitBreakerInfo.mrid);
                        ...
                        const dataOperatingTime: any = await getOperatingTimeBreakerInfoByAssessmentLimitBreakerInfoId(entity.assessmentLimitBreakerInfo.mrid);
                        ...
                        const dataContactTravel: any = await getContactTravelBreakerInfoByAssessmentLimitBreakerInfoId(entity.assessmentLimitBreakerInfo.mrid);
                        ...
                        const dataMiscellaneous: any = await getMiscellaneousBreakerInfoByAssessmentLimitId(entity.assessmentLimitBreakerInfo.mrid);
                        ...
                        const dataCoilCharacteristics: any = await getCoilCharacteristicsBreakerInfoByAssessmentLimitId(entity.assessmentLimitBreakerInfo.mrid);
                        ...
                        const dataPickupVoltage: any = await getPickupVoltageBreakerInfoByAssessmentLimitId(entity.assessmentLimitBreakerInfo.mrid);
                        ...
                        const dataMotorCharacteristics: any = await getMotorCharacteristicsBreakerInfoByAssessmentLimitId(entity.assessmentLimitBreakerInfo.mrid);
                        ...
                        const dataUnderVoltage: any = await getUnderVoltageReleaseBreakerInfoByAssessmentLimitId(entity.assessmentLimitBreakerInfo.mrid);
                        ...
                        const dataOvercurrent: any = await getOvercurrentReleaseBreakerInfoByAssessmentLimitId(entity.assessmentLimitBreakerInfo.mrid);
                ...
                const dataOldOperatingMechanism: any = await getOldOperatingMechanismByAssetIdTransaction(entity.asset.mrid);
                if (dataOldOperatingMechanism.success && dataOldOperatingMechanism.data) {
                    ...
                    if (entity.oldOperatingMechanism.asset_info) {
                        const infoRes: any = await getOldOperatingMechanismInfoById(entity.oldOperatingMechanism.asset_info);
                    ...
                    if (entity.oldOperatingMechanism.product_asset_model) {
                        const modelRes: any = await getProductAssetModelById(entity.oldOperatingMechanism.product_asset_model);
                        if (modelRes.success) entity.operatingProductAssetModel = modelRes.data;
                    }

                    if (entity.oldOperatingMechanism.lifecycle_date) {
                        const dateRes: any = await getLifecycleDateById(entity.oldOperatingMechanism.lifecycle_date);
                        if (dateRes.success) entity.operatingLifecycleDate = dateRes.data;
                    }
                    const dataOperatingComponent: any = await getOperatingMechanismComponentByOperatingMechanismId(entity.oldOperatingMechanism.mrid);
...
export const deleteBreakerEntity: any = async (entity: any) => {
    try {
        ...
        if (entity.assessmentLimitBreakerInfo && entity.assessmentLimitBreakerInfo.mrid) {
            ...
            const crData: any = await getContactResistanceBreakerInfoByAssessmentLimitBreakerInfoId(limitId);
