...
export const getTestingEquipmentBySoftwareLicenseId = async (softwareLicenseId: string) => {
...
export const getSoftwareLicenseByTestingEquipmentId = async (testingEquipmentId: string) => {
  return new Promise((resolve, reject) => {
    db.all(
      `SELECT *
            FROM software_license_testing_equipment
...
export const insertSoftwareLicenseTestingEquipmentTransaction = async (
  softwareLicenseTestingEquipment: any,
  dbsql: any
) => {
  return new Promise((resolve, reject) => {
    dbsql.run(
...
export const deleteSoftwareLicenseTestingEquipmentTransaction = async (
  ...
  return new Promise((resolve, reject) => {
    dbsql.run(
      ...
      [softwareLicenseId, testingEquipmentId],
