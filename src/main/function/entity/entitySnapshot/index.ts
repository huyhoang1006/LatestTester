...
export const getSnapshot = async (mrid: string, type: string) => {
...
export const saveSnapshot = async (mrid: string, type: string, snapshotDto: unknown) => {
  return new Promise((resolve, reject) => {
    db.run(
...
export const deleteSnapshot = async (mrid: string, type: string) => {
  return new Promise((resolve, reject) => {
    db.run(
...
export const entitySnapshotFunc = {
  getSnapshot,
  saveSnapshot,
  deleteSnapshot
}
