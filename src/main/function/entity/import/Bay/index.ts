...
export const importBay = async (
  dto: Record<string, unknown>,
  parentNode: { mode?: string; mrid?: string },
  ...
  try {
    ...
    const entity: Record<string, unknown> = { ...dto }
    ...
    if (parentNode.mode === 'substation') {
      ...
      return {
        success: false,
        message: 'Bay can only be imported under Substation / VoltageLevel / Bay'
      }
    }
