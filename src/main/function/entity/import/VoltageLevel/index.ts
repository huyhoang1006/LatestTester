...
export const importVoltageLevel = async (data: any, parentNode: any, { electronAPI, mappings }: { electronAPI: any; mappings: any }) => {
    try {
...
function ensureRequiredIds(entity: any, data: any) {
    ...
    const hasNominalVoltage = entity.voltage.some((v: any) => v.mrid === entity.baseVoltage.nominal_voltage)
