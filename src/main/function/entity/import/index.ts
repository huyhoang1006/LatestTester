...
export const importNodeFromJSON: any = async (dtos: any[], parentNode: any, dependencies: any) => {
    ...
    try {
        ...
        const importMap: any = {
            organisation: (dto: any) => importOrganisationFromFile(dto, parentNode, { electronAPI, mappings }),
            substation: (dto: any) => importSubstationFromFile(dto, parentNode, { electronAPI, mappings }),
            voltageLevel: (dto: any) => importVoltageLevelFromFile(dto, parentNode, { electronAPI, mappings }),
            bay: (dto: any) => importBayFromFile(dto, parentNode, { electronAPI }),

            surgeArrester: (dto: any) => importSurgeArresterFromFile(dto, parentNode, { electronAPI, mappings }),
            powerCable: (dto: any) => importPowerCableFromFile(dto, parentNode, { electronAPI, mappings }),
            disconnector: (dto: any) => importDisconnectorFromFile(dto, parentNode, { electronAPI, mappings }),
            rotatingMachine: (dto: any) => importRotatingMachineFromFile(dto, parentNode, { electronAPI, mappings }),
            capacitor: (dto: any) => importCapacitorFromFile(dto, parentNode, { electronAPI, mappings }),
            voltageTransformer: (dto: any) => importVoltageTransformerFromFile(dto, parentNode, { electronAPI, mappings }),
            currentTransformer: (dto: any) => importCurrentTransformerFromFile(dto, parentNode, { electronAPI, mappings }),
            transformer: (dto: any) => importTransformerFromFile(dto, parentNode, { electronAPI, mappings }),
