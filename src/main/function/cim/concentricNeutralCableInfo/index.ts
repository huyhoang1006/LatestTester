...
export const updateConcentricNeutralCableInfoTransaction = async (mrid: string, info: any, dbsql: any) => {
    return new Promise(async (resolve, reject) => {
        try {
...
export const deleteConcentricNeutralCableInfoTransaction = async (mrid: string, dbsql: any) => {
    return new Promise(async (resolve, reject) => {
        try {
            dbsql.run("DELETE FROM concentric_neutral_cable_info WHERE mrid=?", [mrid], async function (err: any) {
                if (err) {
