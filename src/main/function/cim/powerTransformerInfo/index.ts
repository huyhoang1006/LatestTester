...
export const getPowerTransformerInfoById = async (mrid: string) => {
    try {
        ...
        return new Promise((resolve, reject) => {
            db.get('SELECT * FROM power_transformer_info WHERE mrid=?', [mrid], (err: Error | null, row: any) => {
...
export const updatePowerTransformerInfoTransaction = async (mrid: string, info: any, dbsql: any) => {
    return new Promise(async (resolve, reject) => {
        try {
...
export const deletePowerTransformerInfoTransaction = async (mrid: string, dbsql: any) => {
    return new Promise(async (resolve, reject) => {
        try {
            ...
            dbsql.run('DELETE FROM power_transformer_info WHERE mrid=?', [mrid], function (this: { lastID: number; changes: number }, err: Error | null) {
                if (err) {
