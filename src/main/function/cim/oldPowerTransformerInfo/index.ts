...
export const insertOldPowerTransformerInfoTransaction = async (info: any, dbsql: any) => {
    return new Promise(async (resolve, reject) => {
        try {
            const baseResult: any = await PowerTransformerInfoFunc.insertPowerTransformerInfoTransaction(info, dbsql)
            if (!baseResult.success) {
...
export const updateOldPowerTransformerInfoTransaction = async (mrid: string, info: any, dbsql: any) => {
    return new Promise(async (resolve, reject) => {
        try {
            const baseResult: any = await PowerTransformerInfoFunc.updatePowerTransformerInfoTransaction(mrid, info, dbsql)
            if (!baseResult.success) {
...
export const deleteOldPowerTransformerInfoTransaction = async (mrid: string, dbsql: any) => {
    return new Promise(async (resolve, reject) => {
        try {
            const baseResult: any = await PowerTransformerInfoFunc.deletePowerTransformerInfoTransaction(mrid, dbsql)
            if (!baseResult.success) {
