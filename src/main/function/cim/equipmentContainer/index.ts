...
export const getEquipmentContainerById = async (mrid: string) => {
    try {
        const cncResult: any = await connectivityNodeContainerFunc.getConnectivityNodeContainerById(mrid)
...
export const updateEquipmentContainerByIdTransaction = async (mrid: string, equipmentContainer: any, dbsql: any) => {
    return new Promise((resolve, reject) => {
