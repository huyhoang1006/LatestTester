...
export const deletePotentialTransformerTableByPotentialTransformerInfoId = async (mrid: string, dbsql: typeof db) => {
    return new Promise((resolve, reject) => {
        dbsql.run('DELETE FROM potential_transformer_table WHERE potential_transformer_info_id=?', [mrid], function (this: { lastID: number; changes: number }, err: Error | null) {
            if (err) {
