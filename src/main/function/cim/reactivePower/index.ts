...
export const getReactivePowerById = async (mrid: string) => {
    return new Promise((resolve, reject) => {
        db.get('SELECT * FROM reactive_power WHERE mrid=?', [mrid], (err: Error | null, row: unknown) => {
...
export const getReactivePowerByIds = async (mrids: string[]) => {
    return new Promise((resolve, reject) => {
...
export const insertReactivePower = async (reactivePower: { mrid: string; multiplier: string | null; unit: string | null; value: number | null }) => {
    return new Promise((resolve, reject) => {
        db.run(
            ...
            [reactivePower.mrid, reactivePower.multiplier, reactivePower.unit, reactivePower.value],
...
export const insertReactivePowerTransaction = async (
    reactivePower: { mrid: string; multiplier: string | null; unit: string | null; value: number | null },
    dbsql: typeof db
) => {
    return new Promise((resolve, reject) => {
        dbsql.run(
...
export const updateReactivePowerById = async (mrid: string, reactivePower: { multiplier: string | null; unit: string | null; value: number | null }) => {
    return new Promise((resolve, reject) => {
        db.run(
...
export const updateReactivePowerByIdTransaction = async (
    mrid: string,
    reactivePower: { multiplier: string | null; unit: string | null; value: number | null },
    dbsql: typeof db
) => {
    return new Promise((resolve, reject) => {
        dbsql.run(
...
export const deleteReactivePowerById = async (mrid: string) => {
    return new Promise((resolve, reject) => {
        db.run('DELETE FROM reactive_power WHERE mrid=?', [mrid], function (this: { lastID: number; changes: number }, err: Error | null) {
...
export const deleteReactivePowerByIdTransaction = async (mrid: string, dbsql: typeof db) => {
    return new Promise((resolve, reject) => {
        dbsql.run('DELETE FROM reactive_power WHERE mrid=?', [mrid], function (this: { lastID: number; changes: number }, err: Error | null) {
            if (err) return reject({ success: false, err, message: 'Delete reactive power failed' })
            if (this.changes === 0) return resolve({ success: false, data: null, message: 'Reactive power not found' })
            return resolve({ success: true, data: null, message: 'Delete reactive power completed' })
        })
