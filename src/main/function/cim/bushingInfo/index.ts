...
export const getBushingInfoById = async (mrid: string) => {
  try {
    ...
    return new Promise((resolve, reject) => {
      db.get(`SELECT * FROM bushing_info WHERE mrid=?`, [mrid], (err: any, row: any) => {
        ...
        return resolve({
          ...
          message: 'Get bushingInfo by id completed'
        })
      })
    })
  } catch (err) {
...
export const insertBushingInfoTransaction = async (info: any, dbsql: any) => {
...
export const updateBushingInfoTransaction = async (mrid: string, info: any, dbsql: any) => {
  return new Promise(async (resolve, reject) => {
    try {
...
export const deleteBushingInfoTransaction = async (mrid: string, dbsql: any) => {
  return new Promise(async (resolve, reject) => {
    try {
      ...
      dbsql.run('DELETE FROM bushing_info WHERE mrid=?', [mrid], function (err: any) {
        if (err) {
