...
export const getOtherByPowerTransformerInfoId = async (powerTransformerInfoId: string) => {
    return new Promise((resolve, reject) => {
        db.get("SELECT * FROM other WHERE power_transformer_info_id=?", [powerTransformerInfoId], (err: any, row: any) => {
...
export const insertOtherTransaction = async (other: any, dbsql: any) => {
    return new Promise(async (resolve, reject) => {
        try {
            ...
            const identifiedObjectResult: any = await IdentifiedObjectFunc.insertIdentifiedObjectTransaction(other, dbsql)
            if (!identifiedObjectResult.success) {
                return reject({ success: false, message: 'Insert identifiedObject failed', err: identifiedObjectResult.err })
            }
...
export const updateOtherById = async (mrid: string, other: any) => {
    return new Promise(async (resolve, reject) => {
        try {
            const identifiedObjectResult: any = await IdentifiedObjectFunc.updateIdentifiedObjectById(mrid, other)
            if (!identifiedObjectResult.success) {
...
export const updateOtherByIdTransaction = async (mrid: string, other: any, dbsql: any) => {
    return new Promise(async (resolve, reject) => {
        try {
            const identifiedObjectResult: any = await IdentifiedObjectFunc.updateIdentifiedObjectByIdTransaction(mrid, other, dbsql)
            if (!identifiedObjectResult.success) {
                return reject({ success: false, message: 'Update identifiedObject failed', err: identifiedObjectResult.err })
            }
...
export const deleteOtherById = async (mrid: string) => {
    return new Promise(async (resolve, reject) => {
        try {
            const identifiedObjectResult: any = await IdentifiedObjectFunc.deleteIdentifiedObjectById(mrid)
            if (!identifiedObjectResult.success) {
