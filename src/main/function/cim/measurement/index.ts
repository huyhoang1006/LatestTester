...
export const getMeasurementById = async (mrid: string) => {
    try {
...
export const insertMeasurementTransaction = async (measurement: any, dbsql: any) => {
    return new Promise(async (resolve, reject) => {
        try {
            const idObjResult: any = await identifiedObjectFunc.insertIdentifiedObjectTransaction(measurement, dbsql)
...
export const updateMeasurementByIdTransaction = async (mrid: string, measurement: any, dbsql: any) => {
    return new Promise(async (resolve, reject) => {
        try {
            const idObjResult: any = await identifiedObjectFunc.updateIdentifiedObjectByIdTransaction(mrid, measurement, dbsql)
            if (!idObjResult.success) {
...
export const deleteMeasurementByIdTransaction = async (mrid: string, dbsql: any) => {
    return new Promise(async (resolve, reject) => {
        try {
            dbsql.run("DELETE FROM measurement WHERE mrid=?", [mrid], function (this: any, err: any) {
