...
export const getTestStandardById = async (mrid: string) => {
    try {
...
export const insertTestStandardTransaction = async (testStandard: any, dbsql: any) => {
    return new Promise(async (resolve, reject) => {
        try {
            const idObjResult: any = await identifiedObjectFunc.insertIdentifiedObjectTransaction(testStandard, dbsql)
...
export const updateTestStandardByIdTransaction = async (mrid: string, testStandard: any, dbsql: any) => {
    return new Promise(async (resolve, reject) => {
        try {
            const idObjResult: any = await identifiedObjectFunc.updateIdentifiedObjectByIdTransaction(mrid, testStandard, dbsql)
            if (!idObjResult.success) {
...
export const deleteTestStandardByIdTransaction = async (mrid: string, dbsql: any) => {
    return new Promise(async (resolve, reject) => {
        try {
            dbsql.run("DELETE FROM test_standard WHERE mrid=?", [mrid], function (this: any, err: any) {
