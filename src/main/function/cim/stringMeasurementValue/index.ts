...
export const insertStringMeasurementValueTransaction = async (stringMeasurementValue: any, dbsql: any) => {
    return new Promise(async (resolve, reject) => {
        try {
            const mvResult: any = await measurementValueFunc.insertMeasurementValueTransaction(stringMeasurementValue, dbsql)
            if (!mvResult.success) {
...
export const updateStringMeasurementValueByIdTransaction = async (mrid: string, stringMeasurementValue: any, dbsql: any) => {
    return new Promise(async (resolve, reject) => {
        try {
            const mvResult: any = await measurementValueFunc.updateMeasurementValueByIdTransaction(mrid, stringMeasurementValue, dbsql)
            if (!mvResult.success) {
...
export const deleteStringMeasurementValueByIdTransaction = async (mrid: string, dbsql: any) => {
    return new Promise(async (resolve, reject) => {
        try {
            dbsql.run("DELETE FROM string_measurement_value WHERE mrid=?", [mrid], function (this: any, err: any) {
