...
export const insertResistanceTransaction = async (
    resistance: { mrid: string; multiplier: string | null; unit: string | null; value: number | null },
    dbsql: typeof db
) => {
    return new Promise((resolve, reject) => {
        dbsql.run(
            ...
            [resistance.mrid, resistance.multiplier, resistance.unit, resistance.value],
...
export const getResistanceById = async (mrid: string) => {
    try {
        return new Promise((resolve, reject) => {
            db.get(
...
export const getResistanceByIds = async (mrids: string[]) => {
    return new Promise((resolve, reject) => {
...
export const deleteResistanceByIdTransaction = async (mrid: string, dbsql: typeof db) => {
    return new Promise((resolve, reject) => {
        dbsql.run('DELETE FROM resistance WHERE mrid=?', [mrid], function (this: { lastID: number; changes: number }, err: Error | null) {
