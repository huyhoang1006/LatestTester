...
export const getDocumentById = async (mrid: string) => {
    try {
...
export const insertDocumentTransaction = async (document: any, dbsql: any) => {
    return new Promise(async (resolve, reject) => {
        try {
            const idObjResult: any = await identifiedObjectFunc.insertIdentifiedObjectTransaction(document, db)
...
export const updateDocumentByIdTransaction = async (mrid: string, document: any, dbsql: any) => {
    return new Promise(async (resolve, reject) => {
        try {
            const idObjResult: any = await identifiedObjectFunc.updateIdentifiedObjectByIdTransaction(mrid, document, dbsql)
            if (!idObjResult.success) {
...
export const deleteDocumentByIdTransaction = async (mrid: string, dbsql: any) => {
    return new Promise(async (resolve, reject) => {
        try {
            dbsql.run("DELETE FROM document WHERE mrid=?", [mrid], function (this: any, err: any) {
                ...
                identifiedObjectFunc.deleteIdentifiedObjectById(mrid)
