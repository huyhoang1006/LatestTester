...
export const getAreaById = async (mrid: string) => {
    return new Promise((resolve, reject) => {
        db.get('SELECT * FROM area WHERE mrid=?', [mrid], (err: Error | null, row: unknown) => {
...
export const getAreaByIds = async (mrids: string[]) => {
    return new Promise((resolve, reject) => {
...
export const insertArea = async (area: { mrid: string; multiplier: string | null; unit: string | null; value: number | null }) => {
    return new Promise((resolve, reject) => {
        db.run(
            ...
            [area.mrid, area.multiplier, area.unit, area.value],
...
export const insertAreaTransaction = async (
    area: { mrid: string; multiplier: string | null; unit: string | null; value: number | null },
    dbsql: typeof db
) => {
    return new Promise((resolve, reject) => {
        dbsql.run(
...
export const updateAreaById = async (mrid: string, area: { multiplier: string | null; unit: string | null; value: number | null }) => {
    return new Promise((resolve, reject) => {
        db.run(
            `UPDATE area
...
export const deleteAreaByIdTransaction = async (mrid: string, dbsql: typeof db) => {
    return new Promise((resolve, reject) => {
        dbsql.run('DELETE FROM area WHERE mrid=?', [mrid], function (this: { lastID: number; changes: number }, err: Error | null) {
