...
export const getConnectivityNodeContainerById = async (mrid: string) => {
    try {
        ...
        return new Promise((resolve, reject) => {
            db.get("SELECT * FROM connectivity_node_container WHERE mrid = ?", [mrid], (err: any, row: any) => {
...
export const updateConnectivityNodeContainerByIdTransaction = async (mrid: string, cnc: any, dbsql: any) => {
    return new Promise((resolve, reject) => {
