...
export const getReconditioningById = async (mrid: string) => {
  try {
    ...
    return new Promise((resolve, reject) => {
      db.get(`SELECT * FROM reconditioning WHERE mrid=?`, [mrid], (err: Error | null, row: any) => {
...
export const insertReconditioningTransaction = async (
  info: { mrid: string; asset: string | null; date_time: string | null },
  dbsql: any
) => {
...
export const updateReconditioningTransaction = async (
  mrid: string,
  info: { asset: string | null; date_time: string | null },
  dbsql: any
) => {
  return new Promise(async (resolve, reject) => {
    try {
...
export const deleteReconditioningTransaction = async (mrid: string, dbsql: any) => {
  return new Promise(async (resolve, reject) => {
    try {
      ...
      dbsql.run(
        'DELETE FROM reconditioning WHERE mrid=?',
        [mrid],
        function (this: { lastID: number; changes: number }, err: Error | null) {
          if (err) {
