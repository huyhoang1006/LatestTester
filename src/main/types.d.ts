declare module '@journeyapps/sqlcipher' {
    interface Database {
        run(sql: string, params?: unknown[], callback?: (this: { lastID: number, changes: number }, err: Error | null) => void): this
        all(sql: string, params?: unknown[], callback?: (err: Error | null, rows: unknown[]) => void): this
